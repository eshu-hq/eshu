---
description: Eshu executor variant pinned to GPT-5.5 medium
mode: all
...
# Eshu Executor Variant (`develop-eshu-gpt55-medium`)

This is the GPT-5.5 medium variant of `develop-eshu`.
