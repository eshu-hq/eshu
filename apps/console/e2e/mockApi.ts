...
export async function installMockApi(page: Page): Promise<void> {
  await page.route("**/eshu-api/**", async (route) => {
              ...
              repositories: [
                {
                  ...
                  repo_slug: "sample/checkout-service",
                  remote_url: "https://git.example.test/sample/checkout-service",
                  is_dependency: false,
                  group_key: "sample",
                  group_source: "e2e_mock",
                  group_truth: "exact",
                  group_kind: "product",
                  group_reason: "E2E mock fixture",
                },
                {
                  id: "repository:payments-api",
                  name: "payments-api",
                  repo_slug: "sample/payments-api",
                  remote_url: "https://git.example.test/sample/payments-api",
                  is_dependency: false,
                  group_key: "sample",
                  group_source: "e2e_mock",
                  group_truth: "exact",
                ...
                {
                  id: "repository:ledger-service",
                  name: "ledger-service",
                  repo_slug: "sample/ledger-service",
                  remote_url: "https://git.example.test/sample/ledger-service",
                  is_dependency: false,
                  group_key: "sample",
                  group_source: "e2e_mock",
                  group_truth: "exact",
                ...
                {
                  id: "repository:lib-common",
                  name: "lib-common",
                  repo_slug: "sample/lib-common",
                  remote_url: "https://git.example.test/sample/lib-common",
                  is_dependency: false,
                  group_key: "sample",
                  group_source: "e2e_mock",
                  group_truth: "exact",
                ...
                {
                  id: "repository:infra-config",
                  name: "infra-config",
                  repo_slug: "sample/infra-config",
                  remote_url: "https://git.example.test/sample/infra-config",
                  is_dependency: false,
                  group_key: "sample",
                  group_source: "e2e_mock",
                  group_truth: "exact",
                ...
                {
                  id: "repository:frontend-app",
                  name: "frontend-app",
                  repo_slug: "sample/frontend-app",
                  remote_url: "https://git.example.test/sample/frontend-app",
                  is_dependency: false,
                  group_key: "sample",
                  group_source: "e2e_mock",
                  group_truth: "exact",
          ...
          envelope(
            {
              services: [
                ...
                },
                {
                  ...
                  name: "lib-common",
                  kind: "library",
                  repo_name: "lib-common",
                  repo_id: "repository:lib-common",
                  environments: [],
                  materialization_status: "materialized",
                  tier: "library",
                  category: "library",
              ...
              images: [
                {
                  ...
                  vulns: { critical: 0, high: 1, medium: 3, low: 0 },
                },
              ],
            },
            "images.list",
    ...
    if (method === "GET" && path.includes("/supply-chain/impact/findings")) {
      const items =
        params.get("impact_status") === "affected_derived"
          ? [
              {
                id: "GHSA-yyyy",
                package: "axios",
