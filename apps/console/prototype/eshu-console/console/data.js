...
(function () {
  ...
  const graph = {
    nodes: [
      ...
      { id: "env:acme-prod", kind: "env", label: "acme-prod", sub: "EKS · us-east-1", col: 4 },
      { id: "env:acme-qa", kind: "env", label: "acme-qa", sub: "EKS · us-east-1", col: 4 },
    ...
    edges: [
      ...
      { s: "wl:catalog", t: "env:acme-prod", verb: "RUNS_IN", layer: "runtime" },
      { s: "wl:catalog", t: "env:acme-qa", verb: "RUNS_IN", layer: "runtime" },
