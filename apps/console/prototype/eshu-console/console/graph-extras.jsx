...
const VERB_META = {
  ...
  PUBLISHES: { desc: "Repository publishes an internal npm package.", facts: (s, t) => [`${s} PUBLISHES ${t}`, "registry: npm · private @dmm scope", "provenance: build attestation"] },
  ...
  TRACKED_BY: { desc: "Jira work item linked to a service or change.", facts: (s, t) => [`${s} TRACKED_BY ${t}`, "source: Jira · DMM-NODE", "link: commit / deploy reference"] },
