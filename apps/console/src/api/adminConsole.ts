...
// Provenance for list/summary loaders: live data, or empty-because-error.
export type AdminProvenance = "live" | "unavailable";
// Audit loaders add "forbidden" (HTTP 403 — not authorized for this scope).
...
// ---------------------------------------------------------------------------
// Audit events — GET /api/v0/auth/admin/audit/events (global operator only)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Audit summary — GET /api/v0/auth/admin/audit/summary (global operator only)
// ---------------------------------------------------------------------------
