...
// (go/internal/query/local/requests.go RecoveryCodes) are opaque
...
// go/internal/query/local/helpers.go:writeLocalIdentityUnauthenticated).
...
// Exact backend field names from go/internal/query/local/requests.go:
