...
export function AppRoutes({
  ...
  return (
    <Routes>
      <Route path="/" element={<DashboardPage model={model} client={client} onOpenService={onOpenService} repositories={repositories} />} />
      <Route path="/status" element={<StatusPage client={client} />} />
      <Route path="/dashboard" element={<DashboardPage model={model} client={client} onOpenService={onOpenService} repositories={repositories} />} />
      ...
      <Route path="/explorer" element={<ExplorerPage model={model} client={client} onOpenService={onOpenService} />} />
      <Route path="/relationships" element={<RelationshipsPage model={model} client={client} />} />
      <Route path="/service-story" element={<ServiceEvidenceGraphPage model={model} client={client} onOpenService={onOpenService} />} />
      <Route path="/service-story/:serviceName" element={<ServiceEvidenceGraphPage model={model} client={client} onOpenService={onOpenService} />} />
      <Route path="/service-report" element={<ServiceReportPage model={model} client={client} onOpenService={onOpenService} />} />
      <Route path="/service-report/:serviceName" element={<ServiceReportPage model={model} client={client} onOpenService={onOpenService} />} />
      ...
      <Route path="/ci-cd/run-correlations" element={<CICDRunCorrelationsPage client={client} model={model} />} />
      <Route path="/cloud-drift" element={<CloudDriftPage client={client} demoDefaults={cloudDriftDemoDefaults} />} />
      <Route path="/secrets-iam" element={<SecretsIamPage model={model} client={client} />} />
      <Route path="/topology" element={<TopologyPage client={client} model={model} onOpenService={onOpenService} />} />
      <Route path="/incidents" element={<IncidentContextPage model={model} client={client} onOpenService={onOpenService} />} />
      <Route path="/incidents/:incidentId/context" element={<IncidentContextPage model={model} client={client} onOpenService={onOpenService} />} />
      <Route path="/catalog" element={<CatalogPage model={model} onOpenService={onOpenService} />} />
      <Route path="/images" element={<ImagesPage client={client} sourceLabel={sourceLabel} />} />
      <Route path="/capabilities" element={<CapabilityMatrixPage client={client} sourceLabel={sourceLabel} />} />
      <Route path="/surface-inventory" element={<SurfaceInventoryPage client={client} sourceLabel={sourceLabel} />} />
      <Route path="/iac" element={<IacPage model={model} client={client} sourceLabel={sourceLabel} />} />
      ...
      <Route path="/dependencies" element={<DependenciesPage client={client} sourceLabel={sourceLabel} />} />
