...
import type { ConsoleModel, GraphModel, RelationshipRow, SeriesBundle } from "./types";
...
const demoRelationships: readonly RelationshipRow[] = [
  ...
  { verb: "DEPENDS_ON", layer: "runtime", count: 88, detail: "Runtime dependency" },
  {
    ...
    layer: "security",
    count: 34,
    detail: "Component affected by a vulnerability",
  },
];
...
export const demoModel: ConsoleModel = {
  ...
  findings: [
    {
      ...
      title: "CVE-2024-0001 reachable in prod image",
      detail: "checkout:1.4.2 ships an affected dependency.",
      truth: "fallback",
    },
    {
      id: "d2",
      type: "Dead code",
      entity: "checkout-service",
      title: "Unreferenced symbol legacyDiscount",
      detail: "src/discounts.ts · no callers",
      truth: "derived",
    },
  ],
  vulnerabilities: [
  ...
  dependencies: [
    {
      direction: "forward",
      anchorPackage: "sample-lib",
      anchorPackageId: "npm://sample-lib",
      declaringVersion: "1.0.0",
      relatedPackage: "left-pad",
      relatedPackageId: "npm://left-pad",
      ecosystem: "npm",
      range: "^1.3.0",
  ...
  images: [
    {
      id: "oci-image://registry.example/sample/checkout@sha256:abc123",
      ...
      artifactType: "",
      configDigest: "sha256:cfg9876543210",
      sizeBytes: 28475610,
  ...
  advisories: [
    {
      ...
      kev: true,
      ecosystems: ["maven"],
      packageIds: ["pkg:maven/org.apache.logging.log4j/log4j-core"],
  ...
  argoCDApps: [
    {
      id: "argo:checkout-app",
      name: "checkout-app",
      kind: "ArgoCDApplication",
      source: "sample/checkout-service",
      sourceIndexed: true,
    },
    {
      id: "argo:payments-app",
      name: "payments-app",
      kind: "ArgoCDApplication",
      source: "sample/payments-api",
      sourceIndexed: true,
    },
    {
      id: "argo:ledger-app",
      name: "ledger-app",
      kind: "ArgoCDApplication",
      source: "sample/ledger-service",
      sourceIndexed: true,
    },
    {
      id: "argo:external-app",
      name: "external-app",
      kind: "ArgoCDApplication",
      source: "https://github.com/sample/external-configs",
      sourceIndexed: false,
    },
  ],
  truth: {},
