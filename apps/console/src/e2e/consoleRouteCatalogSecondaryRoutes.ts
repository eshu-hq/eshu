...
export const secondaryConsoleRoutes: readonly ConsoleRoute[] = [
  ...
  },
  {
    ...
    workflow: {
      ...
      deadCodeControls: {
        applyName: "Apply",
        breakdownLinkSelector: '#dead-code-repository-breakdown a[href^="/dead-code?repo_id="]',
        breakdownSelector: '#dead-code-repository-breakdown[aria-label="Repository breakdown"]',
        breakdownToggleName: "Show repository breakdown",
        countScopeSelector: ".dead-code-scan-status",
        expectedCountScopeText: "returned result window, not the corpus",
        languageOptionsSelector: "#dead-code-language-options option",
        languageSelector: 'input[aria-label="Language selector"]',
        observedLanguageSelector: ".evidence-workbench .dead-code-row-language",
        repositoryOptionsSelector: "#dead-code-repository-options option",
