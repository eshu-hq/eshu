// pages/ExposurePathAdvanced.tsx
// Advanced mode of the Exposure Path surface: the original code-to-cloud handler
// trace from POST /api/v0/impact/trace-exposure-path (epic #2704, backend #2726).
// An operator supplies a source handler (name + repo, or entity id) and an
// optional max depth; the view renders the bounded reachability path
// "internet -> endpoint -> handler -> ... -> cloud sink".
//
...
export function ExposurePathAdvanced({
  ...
  return (
    <div className="exposure-advanced">
