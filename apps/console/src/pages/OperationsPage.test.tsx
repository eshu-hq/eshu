...
// The live operations board (issue #5137, plus its #5172 "Top domain
// backlogs" panel) has its own test file colocated with the component:
// pages/operations/OperationsLiveBoard.test.tsx (split out here to keep this
