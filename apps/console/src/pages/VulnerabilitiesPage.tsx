...
export function VulnerabilitiesPage({ model }: { readonly model: ConsoleModel }): React.JSX.Element {
  ...
  return (
    <div className="page">
      <div className="page-intro"><h2>Vulnerabilities</h2><p>Advisories correlated to reachable services — <span className="mono">GET /api/v0/supply-chain/impact/findings</span>.</p></div>
        ...
        <Panel className="flush" title="Advisory register" sub="Sorted by CVSS">
          <table className="tbl">
            ...
            <tbody>
              ...
              {rows.length === 0 ? <tr><td colSpan={6} className="empty">No advisories from this source — requires the vulnerability-intelligence collector.</td></tr> : null}
            </tbody>
          </table>
        </Panel>
      </div>
