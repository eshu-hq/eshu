...
// is explicit: "Reachable" lists advisories correlated to indexed services
...
export function VulnerabilitiesPage({ model, client }: {
  ...
  return (
    <div className="page">
      <div className="page-intro">
        ...
        <p>
          Separate views of vulnerability truth: advisories <strong>reachable in our services</strong>{" "}
      ...
      {tab === "reachable" ? <ReachableAdvisories model={model} /> : <AdvisoryCatalog model={model} client={client} />}
    </div>
  );
}
