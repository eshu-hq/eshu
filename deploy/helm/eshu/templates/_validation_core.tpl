...
{{- fail "nornicdb.persistence.existingClaim cannot reuse the pre-v1.3.2 NornicDB PVC; stop NornicDB, snapshot or back up the graph, use a fresh v1.3.2-compatible claim, and rebuild the graph from Postgres facts" -}}
{{- end -}}
