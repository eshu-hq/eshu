...
| `analyze_code_relationships` | `call_graph.direct_callers`, `call_graph.direct_callees`, `call_graph.transitive_callers`, `call_graph.transitive_callees`, `symbol_graph.inheritance` |
