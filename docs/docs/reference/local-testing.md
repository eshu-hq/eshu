...
explicit-CVE query shaping, source snapshot facts, affected package
normalization, KEV/EPSS risk-signal facts, fixed-version extraction, and URL
credential stripping without network calls or graph writes.
