...
| GET /api/v0/service-catalog/correlations | ServiceCatalogHandler.listCorrelations | service_catalog_correlation | `fact.fact_kind = $1` = `reducer_service_catalog_correlation` (query/service/catalog_correlations.go:24,195) |
