...
Verified on Neo4j by the #6671 barrier proof ([6671-runs-on-concurrent-writers.md](../evidence/6671-runs-on-concurrent-writers.md)): 660 keyed barrier trials checked the tuple and cross-repo won in every one.
