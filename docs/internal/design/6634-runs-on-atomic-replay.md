...
Measured exception: see [6671-runs-on-concurrent-writers.md](../evidence/6671-runs-on-concurrent-writers.md) (#FOLLOWUP-6671). A rare concurrent-overlap trial ended with the workload tuple.
