...
- [x] PR 4 — `querytestutil/content` and `querytestutil/graph` nested ([#7043](https://github.com/eshu-hq/eshu/pull/7043), merged `950c16cc4`). The `querytestutil` -> `testutil` rename itself stays with #6818.
- [ ] PR 6 — `auth/`
