...
### 10. go/internal/parser/javascript/semantics_ast.go (2 sites)
...
### 32. go/internal/parser/scip/parser.go (3 sites)
...
| `parser/scip/parser.go` | SCIP index | No migration. SCIP protobuf symbol manipulation, not source parsing. |
