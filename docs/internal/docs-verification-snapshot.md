...
Current checkpoint after the local performance, public run/CLI, package README,
and scoped AGENTS follow-up pass:

- Public docs verification: `173` documents, `1237` claims,
  `0` contradicted, `0` missing evidence.
- Full repository docs verification: `562` documents, `1434` claims,
  `0` contradicted, `0` missing evidence.
