...
Trigger `ec2.BuildInstanceIdentityMaterializationReducerIntent` (moved to
`internal/projector/ec2` in #6057 and now located at
`internal/projector/aws/ec2`; unexported
`buildEC2InstanceIdentityMaterializationReducerIntent` at the time of this
