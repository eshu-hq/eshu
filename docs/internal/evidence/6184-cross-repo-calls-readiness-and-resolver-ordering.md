...
Measured exception: see [6671-runs-on-concurrent-writers.md](6671-runs-on-concurrent-writers.md) (#7175): observed on the pinned NornicDB image, not reproduced on Neo4j.
