...
The fence that keeps readers off a table an older writer made stale, its
race proofs, its measured cost, and its rollback path are in
[6793-infra-read-model-fence.md](6793-infra-read-model-fence.md).
