...
entity_id tiebreak keeps the order total (ids are unique), so answers are
identical across backends. No Cypher text change, no response-shape change
(same fields, same truth envelope).
