...
Validation-Slug: prod-call-chain-path
...
Capability-Assertion: call_graph.call_chain_path passed its non-vacuous capability-specific assertion through the deployed API or MCP surface.
B12-Assertion: call_graph.call_chain_path -> mcp:find_function_call_chain
