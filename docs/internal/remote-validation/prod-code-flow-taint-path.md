...
Validation-Slug: prod-code-flow-taint-path
...
Capability-Assertion: code_flow.taint_path passed its non-vacuous capability-specific assertion through the deployed API or MCP surface.
B12-Assertion: code_flow.taint_path -> mcp:dispatch_taint_path
