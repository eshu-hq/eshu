...
Validation-Slug: prod-direct-callers
...
Capability-Assertion: call_graph.direct_callers passed its non-vacuous capability-specific assertion through the deployed API or MCP surface.
B12-Assertion: call_graph.direct_callers -> mcp:analyze_code_relationships
