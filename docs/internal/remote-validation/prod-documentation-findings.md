...
Validation-Slug: prod-documentation-findings
...
Capability-Assertion: documentation_findings.list passed its non-vacuous capability-specific assertion through the deployed API or MCP surface.
B12-Assertion: documentation_findings.list -> mcp:list_documentation_findings
