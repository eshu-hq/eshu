...
Validation-Slug: prod-iac-resource-list
...
Capability-Assertion: iac_inventory.resources.list passed its non-vacuous capability-specific assertion through the deployed API or MCP surface.
B12-Assertion: iac_inventory.resources.list -> http:GET /api/v0/iac/resources?limit=50&include_facets=true
