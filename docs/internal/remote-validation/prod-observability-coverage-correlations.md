...
Validation-Slug: prod-observability-coverage-correlations
...
Capability-Assertion: observability.coverage.correlations.list passed its non-vacuous capability-specific assertion through the deployed API or MCP surface.
B12-Assertion: observability.coverage.correlations.list -> mcp:list_observability_coverage_correlations
