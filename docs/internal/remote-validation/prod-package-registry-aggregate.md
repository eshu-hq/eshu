...
Validation-Slug: prod-package-registry-aggregate
...
Capability-Assertion: package_registry.packages.aggregate passed its non-vacuous capability-specific assertion through the deployed API or MCP surface.
B12-Assertion: package_registry.packages.aggregate -> mcp:count_package_registry_packages
