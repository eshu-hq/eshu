...
Validation-Slug: prod-security-alert-reconciliation-aggregate
...
Capability-Assertion: supply_chain.security_alert_reconciliations.aggregate passed its non-vacuous capability-specific assertion through the deployed API or MCP surface.
B12-Assertion: supply_chain.security_alert_reconciliations.aggregate -> mcp:count_security_alert_reconciliations
