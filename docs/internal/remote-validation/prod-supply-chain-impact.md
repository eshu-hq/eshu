...
B12-Assertion: reachability.go.govulncheck -> mcp:list_supply_chain_impact_findings
...
B12-Assertion: supply_chain.impact_findings.list -> mcp:list_supply_chain_impact_findings
