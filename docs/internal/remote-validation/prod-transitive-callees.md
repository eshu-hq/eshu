...
Validation-Slug: prod-transitive-callees
...
Capability-Assertion: call_graph.transitive_callees passed its non-vacuous capability-specific assertion through the deployed API or MCP surface.
B12-Assertion: call_graph.transitive_callees -> mcp:analyze_code_relationships
