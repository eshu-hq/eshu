...
| Parser behavior used by collection or content shape | `cd go && go test ./internal/parser/... ./internal/collector/repo/discovery ./internal/content/shape -run <focused-test> -count=1` |
