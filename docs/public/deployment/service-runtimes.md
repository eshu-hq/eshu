...
| Hosted Collectors | Confluence, OCI registry, Terraform-state, AWS cloud, package-registry, SBOM, attestation, provider security-alert, and PagerDuty incident-context fact intake. | optional `Deployment` | [Collector runtimes](service-runtimes-collectors.md) |
