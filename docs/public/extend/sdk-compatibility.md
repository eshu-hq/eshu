...
| --- | --- | --- | --- | --- |
| `sdk/go/collector` v0.1.0 (`sdk/go/collector/v0.1.0`, 2026-07-06; proxy-verified per #6708) | `v0.0.3-pre-release-*` train (current; stable `v0.0.3` not yet cut, see [Release Log](../releases/index.md)) | `collector-sdk/v1alpha1` | `sdk/go/factschema` v0.1.0 (`sdk/go/factschema/v0.1.0`, 2026-07-06) | Supported. Initial tagged combination; 130 fixture-pack schemas. |
| `sdk/go/collector` v0.2.0 (unreleased; see `sdk/go/collector/CHANGELOG.md`) | `v0.0.3-pre-release-*` train (current) | `collector-sdk/v1alpha1` (unchanged) | `sdk/go/factschema` v0.2.0 (unreleased; see `sdk/go/factschema/CHANGELOG.md`) | Pending. Additive post-v0.1.0 changes only: redaction helper exports, opaque-URI credential refusal, six new fact-schema families (46 new schemas), fixture-pack growth. Manifests may set `payloadSchemaRef` to validate a namespaced component fact against a fixture-pack payload shape. |
