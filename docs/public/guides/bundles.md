...
A bundle record represents graph content that was already indexed and can be
...
find existing pre-indexed library graph candidates instead of walking vendored
source in every repository.
