...
| Who implements this interface? | `analyze_code_relationships` with `query_type=find_implementers` |
| Who instantiates this class? | `analyze_code_relationships` with `query_type=find_instantiators` |
