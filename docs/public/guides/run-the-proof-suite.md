...
| `ifa-fault-injection` | Lease reclaim and retry converge across a 24-cell matrix. It includes fault injection, baselines, and exact-edge delta retraction. CI shards 23 non-baseline cells four ways and repeats the shared baseline, for 27 runs. |
