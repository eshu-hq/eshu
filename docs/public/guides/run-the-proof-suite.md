...
| `ifa-fault-injection` | Lease reclaim and retry converge across a 49-cell matrix. It includes fault injection, baselines, and exact-edge delta retraction. CI shards 48 non-baseline cells across 4 jobs and repeats the shared baseline, for 52 runs. |
