...
| `ifa-fault-injection` | Lease reclaim and retry converge across a 33-cell matrix. It includes fault injection, baselines, and exact-edge delta retraction. CI shards 32 non-baseline cells four ways and repeats the shared baseline, for 36 runs. |
