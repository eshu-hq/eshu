...
- **Cross-repo target matching is deliberately narrow.**
  ...
  exact `GitRepository` sourceRef name and exactly one evidence-backed target
  repository. A missing identity, multiple targets, or a saturated binding
