...
| Generics | `generics` | supported | `functions` | `name, line_number` | `node:Function` | `go/internal/parser/python/engine_python_semantics_test.go::TestDefaultEngineParsePathGoRichSemanticMetadata` | Compose-backed fixture verification | - |
