...
| Generics | `generics` | supported | `functions` | `name, line_number` | `node:Function` | `go/internal/parser/go_dead_code_terraform_gaps_test.go::TestDefaultEngineParsePathGoDoesNotRootTypeParameterNamesAsConstraints` | Compose-backed fixture verification | - |
