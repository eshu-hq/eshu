...
| Main parser tests | `go/internal/parser/javascript/engine_semantics_test.go`, `go/internal/parser/javascript/engine_tsx_advanced_semantics_test.go`, `go/internal/parser/javascript/engine_tsx_component_wrapper_test.go` |
