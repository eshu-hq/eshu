...
| phase publish | go/internal/projector/service.go (publish_phases) | `eshu_dp_canonical_phase_duration_seconds`, `eshu_dp_deployment_mapping_reopened_total`, `eshu_dp_code_import_repo_edge_reopened_total` | projector phase publish |
...
| Cassette replay source | go/internal/collector/cassette/source.go | `No-Observability-Change: collector.Service poll-loop metrics (eshu_dp_facts_emitted_total, eshu_dp_fact_batches_committed_total) cover cassette replay throughput; the cassette Source adds no new instruments` | collector cassette |
| Cassette replay format | go/internal/collector/cassette/format.go | `No-Observability-Change: cassette file loading is a startup-path read; no runtime metrics needed` | collector cassette |
| Cassette replay README | go/internal/collector/cassette/README.md | `No-Observability-Change: documentation file, no runtime stage` | collector cassette |
| Cassette replay AGENTS | go/internal/collector/cassette/AGENTS.md | `No-Observability-Change: agent instructions file, no runtime stage` | collector cassette |
...
| stage | file:line | required metric name(s) | category |
| --- | --- | --- | --- |
| reducer queue | go/internal/storage/postgres/queue_observer.go:112 | `eshu_dp_queue_depth`, `eshu_dp_queue_oldest_age_seconds`, `eshu_dp_workflow_family_queue_depth` | queue domain |
