...
Total Go code coverage: **75.2%** (208764 of 277590 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4375 files and excluded 0 files (0 statements).
