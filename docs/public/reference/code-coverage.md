...
Total Go code coverage: **75.0%** (205828 of 274555 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4322 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/cmd/api` | 628 | 1480 | 42.4% |
