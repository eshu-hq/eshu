...
Total Go code coverage: **74.7%** (198948 of 266382 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4184 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/internal/parser/javascript` | 566 | 3954 | 14.3% |
