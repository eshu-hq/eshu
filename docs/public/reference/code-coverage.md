...
Total Go code coverage: **75.7%** (217323 of 287134 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4544 files and excluded 0 files (0 statements).
