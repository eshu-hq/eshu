...
Total Go code coverage: **74.9%** (205366 of 274023 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4311 files and excluded 0 files (0 statements).
