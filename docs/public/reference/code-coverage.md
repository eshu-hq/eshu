...
Total Go code coverage: **75.8%** (218356 of 288226 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4573 files and excluded 0 files (0 statements).
