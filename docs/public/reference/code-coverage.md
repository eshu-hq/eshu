...
Total Go code coverage: **74.2%** (197377 of 266036 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4169 files and excluded 0 files (0 statements).
