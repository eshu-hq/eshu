...
Total Go code coverage: **73.5%** (186290 of 253413 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 3926 files and excluded 0 files (0 statements).

## Lowest-Covered Packages

| Package | Covered statements | Total statements | Coverage |
| --- | ---: | ---: | ---: |
| `github.com/eshu-hq/eshu/go/cmd/fact-kind-registry` | 0 | 168 | 0.0% |
