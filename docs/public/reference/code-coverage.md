...
Total Go code coverage: **75.1%** (207837 of 276574 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4363 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/cmd/mcp-server` | 87 | 214 | 40.7% |
...
| `github.com/eshu-hq/eshu/go/cmd/api` | 671 | 1487 | 45.1% |
