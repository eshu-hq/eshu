...
Total Go code coverage: **73.8%** (189635 of 256927 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4001 files and excluded 0 files (0 statements).
