...
Total Go code coverage: **75.4%** (213993 of 283744 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4486 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/cmd/mcp-server` | 142 | 349 | 40.7% |
