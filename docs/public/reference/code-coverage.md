...
Total Go code coverage: **75.2%** (209156 of 278055 statements covered).
...
<<<<<<< HEAD
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4383 files and excluded 0 files (0 statements).
=======
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4382 files and excluded 0 files (0 statements).
>>>>>>> 0b05fb6d56 (fix(console): resolve exposure service selections)
...
| `github.com/eshu-hq/eshu/go/cmd/mcp-server` | 88 | 216 | 40.7% |
...
| `github.com/eshu-hq/eshu/go/cmd/api` | 672 | 1489 | 45.1% |
...
| `github.com/eshu-hq/eshu/go/cmd/golden-corpus-gate` | 252 | 506 | 49.8% |
