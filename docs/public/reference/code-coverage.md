...
Total Go code coverage: **73.8%** (189509 of 256842 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 3998 files and excluded 0 files (0 statements).
