...
Total Go code coverage: **74.9%** (204203 of 272486 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4287 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/cmd/api` | 618 | 1452 | 42.6% |
