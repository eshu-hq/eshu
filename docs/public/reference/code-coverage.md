...
Total Go code coverage: **73.8%** (189808 of 257183 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4007 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/internal/parser/php` | 36 | 1265 | 2.8% |
| `github.com/eshu-hq/eshu/go/cmd/workflow-coordinator` | 3 | 90 | 3.3% |
...
| `github.com/eshu-hq/eshu/go/internal/parser/javascript` | 491 | 3835 | 12.8% |
