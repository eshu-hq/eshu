...
Total Go code coverage: **74.7%** (198927 of 266358 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4183 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/internal/parser/golang` | 1539 | 3347 | 46.0% |
| `github.com/eshu-hq/eshu/go/cmd/collector-loki` | 97 | 208 | 46.6% |
| `github.com/eshu-hq/eshu/go/cmd/collector-tempo` | 99 | 211 | 46.9% |
| `github.com/eshu-hq/eshu/go/internal/parser/cpp` | 398 | 812 | 49.0% |
