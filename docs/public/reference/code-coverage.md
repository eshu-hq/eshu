...
Total Go code coverage: **75.6%** (215936 of 285454 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4513 files and excluded 0 files (0 statements).
