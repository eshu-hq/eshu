...
Total Go code coverage: **74.9%** (206454 of 275499 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4338 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/cmd/projector` | 125 | 318 | 39.3% |
...
| `github.com/eshu-hq/eshu/go/cmd/api` | 666 | 1480 | 45.0% |
