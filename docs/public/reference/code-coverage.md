...
Total Go code coverage: **75.0%** (203449 of 271171 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4247 files and excluded 0 files (0 statements).

## Lowest-Covered Packages

| Package | Covered statements | Total statements | Coverage |
| --- | ---: | ---: | ---: |
| `githgithub.com/eshu-hq/eshu/go/internal/collector/awscloud/services/transitgateway/awssdk` | 0 | 1 | 0.0% |
...
| `github.github.com/eshu-hq/eshu/go/internal/collector/awscloud/services/ssm/awssdk` | 0 | 1 | 0.0% |
...
| `github.com/eshu-hq/eshu/go/internal/collector/awscloud/services/transitgateway/awssdk` | 54 | 271 | 19.9% |
...
| `github.com/eshu-hq/eshu/go/cmd/api` | 147 | 415 | 35.4% |
