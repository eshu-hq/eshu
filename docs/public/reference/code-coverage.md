...
Total Go code coverage: **74.9%** (204874 of 273418 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4302 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/cmd/api` | 628 | 1472 | 42.7% |
