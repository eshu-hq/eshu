...
Total Go code coverage: **74.9%** (203715 of 271899 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4277 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/cmd/api` | 600 | 1438 | 41.7% |
