...
Total Go code coverage: **74.2%** (196762 of 265144 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4154 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/internal/parser/javascript` | 567 | 3950 | 14.4% |
...
| `github.com/eshu-hq/eshu/go/cmd/api` | 339 | 962 | 35.2% |
