...
Total Go code coverage: **75.2%** (210219 of 279407 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4408 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/cmd/mcp-server` | 99 | 267 | 37.1% |
...
| `github.com/eshu-hq/eshu/go/cmd/api` | 686 | 1532 | 44.8% |
