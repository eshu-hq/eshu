...
Total Go code coverage: **74.2%** (195055 of 262861 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4095 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/cmd/fact-kind-registry` | 89 | 232 | 38.4% |
...
| `github.com/eshu-hq/eshu/go/cmd/collector-loki` | 97 | 208 | 46.6% |
