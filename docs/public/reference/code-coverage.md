...
Total Go code coverage: **75.4%** (211656 of 280744 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4439 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/internal/testutil/postgresproof` | 7 | 56 | 12.5% |
...
| `github.com/eshu-hq/eshu/go/internal/parser/swift` | 158 | 573 | 27.6% |
...
| `github.com/eshu-hq/eshu/go/cmd/mcp-server` | 104 | 281 | 37.0% |
...
| `github.com/eshu-hq/eshu/go/cmd/api` | 712 | 1555 | 45.8% |
