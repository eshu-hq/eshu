...
Total Go code coverage: **74.3%** (197673 of 266183 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4180 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/internal/parser/javascript` | 567 | 3954 | 14.3% |
