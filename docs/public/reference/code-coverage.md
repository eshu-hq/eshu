...
Total Go code coverage: **73.9%** (192469 of 260487 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4054 files and excluded 0 files (0 statements).
