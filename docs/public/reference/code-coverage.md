...
Total Go code coverage: **73.8%** (190105 of 257632 statements covered).
...
The generator excludes Generated Go files (`*.pb.go`, `*.gen.go`, `zz_generated*`), vendored code, fixture corpora, `testdata`, mocks, and docs-site output. In this run it included 4016 files and excluded 0 files (0 statements).
...
| `github.com/eshu-hq/eshu/go/cmd/api` | 339 | 958 | 35.4% |
...
| `github.com/eshu-hq/eshu/go/cmd/mcp-server` | 82 | 206 | 39.8% |
