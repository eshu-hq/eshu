...
Graph completed in 9.544 seconds with four owned HTTP responses, all status
200, zero console errors, and 7.456 seconds of margin inside the runner's
...
`absolute_target_applicable` classification. The measured 9.544-second result
