...
| `ESHU_REMOTE_E2E_DERIVED_TARGET_LIMIT` | `100` | Package-registry and OSV owned-package derivation budget used by remote E2E. Raise explicitly, up to the collector validation maximum, only for full-corpus package/advisory proof. |
