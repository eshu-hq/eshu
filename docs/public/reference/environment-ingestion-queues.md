...
| `NORNICDB_IMAGE` | `timothyswt/nornicdb-cpu-bge:v1.3.3@sha256:81cedbf48898f4c37d05c325fee76b6d797b43e290e3a8a4e9eea936f0ec827f` in default Compose | Docker Compose | NornicDB image override. Set with `NORNICDB_PULL_POLICY` for controlled comparisons. |
