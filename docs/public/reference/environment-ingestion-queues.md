...
| `NORNICDB_IMAGE` | `ghcr.io/eshu-hq/nornicdb-amd64-cpu:fix-499-6ac958a9@sha256:fc90a2c3115d5dc0fe9a69ac676e5c77428bcfdcadc3320f2e99f887bea22f26` in default Compose | Docker Compose | NornicDB image override. Set with `NORNICDB_PULL_POLICY` for controlled comparisons. |
