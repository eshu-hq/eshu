...
| `ESHU_REPO_SHARD_INDEX` | `0` | collector selector | Zero-based shard index; must be less than `ESHU_REPO_SHARD_COUNT`. Helm injects the StatefulSet pod index for ingester replicas. |
