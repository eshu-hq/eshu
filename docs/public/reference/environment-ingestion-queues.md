...
| `NORNICDB_IMAGE` | `timothyswt/nornicdb-cpu-bge:v1.3.2@sha256:a47ae7eadc80229d3109ade7a57dfc1f1504b7586798859e2b2ac6fc38897440` in default Compose | Docker Compose | NornicDB image override. Set with `NORNICDB_PULL_POLICY` for controlled comparisons. |
| `NORNICDB_PLATFORM` | `linux/amd64` | Docker Compose | Platform override for the bundled backend. Only the amd64 default has live v1.3.2 proof; use a separate project and fresh graph volume for unsupported architecture experiments. |
