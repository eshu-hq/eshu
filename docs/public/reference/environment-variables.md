...
| Workflow coordinator, Terraform-state, AWS, OCI, package-registry, vulnerability-intelligence, Confluence, and webhook variables | [Collector Environment](environment-collectors.md) |
