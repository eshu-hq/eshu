...
| CI/CD runs | `ci_cd_run` | `ci.pipeline_definition`, `ci.workflow_image_evidence`, `ci.run`, `ci.job`, `ci.step`, `ci.artifact`, `ci.trigger_edge`, `ci.environment_observation`, `ci.deployment_event`, `ci.warning` |
