...
If step 5 finds the target superseded (#7130), Ack rolls back (the scope pointer does not move), marks the
work item superseded and returns `ErrWorkSuperseded`. Replay also skips such rows.
