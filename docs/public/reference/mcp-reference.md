...
| Runtime status | `list_collectors`, `list_ingesters`, `get_ingester_status`, `get_index_status`, `get_semantic_capability_status`, `get_answer_narration_status`, `list_component_extensions`, `get_component_extension_diagnostics` |
