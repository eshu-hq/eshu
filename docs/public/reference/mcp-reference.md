...
| Family | Tools |
| --- | --- |
| Code search and analysis | `find_code`, `find_symbol`, `inspect_code_inventory`, `investigate_import_dependencies`, `inspect_call_graph_metrics`, `investigate_code_topic`, `investigate_hardcoded_secrets`, `get_code_relationship_story`, `analyze_code_relationships`, `find_dead_code`, `investigate_dead_code`, `find_cross_repo_dead_code`, `find_code_divergence`, `investigate_code_divergence`, `calculate_cyclomatic_complexity`, `find_most_complex_functions`, `inspect_code_quality`, `execute_language_query`, `find_function_call_chain`, `compare_code_paths` |
