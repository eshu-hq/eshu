...
| Kotlin | `Closed` | The documented Kotlin receiver, chaining, and constructor surfaces are supported end to end. | `docs/public/languages/kotlin.md`, `go/internal/parser/engine_kotlin_*`, `go/internal/query/code_relationships_graph_kotlin_*` | Broader whole-program inference remains outside this documented claim. |
| Kustomize | `Closed` | The documented Kustomize overlay, patch, and typed deploy-source surfaces are supported end to end. | `docs/public/languages/kustomize.md`, `go/internal/parser/engine_yaml_semantics_kustomize_test.go`, `go/internal/query/content_relationships_kustomize_*` | `components`/`configurations` and inline patch bodies remain bounded non-goals. |
...
| SQL | `Partial` | The documented SQL/dbt surface is supported, but compiled lineage still has bounded gaps. | `docs/public/languages/sql.md`, `go/internal/parser/sql_*`, `go/internal/parser/dbt_sql_lineage_parity_test.go` | Unresolved refs, opaque templated expressions, complex macros, and derived expressions remain bounded. |
...
| Crossplane | `Partial` | The documented Crossplane surface is supported, but composition transforms remain bounded. | `docs/public/languages/crossplane.md`, `go/internal/parser/engine_yaml_semantics_test.go` | Patch transforms, validation schema detail, and composition functions stay outside this documented claim. |
| Helm | `Partial` | The documented Helm surface is supported, but hooks and weight modeling remain bounded. | `docs/public/languages/helm.md`, `go/internal/parser/engine_yaml_semantics_kustomize_test.go` | No query/content fallback surface yet and hook metadata remains unstructured. |
