...
| Helm | `Partial` | The documented Helm surface is supported, but hooks and weight modeling remain bounded. | `docs/public/languages/helm.md`, `go/internal/parser/engine_yaml_semantics_test.go` | No query/content fallback surface yet and hook metadata remains unstructured. |
