...
| `collector:jira` | fault | go_test | go-test-race | `go/internal/replay/inputtape/fault_collectors_incident_test.go` |
...
| `collector:oci_registry` | fault | go_test | go-test-race | `go/internal/replay/inputtape/fault_collectors_supplychain_test.go` |
...
| `collector:package_registry` | fault | go_test | go-test-race | `go/internal/replay/inputtape/fault_collectors_supplychain_test.go` |
| `collector:pagerduty` | baseline | cassette | golden-corpus-gate | `testdata/cassettes/pagerduty/supply-chain-demo.json` |
| `collector:pagerduty` | fault | go_test | go-test-race | `go/internal/replay/inputtape/fault_collectors_incident_test.go` |
...
| `collector:sbom_attestation` | fault | go_test | go-test-race | `go/internal/replay/inputtape/fault_collectors_supplychain_test.go` |
...
| `collector:security_alert` | fault | go_test | go-test-race | `go/internal/replay/inputtape/fault_collectors_incident_test.go` |
...
| `collector:terraform_state` | fault | go_test | go-test-race | `go/internal/replay/inputtape/fault_collectors_supplychain_test.go` |
...
| `collector:vulnerability_intelligence` | fault | go_test | go-test-race | `go/internal/replay/inputtape/fault_collectors_supplychain_test.go` |
