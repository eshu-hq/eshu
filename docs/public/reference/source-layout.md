...
| `go/internal/projector/observabilitycoveragematerialization/` | observability-coverage-materialization reducer-intent family builder and its aws_resource decode wrapper |
