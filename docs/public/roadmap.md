...
| GCP | `gated` | Partition-filtered handler proof and a deployed-shape promotion proof; the #1997/#2644 security-only sanitized smoke is complete. Currently a risky resource-scope fallback. |
