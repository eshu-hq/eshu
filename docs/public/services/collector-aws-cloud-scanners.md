...
| `ec2` | VPC, subnet, security group, security-group rule, ENI topology. The EC2 scanner owns the instance/ENI surface; VPC network-fabric resources live in the `vpc` scanner. |
