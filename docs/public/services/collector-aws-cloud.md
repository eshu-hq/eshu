...
- Scanner registry: `go/internal/collector/awscloud/awsruntime/registry.go`
...
records claim, credential, and service-scan spans. The collector metric catalog
is in [Ingestion And Collector Metrics](../reference/telemetry/metrics-ingestion-collectors.md).
