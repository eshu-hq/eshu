...
package_dir="$repo_root/examples/collector-extensions/scorecard"
...
rg -q '"id": "dev.eshu.examples.scorecard"' "$output_dir/inspect.json"
...
run_eshu component enable dev.eshu.examples.scorecard \
  --component-home "$component_home" \
