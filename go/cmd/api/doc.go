...
// chain attachment, impact finding, and impact explanation reads, and listens
// on ESHU_API_ADDR (default :8080) wrapped in otelhttp instrumentation. On
...
// sync, parsing, fact emission, or queued projection work.
//
