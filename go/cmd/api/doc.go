...
// chain attachment reads, and listens on ESHU_API_ADDR (default :8080) wrapped
// in otelhttp instrumentation. On SIGINT or SIGTERM it gives the HTTP server
// up to five seconds for graceful shutdown before exiting. The runtime serves
