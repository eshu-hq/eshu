...
// commands (`component inspect|verify|install|list|enable|disable|uninstall`)
// with stable JSON output, classified errors, and dry-run planning for install
// and enable, service launch (`mcp start`, `api start`,
