...
func groupCRemainingExpectations() []groupCRemainingExpectation {
	...
	return []groupCRemainingExpectation{
		...
		{slug: "prod-pre-change-impact", surface: "mcp", key: "analyze_pre_change_impact", minimum: 1, maximum: 10, resultsField: "direct_impact", arguments: map[string]any{"repo_id": libCommonRepoID, "changed_paths": []any{"common.go"}, "limit": float64(10)}, values: map[string]any{"workflow": "pre_change_impact", "changed_file_count": float64(1), "changed_files[].repo_id": libCommonRepoID, "changed_files[].path": "common.go"}, objectMatches: map[string][]map[string]any{"direct_impact[]": {{"id": ordersRepoID, "name": "orders-api", "depth": float64(1)}}}},
		...
		{slug: "prod-relationship-story", surface: "mcp", key: "get_code_relationship_story", minimum: 1, maximum: 1, resultsField: "relationships", arguments: map[string]any{"entity_id": "repository:r_ea78e8bb:main.go", "relationship_type": "IMPORTS", "direction": "outgoing", "limit": float64(10)}, values: map[string]any{"target_resolution.entity_id": "repository:r_ea78e8bb:main.go", "target_resolution.status": "resolved"}, objectMatches: map[string][]map[string]any{"relationships[]": {{"type": "IMPORTS", "source_id": "repository:r_ea78e8bb:main.go", "source_name": "main.go", "target_name": "github.com/acme/lib-common"}}}},
		{slug: "prod-replatforming-ownership", surface: "mcp", key: "find_unmanaged_resource_owners", minimum: 1, maximum: 1, resultsField: "ownership_packets", arguments: map[string]any{"scope_id": awsScope, "finding_kinds": []any{"image_version_drift"}, "limit": float64(10)}, values: map[string]any{"scope_id": awsScope, "ownership_packets[].stable_id": awsARN, "ownership_packets[].finding_kind": "image_version_drift"}},
		{slug: "prod-replatforming-plan-readiness", surface: "mcp", key: "compose_replatforming_plan", minimum: 1, maximum: 10, resultsField: "blast_radius_summaries", arguments: map[string]any{"scope_kind": "resource", "scope_id": awsScope, "arn": awsARN, "finding_kinds": []any{"image_version_drift"}, "limit": float64(10)}, values: map[string]any{"scope_id": awsScope, "plan.scope.resource": awsARN, "plan.items[].stable_id": awsARN, "analysis_status": "replatforming_plan_composition"}},
		{slug: "prod-replatforming-rollups", surface: "mcp", key: "get_replatforming_rollups", arguments: map[string]any{"scope_id": awsScope, "finding_kinds": []any{"image_version_drift"}, "limit": float64(10)}, values: map[string]any{"scope_id": awsScope, "rollup_findings_count": float64(1), "analysis_status": "replatforming_rollups"}, paths: []string{"dimensions.account[]"}, objectMatches: map[string][]map[string]any{"dimensions.account[]": {{"key": "123456789012"}}}, scalar: true},
		...
		{slug: "prod-security-alert-reconciliation-aggregate", surface: "mcp", key: "get_security_alert_reconciliation_inventory", minimum: 1, maximum: 1, resultsField: "buckets", arguments: map[string]any{"group_by": "provider", "provider": "github_dependabot", "ghsa_id": "GHSA-scd0-0000-demo", "limit": float64(10), "offset": float64(0)}, objectMatches: map[string][]map[string]any{"buckets[]": {{"dimension": "provider", "value": "github_dependabot", "count": float64(1)}}}},
		{slug: "prod-security-alert-reconciliations", surface: "mcp", key: "list_security_alert_reconciliations", minimum: 1, maximum: 1, resultsField: "reconciliations", arguments: map[string]any{"provider": "github_dependabot", "ghsa_id": "GHSA-scd0-0000-demo", "limit": float64(10)}, values: map[string]any{"reconciliations[].provider_alert.provider_alert_id": "github_dependabot:security_alert:supply-chain-demo:supply-chain-demo:42", "reconciliations[].provider_alert.ghsa_ids[]": "GHSA-scd0-0000-demo"}},
		{slug: "prod-structural-inventory", surface: "mcp", key: "inspect_code_inventory", minimum: 1, maximum: 1, resultsField: "results", arguments: map[string]any{"repo_id": "orders-api", "inventory_kind": "entity", "entity_kind": "Function", "symbol": "main", "limit": float64(1)}, objectMatches: map[string][]map[string]any{"results[]": {{"entity_id": "content-entity:e_85bff2c7884a", "name": "main", "repo_id": ordersRepoID, "relative_path": "main.go"}}}},
		{slug: "prod-symbol-lookup", surface: "mcp", key: "find_symbol", minimum: 1, maximum: 1, resultsField: "results", arguments: map[string]any{"symbol": "main", "repo_id": "orders-api", "limit": float64(1)}, objectMatches: map[string][]map[string]any{"results[]": {{"entity_id": "content-entity:e_85bff2c7884a", "name": "main", "repo_id": ordersRepoID, "relative_path": "main.go"}}}},
		{slug: "prod-topic-investigation", surface: "mcp", key: "investigate_code_topic", minimum: 1, maximum: 10, resultsField: "evidence_groups", arguments: map[string]any{"topic": "lib-common", "repo_id": "orders-api", "limit": float64(10)}, values: map[string]any{"topic": "lib-common", "searched_terms": []any{"common", "lib"}}, objectMatches: map[string][]map[string]any{"evidence_groups[]": {{"repo_id": ordersRepoID, "relative_path": "main.go", "matched_terms": []any{"common", "lib"}}}}},
