...
func groupCRemainingExpectations() []groupCRemainingExpectation {
	...
	return []groupCRemainingExpectation{
		...
		{slug: "prod-topic-investigation", surface: "mcp", key: "investigate_code_topic", minimum: 1, maximum: 10, resultsField: "evidence_groups", arguments: map[string]any{"topic": "lib-common", "repo_id": "orders-api", "limit": float64(10)}, values: map[string]any{"topic": "lib-common", "searched_terms": []any{"common", "lib"}}, objectMatches: map[string][]map[string]any{"evidence_groups[]": {{"repo_id": "orders-api", "relative_path": "main.go", "matched_terms": []any{"common", "lib"}}}}},
