...
// advisory evidence, work-item evidence, impact finding, and impact explanation
// read models plus the shared runtime admin mux, and dispatches MCP tool calls through
// mcp.Server. The
