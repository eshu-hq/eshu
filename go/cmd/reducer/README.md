...
| ESHU_SHARED_PROJECTION_LEASE_OWNER | `shared-projection-runner:<hostname>:<pid>:<boot-nonce>` | Per-process partition lease owner; a configured value replaces the prefix |
