...
func TestSemanticEntityWriterForGraphBackendAppliesDefaultNornicDBAnnotationCap(t *testing.T) {
	...
	rows := make([]semantic.EntityRow, 0, 31)
	for i := 0; i < 31; i++ {
...
func TestSemanticEntityWriterForGraphBackendAppliesDefaultNornicDBTypeAliasCap(t *testing.T) {
	...
	rows := make([]semantic.EntityRow, 0, 11)
	for i := 0; i < 11; i++ {
...
func TestSemanticEntityWriterForGraphBackendAppliesDefaultNornicDBTypeAnnotationCap(t *testing.T) {
	...
	rows := make([]semantic.EntityRow, 0, 101)
	for i := 0; i < 101; i++ {
...
func semanticAnnotationRow(id string) semantic.EntityRow {
...
func semanticTypeAliasRow(id string) semantic.EntityRow {
	return semantic.EntityRow{
		RepoID:       "repo-1",
		EntityID:     id,
...
func semanticTypeAnnotationRow(id string) semantic.EntityRow {
	return semantic.EntityRow{
		RepoID:       "repo-1",
		EntityID:     id,
