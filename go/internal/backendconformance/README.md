...
(count descending, text ascending, each label elided to
`AdvisoryStatementMaxLen` runes) for the gate's advisory and ceiling
findings (#6941). UNWIND batches and single-use IN-list filters explode into
