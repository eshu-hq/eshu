...
re-derive them. **Measured against `2af1e3567`** and re-derived unchanged at
`606f404f9`. Nothing between those two commits, or since, adds a file to this
directory or a new importer of this package, which is why none of the figures
move — re-derive with the commands below if you need them at a later commit.
