...
6. Service package docs under `services/` before changing scanner-specific
   behavior.
7. `docs/public/services/collector-aws-cloud.md` - AWS collector runtime flow, claim, and fact boundary.
8. `docs/public/services/collector-aws-cloud-security.md` - credential, scope, and redaction guardrails.
9. `docs/public/services/collector-aws-cloud-scanners.md` - scanner coverage and forbidden data classes.
10. `docs/public/guides/collector-authoring.md` - general collector fact contract.
