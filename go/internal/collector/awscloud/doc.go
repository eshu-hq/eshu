...
// values, policy persistence, payload capture, and mutation APIs. ECS and
// Lambda environment values must be redacted through this package before
// callers build envelopes.
package awscloud
