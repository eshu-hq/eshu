...
`internal/collector/awscloud/service/amplify/runtimebind` registers the Amplify
...
`internal/collector/awscloud/service/amplify` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/amplify` for the scanner struct.
- `internal/collector/awscloud/service/amplify/awssdk` for the SDK adapter
  constructor.
