# AGENTS.md - services/apigateway/runtimebind guidance
...
- Register exactly once from `init()` with `awscloud.ServiceAPIGateway`.
...
- Update the builder body only when the API Gateway scanner constructor
