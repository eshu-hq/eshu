# AGENTS.md - services/auditmanager/runtimebind guidance
...
- Register exactly once from `init()` with `awscloud.ServiceAuditManager`.
...
- Update the builder body only when the Audit Manager scanner constructor
