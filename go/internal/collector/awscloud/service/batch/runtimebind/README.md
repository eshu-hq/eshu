...
`internal/collector/awscloud/service/batch/runtimebind` registers the AWS
...
`internal/collector/awscloud/service/batch` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/batch` for the scanner struct.
- `internal/collector/awscloud/service/batch/awssdk` for the SDK adapter
  constructor.
