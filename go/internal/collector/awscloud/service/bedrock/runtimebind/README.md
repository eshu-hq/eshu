...
`internal/collector/awscloud/service/bedrock/runtimebind` registers the Bedrock
...
`internal/collector/awscloud/service/bedrock` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/bedrock` for the scanner struct.
- `internal/collector/awscloud/service/bedrock/awssdk` for the SDK adapter
  constructor.
