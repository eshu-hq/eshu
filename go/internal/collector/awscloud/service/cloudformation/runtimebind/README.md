...
`internal/collector/awscloud/service/cloudformation/runtimebind` registers the
...
`internal/collector/awscloud/service/cloudformation` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/cloudformation` for the scanner struct.
- `internal/collector/awscloud/service/cloudformation/awssdk` for the SDK
  adapter constructor.
