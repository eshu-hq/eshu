...
`internal/collector/awscloud/service/cloudfront/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/cloudfront` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/cloudfront` for the scanner struct.
- `internal/collector/awscloud/service/cloudfront/awssdk` for the SDK
  adapter constructor.
