...
`internal/collector/awscloud/service/codebuild/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/codebuild` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/codebuild` for the scanner struct.
- `internal/collector/awscloud/service/codebuild/awssdk` for the SDK adapter
  constructor.
