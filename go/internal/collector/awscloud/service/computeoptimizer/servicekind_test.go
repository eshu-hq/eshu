...
// service_kind is written back as the canonical value on every emitted fact. The
// Scan switch trims only for the comparison, so without the write-back the padded
// string leaks into each fact's service_kind and breaks graph joins/filters that
