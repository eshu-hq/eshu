...
`internal/collector/awscloud/service/discovery/runtimebind` registers
...
`internal/collector/awscloud/service/discovery` and its `awssdk`
adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/discovery` for the scanner
  struct.
- `internal/collector/awscloud/service/discovery/awssdk` for the SDK
  adapter constructor.
