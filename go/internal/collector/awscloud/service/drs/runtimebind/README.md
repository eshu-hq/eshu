...
`internal/collector/awscloud/service/drs/runtimebind` registers the DRS scanner
...
`internal/collector/awscloud/service/drs` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/drs` for the scanner struct.
- `internal/collector/awscloud/service/drs/awssdk` for the SDK adapter
  constructor.
