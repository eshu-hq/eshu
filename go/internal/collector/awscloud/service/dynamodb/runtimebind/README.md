...
`internal/collector/awscloud/service/dynamodb/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/dynamodb` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/dynamodb` for the scanner struct.
- `internal/collector/awscloud/service/dynamodb/awssdk` for the SDK
  adapter constructor.
