...
`internal/collector/awscloud/service/elasticache/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/elasticache` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/elasticache` for the scanner struct.
- `internal/collector/awscloud/service/elasticache/awssdk` for the SDK
  adapter constructor.
