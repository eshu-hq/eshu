...
`internal/collector/awscloud/service/fsx/runtimebind` registers the FSx scanner
...
`internal/collector/awscloud/service/fsx` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/fsx` for the scanner struct.
- `internal/collector/awscloud/service/fsx/awssdk` for the SDK adapter
  constructor.
