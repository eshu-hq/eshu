...
`internal/collector/awscloud/service/globalaccelerator/runtimebind` registers
...
`internal/collector/awscloud/service/globalaccelerator` and its `awssdk`
adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/globalaccelerator` for the scanner
  struct.
- `internal/collector/awscloud/service/globalaccelerator/awssdk` for the SDK
  adapter constructor.
