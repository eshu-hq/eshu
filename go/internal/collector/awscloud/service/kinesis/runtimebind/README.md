...
`internal/collector/awscloud/service/kinesis/runtimebind` registers the
...
`internal/collector/awscloud/service/kinesis` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/kinesis` for the scanner struct.
- `internal/collector/awscloud/service/kinesis/awssdk` for the SDK adapter
  constructor.
