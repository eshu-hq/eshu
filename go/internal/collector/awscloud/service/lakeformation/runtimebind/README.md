...
`internal/collector/awscloud/service/lakeformation/runtimebind` registers the
...
`internal/collector/awscloud/service/lakeformation` and its `awssdk` adapter.
...
- `internal/collector/awscloud/service/lakeformation` for the scanner struct.
- `internal/collector/awscloud/service/lakeformation/awssdk` for the SDK
  adapter constructor.
