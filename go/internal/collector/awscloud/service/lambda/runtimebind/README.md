...
`internal/collector/awscloud/service/lambda/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/lambda` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/lambda` for the scanner struct.
- `internal/collector/awscloud/service/lambda/awssdk` for the SDK
  adapter constructor.
