...
`internal/collector/awscloud/service/location` owns the Amazon Location Service
...
`go test ./internal/collector/awscloud/service/location/...` covers the bounded
...
No-Regression Evidence: metadata-only control-plane scanner; new read path, no change to existing hot paths. `go test ./internal/collector/awscloud/service/location/...` green.
