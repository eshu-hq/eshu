...
`internal/collector/awscloud/service/mgn` owns the AWS Application Migration
...
`go test ./internal/collector/awscloud/service/mgn/...` covers the bounded MGN
...
No-Regression Evidence: metadata-only control-plane scanner; new read path, no change to existing hot paths. `go test ./internal/collector/awscloud/service/mgn/...` green.
