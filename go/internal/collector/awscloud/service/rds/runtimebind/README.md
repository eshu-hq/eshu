...
`internal/collector/awscloud/service/rds/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/rds` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/rds` for the scanner struct.
- `internal/collector/awscloud/service/rds/awssdk` for the SDK
  adapter constructor.
