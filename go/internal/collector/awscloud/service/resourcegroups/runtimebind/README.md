...
`internal/collector/awscloud/service/resourcegroups/runtimebind` registers the
...
`internal/collector/awscloud/service/resourcegroups` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/resourcegroups` for the scanner struct.
- `internal/collector/awscloud/service/resourcegroups/awssdk` for the SDK
  adapter constructor.
