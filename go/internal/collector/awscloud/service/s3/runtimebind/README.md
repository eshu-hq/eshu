...
`internal/collector/awscloud/service/s3/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/s3` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/s3` for the scanner struct.
- `internal/collector/awscloud/service/s3/awssdk` for the SDK
  adapter constructor.
