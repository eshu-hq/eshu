...
`internal/collector/awscloud/service/securityhub/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/securityhub` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/securityhub` for the scanner struct.
- `internal/collector/awscloud/service/securityhub/awssdk` for the SDK
  adapter constructor.
