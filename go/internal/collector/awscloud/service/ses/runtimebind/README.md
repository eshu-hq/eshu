...
`internal/collector/awscloud/service/ses/runtimebind` registers the SES (v2)
...
`internal/collector/awscloud/service/ses` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/ses` for the scanner struct.
- `internal/collector/awscloud/service/ses/awssdk` for the SDK adapter
  constructor.
