...
`internal/collector/awscloud/service/ssm/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/ssm` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/ssm` for the scanner struct.
- `internal/collector/awscloud/service/ssm/awssdk` for the SDK
  adapter constructor.
