...
`internal/collector/awscloud/service/stepfunctions/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/stepfunctions` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/stepfunctions` for the scanner struct.
- `internal/collector/awscloud/service/stepfunctions/awssdk` for the SDK
  adapter constructor.
