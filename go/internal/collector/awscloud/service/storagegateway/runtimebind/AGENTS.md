# AGENTS.md - services/storagegateway/runtimebind guidance

## Read First

1. `README.md` - one-binding contract and ownership boundary.
2. `bind.go` - the actual registration.
3. `../README.md` - Storage Gateway scanner contract.
4. `../../../awsruntime/README.md` - awsruntime registry and runtime surface.

## Invariants

- Register exactly once from `init()` with `awscloud.ServiceStorageGateway`.
...
- Update the builder body only when the Storage Gateway scanner constructor
