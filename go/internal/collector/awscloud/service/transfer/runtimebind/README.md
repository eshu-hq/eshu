...
`internal/collector/awscloud/service/transfer/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/transfer` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/transfer` for the scanner struct.
- `internal/collector/awscloud/service/transfer/awssdk` for the SDK
  adapter constructor.
