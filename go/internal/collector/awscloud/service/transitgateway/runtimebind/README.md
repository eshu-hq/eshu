...
`internal/collector/awscloud/service/transitgateway/runtimebind` registers the
...
emission. Those belong to `internal/collector/awscloud/service/transitgateway`
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/transitgateway` for the scanner struct.
- `internal/collector/awscloud/service/transitgateway/awssdk` for the SDK
  adapter constructor.
