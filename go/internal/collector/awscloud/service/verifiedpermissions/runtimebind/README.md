...
`internal/collector/awscloud/service/verifiedpermissions/runtimebind` registers
...
`internal/collector/awscloud/service/verifiedpermissions` and its `awssdk`
adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/verifiedpermissions` for the scanner
  struct.
- `internal/collector/awscloud/service/verifiedpermissions/awssdk` for the SDK
  adapter constructor.
