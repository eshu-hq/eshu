...
`internal/collector/awscloud/service/vpclattice/runtimebind` registers the VPC
...
Those belong to `internal/collector/awscloud/service/vpclattice` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/vpclattice` for the scanner struct.
- `internal/collector/awscloud/service/vpclattice/awssdk` for the SDK adapter
  constructor.
