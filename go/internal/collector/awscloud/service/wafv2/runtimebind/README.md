...
`internal/collector/awscloud/service/wafv2/runtimebind` registers the WAFv2
...
`internal/collector/awscloud/service/wafv2` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/wafv2` for the scanner struct.
- `internal/collector/awscloud/service/wafv2/awssdk` for the SDK adapter
  constructor.
