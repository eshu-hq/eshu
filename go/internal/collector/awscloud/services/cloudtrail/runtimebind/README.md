# AWS CloudTrail Scanner Runtime Binding

## Purpose

`internal/collector/awscloud/services/cloudtrail/runtimebind` registers the
...
emission. Those belong to `internal/collector/awscloud/services/cloudtrail`
...
- `internal/collector/awscloud/services/cloudtrail` for the scanner struct.
- `internal/collector/awscloud/services/cloudtrail/awssdk` for the SDK
  adapter constructor.
