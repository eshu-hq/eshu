# AGENTS.md - services/cloudwatchlogs/runtimebind guidance

## Read First

1. `README.md` - one-binding contract and ownership boundary.
2. `bind.go` - the actual registration.
3. `../README.md` - CloudWatch Logs scanner contract.
4. `../../../awsruntime/README.md` - awsruntime registry and runtime surface.

## Invariants

- Register exactly once from `init()` with `awscloud.ServiceCloudWatchLogs`.
...
- Update the builder body only when the CloudWatch Logs scanner constructor
