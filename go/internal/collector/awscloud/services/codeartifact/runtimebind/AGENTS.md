# AGENTS.md - services/codeartifact/runtimebind guidance

## Read First

1. `README.md` - one-binding contract and ownership boundary.
2. `bind.go` - the actual registration.
3. `../README.md` - CodeArtifact scanner contract.
4. `../../../awsruntime/README.md` - awsruntime registry and runtime surface.

## Invariants

- Register exactly once from `init()` with `awscloud.ServiceCodeArtifact`.
...
- Update the builder body only when the CodeArtifact scanner constructor
