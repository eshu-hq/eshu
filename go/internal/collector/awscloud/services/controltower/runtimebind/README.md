# AWS Control Tower Scanner Runtime Binding

## Purpose

`internal/collector/awscloud/services/controltower/runtimebind` registers the
...
`internal/collector/awscloud/services/controltower` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/services/controltower` for the scanner struct.
- `internal/collector/awscloud/services/controltower/awssdk` for the SDK adapter
  constructor.
