...
// Package runtimebind binds the ECS service scanner into the
...
import (
	...
	svc "github.com/eshu-hq/eshu/go/internal/collector/awscloud/services/ecs"
	sdkadapter "github.com/eshu-hq/eshu/go/internal/collector/awscloud/services/ecs/awssdk"
)
