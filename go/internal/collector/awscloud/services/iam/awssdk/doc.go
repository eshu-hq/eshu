...
// body or condition values. OIDC provider URLs are fingerprinted, and client IDs
// and thumbprints are counted only. The per-principal managed policy document
