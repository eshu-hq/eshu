...
// statements (effect, action set, resource pattern, condition-key summary). The
// scanner never emits the raw policy JSON body or condition values; the SDK
// adapter normalizes documents at the wiring boundary.
//
