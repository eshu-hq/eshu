...
// Package runtimebind binds the KMS service scanner into the
...
import (
	...
	svc "github.com/eshu-hq/eshu/go/internal/collector/awscloud/services/kms"
	sdkadapter "github.com/eshu-hq/eshu/go/internal/collector/awscloud/services/kms/awssdk"
)
