# AWS OpenSearch Scanner Runtime Binding

## Purpose

`internal/collector/awscloud/services/opensearch/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/services/opensearch` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/services/opensearch` for the scanner struct.
- `internal/collector/awscloud/services/opensearch/awssdk` for the SDK
  adapter constructor.
