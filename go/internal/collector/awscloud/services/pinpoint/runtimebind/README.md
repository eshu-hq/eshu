# Amazon Pinpoint Scanner Runtime Binding

## Purpose

`internal/collector/awscloud/services/pinpoint/runtimebind` registers the
...
belong to `internal/collector/awscloud/services/pinpoint` and its `awssdk`
adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/services/pinpoint` for the scanner struct.
- `internal/collector/awscloud/services/pinpoint/awssdk` for the SDK adapter
  constructor.
