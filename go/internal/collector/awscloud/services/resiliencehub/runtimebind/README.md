# AWS Resilience Hub Scanner Runtime Binding

## Purpose

`internal/collector/awscloud/services/resiliencehub/runtimebind` registers the
...
`internal/collector/awscloud/services/resiliencehub` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/services/resiliencehub` for the scanner struct.
- `internal/collector/awscloud/services/resiliencehub/awssdk` for the SDK adapter
  constructor.
