...
// Package runtimebind binds the S3 service scanner into the
...
import (
	...
	svc "github.com/eshu-hq/eshu/go/internal/collector/awscloud/services/s3"
	sdkadapter "github.com/eshu-hq/eshu/go/internal/collector/awscloud/services/s3/awssdk"
)
