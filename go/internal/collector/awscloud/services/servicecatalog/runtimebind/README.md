...
`internal/collector/awscloud/services/servicecatalog/runtimebind` registers the
...
belong to `internal/collector/awscloud/services/servicecatalog` and its `awssdk`
adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/services/servicecatalog` for the scanner struct.
- `internal/collector/awscloud/services/servicecatalog/awssdk` for the SDK
  adapter constructor.
