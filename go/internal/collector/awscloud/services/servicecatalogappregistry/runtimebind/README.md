# Service Catalog AppRegistry Scanner Runtime Binding

## Purpose

`internal/collector/awscloud/services/servicecatalogappregistry/runtimebind`
...
Those belong to
`internal/collector/awscloud/services/servicecatalogappregistry` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/services/servicecatalogappregistry` for the
  scanner struct.
- `internal/collector/awscloud/services/servicecatalogappregistry/awssdk` for
