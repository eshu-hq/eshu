# AWS Shield Advanced Scanner Runtime Binding

## Purpose

`internal/collector/awscloud/services/shield/runtimebind` registers the Shield
...
`internal/collector/awscloud/services/shield` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/services/shield` for the scanner struct.
- `internal/collector/awscloud/services/shield/awssdk` for the SDK adapter
  constructor.
