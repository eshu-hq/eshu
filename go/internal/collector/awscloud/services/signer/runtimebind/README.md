# AWS Signer Scanner Runtime Binding

## Purpose

`internal/collector/awscloud/services/signer/runtimebind` registers the Signer
...
`internal/collector/awscloud/services/signer` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/services/signer` for the scanner struct.
- `internal/collector/awscloud/services/signer/awssdk` for the SDK adapter
  constructor.
