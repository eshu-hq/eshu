# AWS SNS Scanner Runtime Binding

## Purpose

`internal/collector/awscloud/services/sns/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/services/sns` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/services/sns` for the scanner struct.
- `internal/collector/awscloud/services/sns/awssdk` for the SDK
  adapter constructor.
