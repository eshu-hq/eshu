# AGENTS.md - services/transitgateway/runtimebind guidance
...
- Register exactly once from `init()` with `awscloud.ServiceTransitGateway`.
...
- Update the builder body only when the Transit Gateway scanner constructor
