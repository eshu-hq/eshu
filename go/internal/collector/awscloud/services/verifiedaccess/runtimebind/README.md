# Amazon Verified Access Scanner Runtime Binding

## Purpose

`internal/collector/awscloud/services/verifiedaccess/runtimebind` registers the
...
emission. Those belong to `internal/collector/awscloud/services/verifiedaccess`
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/services/verifiedaccess` for the scanner struct.
- `internal/collector/awscloud/services/verifiedaccess/awssdk` for the SDK
  adapter constructor.
