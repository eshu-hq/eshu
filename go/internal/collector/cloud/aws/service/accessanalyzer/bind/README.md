...
`internal/collector/awscloud/service/accessanalyzer/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/accessanalyzer` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/accessanalyzer` for the scanner struct.
- `internal/collector/awscloud/service/accessanalyzer/awssdk` for the SDK
  adapter constructor.
