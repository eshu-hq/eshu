...
`internal/collector/awscloud/service/acm/runtimebind` registers the ACM scanner
...
`internal/collector/awscloud/service/acm` and its `awssdk` adapter.
...
- `internal/collector/awscloud/service/acm` for the scanner struct.
- `internal/collector/awscloud/service/acm/awssdk` for the SDK adapter
  constructor.
