...
`internal/collector/awscloud/service/apigateway/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/apigateway` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/apigateway` for the scanner struct.
- `internal/collector/awscloud/service/apigateway/awssdk` for the SDK
  adapter constructor.
