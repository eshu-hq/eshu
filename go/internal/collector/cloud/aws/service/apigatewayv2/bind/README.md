...
`internal/collector/awscloud/service/apigatewayv2/runtimebind` registers the
...
emission. Those belong to `internal/collector/awscloud/service/apigatewayv2`
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/apigatewayv2` for the scanner struct.
- `internal/collector/awscloud/service/apigatewayv2/awssdk` for the SDK adapter
  constructor.
