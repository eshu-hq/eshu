...
`internal/collector/awscloud/service/apprunner/runtimebind` registers the App
...
`internal/collector/awscloud/service/apprunner` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/apprunner` for the scanner struct.
- `internal/collector/awscloud/service/apprunner/awssdk` for the SDK adapter
  constructor.
