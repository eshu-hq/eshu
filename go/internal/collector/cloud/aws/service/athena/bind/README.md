...
`internal/collector/awscloud/service/athena/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/athena` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/athena` for the scanner struct.
- `internal/collector/awscloud/service/athena/awssdk` for the SDK
  adapter constructor.
