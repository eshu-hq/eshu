...
`internal/collector/awscloud/service/auditmanager/runtimebind` registers the
...
`internal/collector/awscloud/service/auditmanager` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/auditmanager` for the scanner struct.
- `internal/collector/awscloud/service/auditmanager/awssdk` for the SDK adapter
  constructor.
