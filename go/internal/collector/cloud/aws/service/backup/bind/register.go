...
// Package bind binds the AWS Backup service scanner into the
...
import (
	...
	svc "github.com/eshu-hq/eshu/go/internal/collector/cloud/aws/service/backup"
	sdkadapter "github.com/eshu-hq/eshu/go/internal/collector/cloud/aws/service/backup/sdk"
)

func init() {
	runtime.Register(runtime.ScannerRegistration{
		ServiceKind: aws.ServiceBackup,
