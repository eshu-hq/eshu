...
func TestScannerEmitsAppRegistryMetadataAndRelationships(t *testing.T) {
	...
	app := resourceByType(t, envelopes, aws.ResourceTypeServiceCatalogAppRegistryApplication)
	...
	group := resourceByType(t, envelopes, aws.ResourceTypeServiceCatalogAppRegistryAttributeGroup)
	...
	appGroup := relationshipByType(t, envelopes, aws.RelationshipServiceCatalogAppRegistryApplicationHasAttributeGroup)
	assertEdgeTarget(t, appGroup, aws.ResourceTypeServiceCatalogAppRegistryAttributeGroup, testAttributeGroupARN)
	...
	appStack := relationshipByType(t, envelopes, aws.RelationshipServiceCatalogAppRegistryApplicationAssociatesCloudFormationStack)
	assertEdgeTarget(t, appStack, aws.ResourceTypeCloudFormationStack, testStackARN)
	...
	stackEdges := relationshipsByType(envelopes, aws.RelationshipServiceCatalogAppRegistryApplicationAssociatesCloudFormationStack)
	if len(stackEdges) != 1 {
...
func TestScannerDeduplicatesAttributeGroupEdges(t *testing.T) {
	...
	edges := relationshipsByType(envelopes, aws.RelationshipServiceCatalogAppRegistryApplicationHasAttributeGroup)
	if len(edges) != 1 {
