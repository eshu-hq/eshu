...
`internal/collector/awscloud/service/cloudwatchlogs/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/cloudwatchlogs` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/cloudwatchlogs` for the scanner struct.
- `internal/collector/awscloud/service/cloudwatchlogs/awssdk` for the SDK
  adapter constructor.
