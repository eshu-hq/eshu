...
`internal/collector/awscloud/service/codedeploy/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/codedeploy` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/codedeploy` for the scanner struct.
- `internal/collector/awscloud/service/codedeploy/awssdk` for the SDK adapter
  constructor.
