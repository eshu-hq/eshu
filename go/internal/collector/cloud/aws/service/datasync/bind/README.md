...
`internal/collector/awscloud/service/datasync/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/datasync` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/datasync` for the scanner struct.
- `internal/collector/awscloud/service/datasync/awssdk` for the SDK
  adapter constructor.
