...
`internal/collector/awscloud/service/dax/runtimebind` registers the DAX scanner
...
`internal/collector/awscloud/service/dax` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/dax` for the scanner struct.
- `internal/collector/awscloud/service/dax/awssdk` for the SDK adapter
  constructor.
