...
`internal/collector/awscloud/service/detective/runtimebind` registers the
...
`internal/collector/awscloud/service/detective` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/detective` for the scanner struct.
- `internal/collector/awscloud/service/detective/awssdk` for the SDK adapter
  constructor.
