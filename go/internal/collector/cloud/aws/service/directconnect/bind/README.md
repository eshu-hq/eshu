...
`internal/collector/awscloud/service/directconnect/runtimebind` registers the
...
belong to `internal/collector/awscloud/service/directconnect` and its `awssdk`
adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/directconnect` for the scanner struct.
- `internal/collector/awscloud/service/directconnect/awssdk` for the SDK
  adapter constructor.
