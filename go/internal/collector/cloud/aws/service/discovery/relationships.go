...
// scanner owns.
func namespaceRelationships(boundary aws.Boundary, namespace Namespace) []aws.RelationshipObservation {
	...
	return []aws.RelationshipObservation{{
		Boundary:         boundary,
		RelationshipType: aws.RelationshipCloudMapNamespaceInHostedZone,
...
func serviceRelationships(boundary aws.Boundary, service Service) []aws.RelationshipObservation {
	...
	return []aws.RelationshipObservation{{
		Boundary:         boundary,
		RelationshipType: aws.RelationshipCloudMapServiceInNamespace,
		SourceResourceID: resourceID,
		SourceARN:        strings.TrimSpace(service.ARN),
		TargetResourceID: namespaceID,
		TargetType:       aws.ResourceTypeCloudMapNamespace,
