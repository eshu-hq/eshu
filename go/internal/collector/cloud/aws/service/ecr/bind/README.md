...
`internal/collector/awscloud/service/ecr/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/ecr` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/ecr` for the scanner struct.
- `internal/collector/awscloud/service/ecr/awssdk` for the SDK
  adapter constructor.
