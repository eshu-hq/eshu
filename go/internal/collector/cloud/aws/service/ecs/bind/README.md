...
`internal/collector/awscloud/service/ecs/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/ecs` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/ecs` for the scanner struct.
- `internal/collector/awscloud/service/ecs/awssdk` for the SDK
  adapter constructor.
