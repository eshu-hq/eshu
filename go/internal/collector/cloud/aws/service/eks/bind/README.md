...
`internal/collector/awscloud/service/eks/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/eks` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/eks` for the scanner struct.
- `internal/collector/awscloud/service/eks/awssdk` for the SDK
  adapter constructor.
