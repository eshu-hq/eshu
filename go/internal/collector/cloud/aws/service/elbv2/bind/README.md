...
`internal/collector/awscloud/service/elbv2/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/elbv2` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/elbv2` for the scanner struct.
- `internal/collector/awscloud/service/elbv2/awssdk` for the SDK
  adapter constructor.
