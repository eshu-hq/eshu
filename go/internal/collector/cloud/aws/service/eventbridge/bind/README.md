...
`internal/collector/awscloud/service/eventbridge/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/eventbridge` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/eventbridge` for the scanner struct.
- `internal/collector/awscloud/service/eventbridge/awssdk` for the SDK
  adapter constructor.
