...
// Package bind binds the FSx service scanner into the runtime
...
import (
	...
	svc "github.com/eshu-hq/eshu/go/internal/collector/cloud/aws/service/fsx"
	sdkadapter "github.com/eshu-hq/eshu/go/internal/collector/cloud/aws/service/fsx/sdk"
)

func init() {
	runtime.Register(runtime.ScannerRegistration{
		ServiceKind: aws.ServiceFSx,
