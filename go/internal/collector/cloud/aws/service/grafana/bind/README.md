...
`internal/collector/awscloud/service/grafana/runtimebind` registers the Managed
...
`internal/collector/awscloud/service/grafana` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/grafana` for the scanner struct.
- `internal/collector/awscloud/service/grafana/awssdk` for the SDK adapter
  constructor.
