...
`internal/collector/awscloud/service/imagebuilder/runtimebind` registers the
...
emission. Those belong to `internal/collector/awscloud/service/imagebuilder`
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/imagebuilder` for the scanner struct.
- `internal/collector/awscloud/service/imagebuilder/awssdk` for the SDK adapter
  constructor.
