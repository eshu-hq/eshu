...
`internal/collector/awscloud/service/keyspaces/runtimebind` registers the
...
`internal/collector/awscloud/service/keyspaces` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/keyspaces` for the scanner struct.
- `internal/collector/awscloud/service/keyspaces/awssdk` for the SDK adapter
  constructor.
