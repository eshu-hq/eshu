...
`internal/collector/awscloud/service/kms/runtimebind` registers the KMS
...
belong to `internal/collector/awscloud/service/kms` and its `awssdk`
adapter.
...
- `internal/collector/awscloud/service/kms` for the scanner struct.
- `internal/collector/awscloud/service/kms/awssdk` for the SDK adapter
  constructor.
