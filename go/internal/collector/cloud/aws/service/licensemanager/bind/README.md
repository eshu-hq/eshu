...
`internal/collector/awscloud/service/licensemanager/runtimebind` registers the
...
emission. Those belong to `internal/collector/awscloud/service/licensemanager`
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/licensemanager` for the scanner struct.
- `internal/collector/awscloud/service/licensemanager/awssdk` for the SDK
  adapter constructor.
