...
`internal/collector/awscloud/service/location/runtimebind` registers the
...
`internal/collector/awscloud/service/location` and its `awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/location` for the scanner struct.
- `internal/collector/awscloud/service/location/awssdk` for the SDK adapter
  constructor.
