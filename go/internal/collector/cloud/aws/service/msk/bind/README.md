...
`internal/collector/awscloud/service/msk/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/msk` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/msk` for the scanner struct.
- `internal/collector/awscloud/service/msk/awssdk` for the SDK
  adapter constructor.
