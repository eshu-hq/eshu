...
`internal/collector/awscloud/service/opensearchserverless/runtimebind` registers
...
`internal/collector/awscloud/service/opensearchserverless` and its `awssdk`
adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/opensearchserverless` for the scanner
  struct.
- `internal/collector/awscloud/service/opensearchserverless/awssdk` for the SDK
  adapter constructor.
