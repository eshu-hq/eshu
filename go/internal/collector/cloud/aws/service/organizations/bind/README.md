...
`internal/collector/awscloud/service/organizations/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/organizations` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/organizations` for the scanner struct.
- `internal/collector/awscloud/service/organizations/awssdk` for the SDK
  adapter constructor.
