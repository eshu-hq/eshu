...
`internal/collector/awscloud/service/redshift/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/redshift` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/redshift` for the scanner struct.
- `internal/collector/awscloud/service/redshift/awssdk` for the SDK
  adapter constructor.
