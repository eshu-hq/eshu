...
`internal/collector/awscloud/service/route53/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/route53` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/route53` for the scanner struct.
- `internal/collector/awscloud/service/route53/awssdk` for the SDK
  adapter constructor.
