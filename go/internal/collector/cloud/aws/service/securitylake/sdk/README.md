...
`internal/collector/awscloud/service/securitylake/awssdk` adapts AWS SDK for Go
...
- `internal/collector/awscloud` for account, region, and service boundary
  labels.
- `internal/collector/awscloud/service/securitylake` for scanner-owned result
  types.
