...
`internal/collector/awscloud/service/sqs/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/sqs` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/service/sqs` for the scanner struct.
- `internal/collector/awscloud/service/sqs/awssdk` for the SDK
  adapter constructor.
