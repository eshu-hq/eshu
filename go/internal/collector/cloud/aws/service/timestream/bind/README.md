...
`internal/collector/awscloud/service/timestream/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/timestream` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/timestream` for the scanner struct.
- `internal/collector/awscloud/service/timestream/awssdk` for the SDK adapter
  constructor.
