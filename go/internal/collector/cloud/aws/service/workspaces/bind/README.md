...
`internal/collector/awscloud/service/workspaces/runtimebind` registers the
...
Those belong to `internal/collector/awscloud/service/workspaces` and its
`awssdk` adapter.
...
- `internal/collector/awscloud/awsruntime` for `Register`, `ScannerDeps`, and
  `ScannerRegistration`.
- `internal/collector/awscloud/service/workspaces` for the scanner struct.
- `internal/collector/awscloud/service/workspaces/awssdk` for the SDK adapter
  constructor.
