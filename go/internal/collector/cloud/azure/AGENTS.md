# AGENTS.md - internal/collector/cloud/azure guidance
...
```bash
cd go && go build ./...
cd go && go test ./internal/collector/cloud/azure/... ./internal/facts/ -count=1
cd go && golangci-lint run ./internal/collector/cloud/azure/... ./internal/facts/
```
