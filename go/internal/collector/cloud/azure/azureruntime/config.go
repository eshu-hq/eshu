...
type TargetConfig struct {
	...
	TenantID string
	// ScopeKind is one of azure.ScopeKindSubscription,
	// azure.ScopeKindManagementGroup, or azure.ScopeKindTenant.
	ScopeKind string
	...
	// azure.SourceLaneResourceGraph; resource_changes is fixture-only in
	// this slice.
	SourceLane string
...
func validScopeKind(kind string) bool {
	switch kind {
	case azure.ScopeKindSubscription, azure.ScopeKindManagementGroup, azure.ScopeKindTenant:
		return true
	default:
		return false
	}
...
func validSourceLane(lane string) bool {
	switch lane {
	case azure.SourceLaneResourceGraph, azure.SourceLaneResourceChanges, azure.SourceLaneARMFallback:
		return true
	default:
		return false
	}
