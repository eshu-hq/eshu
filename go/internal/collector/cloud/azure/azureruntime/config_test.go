...
func TestTargetValidatedDefaultsAndValidatesSourceLane(t *testing.T) {
	...
	if validated.SourceLane != azure.SourceLaneResourceGraph {
	...
	if validated.SourceLane != azure.SourceLaneResourceChanges {
...
func TestValidScopeKindMatchesContract(t *testing.T) {
	for _, kind := range []string{
		azure.ScopeKindSubscription,
		azure.ScopeKindManagementGroup,
		azure.ScopeKindTenant,
	} {
