...
// azure.PageProvider seam with $skipToken resume, and yields one
...
// bounded telemetry to the parent azure package, and it commits nothing
...
// azure.SourceLaneResourceChanges and remain provenance-only. Reducer
