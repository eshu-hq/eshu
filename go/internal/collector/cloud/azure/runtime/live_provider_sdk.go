...
func liveResourceGraphPageFromSDKResponse(
	...
	return azure.ResourceGraphPage{
...
func liveSDKResourceRows(data any) ([]azure.ResourceRow, error) {
	if data == nil {
		return nil, nil
	}
	...
	rows := make([]azure.ResourceRow, 0, len(rawRows))
