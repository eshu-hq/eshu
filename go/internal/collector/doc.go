...
// webhook-listener rollout: it claims queued trigger rows, syncs GitHub-backed
// repositories, marks unsupported providers and handoff failures visibly, and
// lets PriorityRepositorySelector fall back to the scheduled selector when no
