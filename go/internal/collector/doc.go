...
// Grafana, Prometheus/Mimir, Loki, and Tempo observability rows from
// repository parsers become metadata-only observability source facts; reducers
// and query surfaces own any later declared/applied/observed coverage truth.
//
