...
// observations, IAM policy observations, collection-warning evidence, and the
// scoped telemetry contract. The live Cloud Asset Inventory transport, Helm
// values, and remaining relationship, DNS, and image-reference scan emission are
// documented follow-ups. See docs/public/reference/gcp-cloud-collector-contract.md
