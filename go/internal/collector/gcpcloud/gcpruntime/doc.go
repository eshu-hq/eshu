...
// accumulates gcp_cloud_resource and gcp_collection_warning facts in a
// gcpcloud.Generation, fences the generation with gcpcloud.GenerationTracker so a
// stale scan cannot replace current facts, and emits bounded-label telemetry.
//
