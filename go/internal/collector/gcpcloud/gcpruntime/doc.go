...
// gcpcloud.Generation, fences the generation with gcpcloud.GenerationTracker so
// a stale scan cannot replace current facts, and emits bounded-label telemetry
// by fact kind.
//
