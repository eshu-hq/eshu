...
func testImageReferenceObservation() ImageReferenceObservation {
	return ImageReferenceObservation{
		...
		OwningFullResourceName: "//container.googleapis.com/projects/my-project/locations/us-central1/clusters/prod/k8s/pods/api-1",
		ImageReference:         "us-docker.pkg.dev/my-project/team/api:1.4.2",
...
func TestNewImageReferenceEnvelopeDigestFirstConfidence(t *testing.T) {
	...
	if env.FactKind != facts.GCPImageReferenceFactKind {
...
// records tag confidence rather than fabricating a digest match.
func TestNewImageReferenceEnvelopeTagOnlyLowerConfidence(t *testing.T) {
	obs := testImageReferenceObservation()
	obs.ImageDigest = ""
	obs.ImageReference = "us-docker.pkg.dev/my-project/team/api:1.4.2"
	key := testRedactionKey(t)
...
func TestNewImageReferenceEnvelopeRejectsInvalid(t *testing.T) {
	...
	missingOwning.OwningFullResourceName = ""
