...
func (s NativeRepositorySnapshotter) SnapshotRepository(
	...
	var workflowImageFileMetas []gitmodel.ContentFileMeta
	if repository.Delta {
		workflowImageFileMetas = workflowimage.CurrentWorkflowImageFileMetas(repoPath, fileSet.Files, fullFileSet.Files)
	}
	...
	fileSet.Files, gitmodulesCandidateRelativePaths = gitsubmodule.ExtractGitmodulesCandidateFiles(repoPath, fileSet.Files)
	...
	fileSet.Files, codeownersCandidateRelativePaths = gitcodeowners.ExtractCodeownersCandidateFiles(repoPath, fileSet.Files)
	...
	codeownersCandidateRelativePaths = gitcodeowners.ResolvedCodeownersCandidateRelativePaths(repoPath, repository.Delta, deltaRelativePaths, codeownersCandidateRelativePaths)
	...
	snapshot := RepositorySnapshot{
		...
		ContentFiles:             []gitmodel.ContentFileSnapshot{},
		ContentEntities:          []gitmodel.ContentEntitySnapshot{},
	...
	snapshot.ContentFileMetas = append(
		gitsubmodule.GitmodulesFileMetasForPaths(repoPath, gitmodulesCandidateRelativePaths, commitSHA),
		gitcodeowners.CodeownersFileMetasForPaths(repoPath, codeownersCandidateRelativePaths, commitSHA)...,
	)
	...
	snapshot.DocumentationFileMetas = gitdocs.DocumentationFileMetasForPaths(repoPath, discovery.FilePaths(documentationFiles), commitSHA)
