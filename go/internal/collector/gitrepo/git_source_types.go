...
type SelectedRepository struct {
	...
	// starts clean and every copied regular-file byte matches its immutable Git
	// blob. Other paths leave it empty. Snapshot code uses this
	// value directly instead of re-reading a mutable source checkout.
...
type RepositorySnapshot struct {
	...
	ContentFiles    []gitmodel.ContentFileSnapshot   `json:"content_files"`
	ContentEntities []gitmodel.ContentEntitySnapshot `json:"content_entities"`
	...
	DiscoveryAdvisory *collector.DiscoveryAdvisoryReport `json:"discovery_advisory,omitempty"`
	...
	ContentFileMetas []gitmodel.ContentFileMeta `json:"content_file_metas,omitempty"`
	...
	DocumentationFileMetas []gitmodel.ContentFileMeta `json:"documentation_file_metas,omitempty"`
	...
	WorkflowImageFileMetas []gitmodel.ContentFileMeta `json:"workflow_image_file_metas,omitempty"`
