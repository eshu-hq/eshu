...
func TestNoteSubmoduleCandidateIgnoresOtherPaths(t *testing.T) {
	...
	gitsubmodule.NoteSubmoduleCandidate(candidates, "vendor/.gitmodules", "ignored body")
	gitsubmodule.NoteSubmoduleCandidate(candidates, "README.md", "ignored body")
	if len(candidates) != 0 {
		t.Fatalf("candidates = %#v, want empty", candidates)
	}

	gitsubmodule.NoteSubmoduleCandidate(candidates, ".gitmodules", "real body")
