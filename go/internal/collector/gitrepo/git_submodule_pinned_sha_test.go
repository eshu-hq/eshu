...
func TestGitSubmoduleGitlinkSHAResolvesGitlinkEntry(t *testing.T) {
	...
	got := gitsubmodule.GitSubmoduleGitlinkSHA(context.Background(), repoPath, "", "lib/foo")
	if got == nil {
...
func TestGitSubmoduleGitlinkSHANilForRegularDirectory(t *testing.T) {
	...
	if got := gitsubmodule.GitSubmoduleGitlinkSHA(context.Background(), repoPath, "", "lib/foo"); got != nil {
...
func TestGitSubmoduleGitlinkSHANilForMissingPath(t *testing.T) {
	...
	if got := gitsubmodule.GitSubmoduleGitlinkSHA(context.Background(), repoPath, "", "lib/never-added"); got != nil {
