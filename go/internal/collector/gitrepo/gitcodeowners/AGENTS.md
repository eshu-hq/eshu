# AGENTS.md — go/internal/collector/gitrepo/gitcodeowners

## Read first

1. `go/internal/collector/gitrepo/gitcodeowners/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/gitrepo/gitcodeowners/doc.go` — the package contract
