...
func CodeownersFileMetasForPaths(repoPath string, relativePaths []string, commitSHA string) []gitmodel.ContentFileMeta {
	...
	for _, relativePath := range relativePaths {
		...
		digest, ok := gitmodel.DocumentationDigestForFile(absolutePath)
		if !ok {
			continue
		}
