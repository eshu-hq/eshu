# AGENTS.md — go/internal/collector/gitrepo/gitmodel

## Read first

1. `go/internal/collector/gitrepo/gitmodel/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/gitrepo/gitmodel/doc.go` — the package contract
