# AGENTS.md — go/internal/collector/gitrepo/gitobs

## Read first

1. `go/internal/collector/gitrepo/gitobs/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/gitrepo/gitobs/doc.go` — the package contract
