# AGENTS.md — go/internal/collector/gitrepo/gitsubmodule

## Read first

1. `go/internal/collector/gitrepo/gitsubmodule/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/gitrepo/gitsubmodule/doc.go` — the package contract
