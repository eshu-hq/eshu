# AGENTS.md — go/internal/collector/gitrepo/gitsvccatalog

## Read first

1. `go/internal/collector/gitrepo/gitsvccatalog/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/gitrepo/gitsvccatalog/doc.go` — the package contract
