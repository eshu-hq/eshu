# AGENTS.md — go/internal/collector/gitrepo/gittfstate

## Read first

1. `go/internal/collector/gitrepo/gittfstate/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/gitrepo/gittfstate/doc.go` — the package contract
