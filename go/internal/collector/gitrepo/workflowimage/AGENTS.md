# AGENTS.md — go/internal/collector/gitrepo/workflowimage

## Read first

1. `go/internal/collector/gitrepo/workflowimage/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/gitrepo/workflowimage/doc.go` — the package contract
