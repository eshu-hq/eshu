...
The package depends on `internal/collector/preflight/picture` for metadata-only
...
./internal/collector/preflight/picture -count=1` proves OCR fact construction is
