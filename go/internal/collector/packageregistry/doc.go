...
// artifact, source-hint, hosting, and warning envelope builders. The
// packageruntime subpackage owns the claim-driven HTTP metadata fetch path and
// returns these facts through the shared collector commit boundary.
