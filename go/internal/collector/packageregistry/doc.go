...
// package facts stay idempotent across retries and replay. The package does not
// claim ownership, dependency truth, graph nodes, or query answers; reducers
// must corroborate registry facts with source, build, lockfile, or runtime
// evidence before promoting canonical relationships.
