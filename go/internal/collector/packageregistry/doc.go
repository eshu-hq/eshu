...
// package/feed metadata, then emits reported-confidence facts through the
// package, version, dependency, artifact, source-hint, hosting, and warning
// envelope builders. NormalizePackageIdentity keeps ecosystem identity rules
// separate so package facts stay idempotent across retries and replay. The
