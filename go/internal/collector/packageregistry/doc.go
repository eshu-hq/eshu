...
// artifact, source-hint, hosting, and warning envelope builders.
...
// The package does not call live registries, claim ownership, dependency truth,
// graph nodes, or query answers; reducers must corroborate registry facts with
// source, build, lockfile, or runtime evidence before promoting canonical
// relationships.
