# AGENTS.md - collector/preflight/picture guidance for LLM assistants

## Read first

1. `go/internal/collector/preflight/picture/README.md`
2. `go/internal/collector/preflight/picture/doc.go`
3. `go/internal/collector/preflight/picture/preflight.go`
