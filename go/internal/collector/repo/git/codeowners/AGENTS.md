# AGENTS.md — go/internal/collector/repo/git/codeowners

## Read first

1. `go/internal/collector/repo/git/codeowners/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/repo/git/codeowners/doc.go` — the package contract
