...
// Package git is Eshu's git repository collector: it selects repositories,
...
// (selection_*), working-tree snapshotting (snapshot_*), and the source
// that drives them (source*). They form a measured three-way production
...
// docs, observability, codeowners, submodule, catalog, tfstate and image —
// are nested subpackages, with everything they share below them in model.
//
...
// source facts in the observability subpackage; reducers and query surfaces own any
