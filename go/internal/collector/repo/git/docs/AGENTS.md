# AGENTS.md — go/internal/collector/repo/git/docs

## Read first

1. `go/internal/collector/repo/git/docs/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/repo/git/docs/doc.go` — the package contract
