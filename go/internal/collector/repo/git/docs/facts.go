...
func DocumentationMetaRelativePaths(metas []model.ContentFileMeta) map[string]bool {
...
func gitDocumentationEnvelope(
	...
	if sourceURI == repoPath {
		...
		envelope.SourceRef.SourceRecordID = model.RepositoryRelativePath(repoPath, sourceURI)
	}
	return envelope
}
