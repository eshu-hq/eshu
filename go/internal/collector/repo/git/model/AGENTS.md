# AGENTS.md — go/internal/collector/repo/git/model

## Read first

1. `go/internal/collector/repo/git/model/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/repo/git/model/doc.go` — the package contract
