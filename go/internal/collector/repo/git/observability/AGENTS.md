# AGENTS.md — go/internal/collector/repo/git/observability

## Read first

1. `go/internal/collector/repo/git/observability/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/repo/git/observability/doc.go` — the package contract
