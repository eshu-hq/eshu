# AGENTS.md — go/internal/collector/repo/git/service/catalog

## Read first

1. `go/internal/collector/repo/git/service/catalog/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/repo/git/service/catalog/doc.go` — the package contract
