...
func (s NativeRepositorySnapshotter) SnapshotRepository(
	...
	var workflowImageFileMetas []model.ContentFileMeta
	if repository.Delta {
		workflowImageFileMetas = image.CurrentWorkflowImageFileMetas(repoPath, fileSet.Files, fullFileSet.Files)
	}
	...
	fileSet.Files, gitmodulesCandidateRelativePaths = submodule.ExtractGitmodulesCandidateFiles(repoPath, fileSet.Files)
	...
	fileSet.Files, codeownersCandidateRelativePaths = codeowners.ExtractCodeownersCandidateFiles(repoPath, fileSet.Files)
	...
	codeownersCandidateRelativePaths = codeowners.ResolvedCodeownersCandidateRelativePaths(repoPath, repository.Delta, deltaRelativePaths, codeownersCandidateRelativePaths)
	...
	snapshot := RepositorySnapshot{
		...
		ContentFiles:             []model.ContentFileSnapshot{},
		ContentEntities:          []model.ContentEntitySnapshot{},
	...
	snapshot.ContentFileMetas = append(
		submodule.GitmodulesFileMetasForPaths(repoPath, gitmodulesCandidateRelativePaths, commitSHA),
		codeowners.CodeownersFileMetasForPaths(repoPath, codeownersCandidateRelativePaths, commitSHA)...,
	)
	...
	snapshot.DocumentationFileMetas = docs.DocumentationFileMetasForPaths(repoPath, discovery.FilePaths(documentationFiles), commitSHA)
