...
type RepositorySnapshot struct {
	...
	ContentFiles    []model.ContentFileSnapshot   `json:"content_files"`
	ContentEntities []model.ContentEntitySnapshot `json:"content_entities"`
	...
	ContentFileMetas []model.ContentFileMeta `json:"content_file_metas,omitempty"`
	...
	DocumentationFileMetas []model.ContentFileMeta `json:"documentation_file_metas,omitempty"`
	...
	WorkflowImageFileMetas []model.ContentFileMeta `json:"workflow_image_file_metas,omitempty"`
