# AGENTS.md — go/internal/collector/repo/git/submodule

## Read first

1. `go/internal/collector/repo/git/submodule/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/repo/git/submodule/doc.go` — the package contract
