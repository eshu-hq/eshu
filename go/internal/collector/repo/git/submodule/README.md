...
`go/internal/collector/repo/git/submodule` owns `.gitmodules` submodule facts and pinned-SHA resolution.
...
The name is `submodule`, not `submodule`: `collector/repo/submodule` already
