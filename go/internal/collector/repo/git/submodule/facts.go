...
import (
	...
	"github.com/eshu-hq/eshu/go/internal/collector/repo/submodule"
)
...
// content file.
func GitmodulesFileMetasForPaths(repoPath string, relativePaths []string, commitSHA string) []model.ContentFileMeta {
	...
	for _, relativePath := range relativePaths {
		...
		digest, ok := model.DocumentationDigestForFile(absolutePath)
		if !ok {
			continue
		}
