...
package git //nolint:dirgate // Candidate extraction is selection-phase wiring over discovery file sets feeding the snapshot core contract; it stays with the core until the core splits per #6695.
