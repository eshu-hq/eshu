# AGENTS.md — go/internal/collector/repo/git/workflow/image

## Read first

1. `go/internal/collector/repo/git/workflow/image/README.md` — purpose, exported surface, and the notes below
2. `go/internal/collector/repo/git/workflow/image/doc.go` — the package contract
