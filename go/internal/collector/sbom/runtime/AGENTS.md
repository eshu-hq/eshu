# AGENTS.md - internal/collector/sbom/runtime guidance

## Read First

1. `README.md` for the collector/runtime boundary.
2. `go/internal/collector/sbom/document/README.md` for SBOM parser contracts.
...
```bash
go test ./internal/collector/sbom/runtime ./internal/reducer -run 'Test(ClaimedSource|HTTPProvider|RuntimeSBOMFacts)' -count=1
```
