...
// dependency Variables (npm/composer, non-lockfile) to the section-keyed,
// line-independent content.CanonicalDependencyEntityID and falls back to the
// legacy line-keyed content.CanonicalEntityID for everything else — builds
