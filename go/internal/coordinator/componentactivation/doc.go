...
// registry readback constructs it, the component-extension scheduler parses
// it back at planning time, and unrelated root files (the PagerDuty
...
// imports only internal/component, never internal/coordinator, so every one
// of those consumers can import it without creating an import cycle.
