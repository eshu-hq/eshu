...
// every freshness test binary. ParseTargetScopes calls
// runtime.SupportsServiceKind to validate target-scope service_kind
...
// keeps every planner test honest about the scanner set the
