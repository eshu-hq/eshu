...
`extension` turns one validated, claim-capable component
...
This package imports the shared activation and plan-key contracts, but never
the orchestrating coordinator root or another planner implementation.
