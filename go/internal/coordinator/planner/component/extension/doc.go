...
// Package extension builds deterministic workflow rows for
...
// activation configuration through activation.ParseConfig, derives
...
// component/activation package, not here, so root's unrelated callers of
