...
6. `../contract/README.md` — shared safe plan-key rules.
...
`jira.HasConfiguredScope` and `pagerduty.HasConfiguredScope` use
...
`go test ./internal/coordinator/planner/gcp ./internal/coordinator -count=1`.
