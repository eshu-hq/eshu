# AGENTS.md - internal/coordinator/planner/loki guidance

## Read first

1. `README.md` for ownership and invariants.
2. `planner.go` for validation and deterministic identities.
3. `../../loki_service.go` for root scheduling and admission.
4. `../contract/README.md` for plan-key grammar.

## Invariants

- Keep Loki calls and credential resolution out.
