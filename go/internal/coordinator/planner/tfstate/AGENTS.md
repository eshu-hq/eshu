# AGENTS.md — internal/coordinator/planner/tfstate guidance
...
- Keep `validateTerraformStatePlanKey` local and stricter than
  `contract.ValidateSafePlanKey`. It rejects `s3://`, `/`, and `\`
...
Run `go test ./internal/coordinator/planner/tfstate ./internal/coordinator -count=1`
