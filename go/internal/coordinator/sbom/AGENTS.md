# Coordinator SBOM namespace agent guide
...
3. The destination leaf's `AGENTS.md`, `README.md`, and source before
   changing an SBOM or attestation planning contract.
...
Move or add an SBOM planner only with a production-and-test import edge census.
