# Coordinator security namespace agent guide

## Read first

1. `README.md` for this documentation-only namespace boundary.
2. `../AGENTS.md` for coordinator scheduling and runtime invariants.
3. The destination leaf's `AGENTS.md`, `README.md`, and source before
   changing a security-alert planning contract.
...
Move or add a security-alert planner only with a production-and-test import edge census.
