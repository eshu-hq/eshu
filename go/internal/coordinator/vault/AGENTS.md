# Coordinator Vault namespace agent guide
...
3. The destination leaf's `AGENTS.md`, `README.md`, and source before
   changing a Vault planning contract.
...
Move or add a Vault planner only with a production-and-test import edge census.
