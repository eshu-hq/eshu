...
// config is unmanaged, conflicting deterministic ownership is ambiguous, and a
// collector coverage gap is unknown. Provider observation never overwrites
// declared IaC truth; missing, ambiguous, and unknown states are carried as
// explicit evidence, never fabricated into a single owner.
//
