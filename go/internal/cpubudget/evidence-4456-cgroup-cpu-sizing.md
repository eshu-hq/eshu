...
| 11 | `internal/reducer/code/value/fixpoint_cache.go` | inline semaphore size (value-flow fixpoint cache worker pool) |
| 12 | `internal/reducer/code/value/fixpoint_snapshot.go` | inline semaphore size (value-flow fixpoint snapshot worker pool) |
