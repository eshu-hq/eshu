...
var collectorEntries = func() []Entry {
	...
	add(
		...
		Entry{Name: "ESHU_AZURE_POLL_INTERVAL", Type: VarDuration, Default: "1s", Subsystem: "collector-azure-cloud", Description: "Poll interval for discovering Azure targets."},
		Entry{Name: "ESHU_AZURE_TARGETS_JSON", Type: VarString, Subsystem: "collector-azure-cloud", Description: "JSON array of Azure target scopes."},
		Entry{Name: "ESHU_AZURE_FIXTURE_PAGES_JSON", Type: VarString, Subsystem: "collector-azure-cloud", Description: "JSON fixture pages for offline smoke testing; not used in production."},
	)
