...
// matrix and its fragments, the generated surface inventory, and the two files
// the check itself reads — the CI gate registry and the workflow; they are
// listed in validatorInputs, which a new input must be added to.
