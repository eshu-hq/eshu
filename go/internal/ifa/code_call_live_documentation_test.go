...
func TestMaterializedEdgeLiveProofDocumentationMatchesWiring(t *testing.T) {
	...
	checks := []struct {
		...
		},
		{
			...
			required: []string{
				"The sql_relationships BASELINE, DELTA, and FAULT rows, the code_calls BASELINE\n# and FAULT rows, the documentation_edges BASELINE and FAULT rows, and the\n# rationale_edges BASELINE and FAULT rows are proven; none of those four\n# families carries a waiver.",
