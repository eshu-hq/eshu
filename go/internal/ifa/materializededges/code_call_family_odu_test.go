...
func TestCodeCallFamilyCassetteDerivesTheExpectedEdgeSet(t *testing.T) {
	...
	odu, err := ifa.LoadCodeCallFamilyOdu(ifa.CodeCallFamilyCassetteFullPath(repoRoot))
	if err != nil {
		t.Fatalf("ifa.LoadCodeCallFamilyOdu: %v", err)
	}
...
func TestCodeCallFamilyIsCatalogedAndResolvable(t *testing.T) {
	...
	fromCassette, err := ifa.LoadCodeCallFamilyOdu(ifa.CodeCallFamilyCassetteFullPath(repoRoot))
	if err != nil {
		t.Fatalf("ifa.LoadCodeCallFamilyOdu: %v", err)
	}
...
func TestCodeCallOduPreservesEnvelopeFields(t *testing.T) {
	...
	raw, err := os.ReadFile(ifa.CodeCallFamilyCassetteFullPath(repoRoot))
	if err != nil {
...
func TestLoadCodeCallFamilyOduRejectsUnknownJSONField(t *testing.T) {
  ...
  "scopes": [
	...
	if _, err := ifa.LoadCodeCallFamilyOdu(goodPath); err != nil {
		t.Fatalf("ifa.LoadCodeCallFamilyOdu rejected a well-formed cassette carrying every real envelope field: %v", err)
	}
	...
	if _, err := ifa.LoadCodeCallFamilyOdu(badPath); err == nil {
		t.Fatal("ifa.LoadCodeCallFamilyOdu accepted a cassette with an unknown field (fact_knd typo)")
	}
}
