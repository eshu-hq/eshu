...
// vacuity guard.
// Current guards cover SQL relationships, documentation edges, code calls, rationale edges, codeowners ownership edges, deployable-unit edges, repository dependencies, inheritance edges, and shell-exec edges.
...
func (r MaterializedEdgeOduResolver) Resolve(entry replaycoverage.CoverageEntry) (bool, string) {
	...
	case shellExecFamily:
		return resolveShellExecMaterializedEdges(odu, shellExecFamilyExpectedEdgesPath(r.RepoRoot))
	default:
