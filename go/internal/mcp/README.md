...
|---|---|---|
| `codebaseTools` | 33 | `tools_codebase.go` (splices `code/intel/tools.go`, `code/dead/tools.go`, `code/quality/tools.go`), `relationships/code_tools.go`, `tools_import_dependencies.go`, `tools_security.go`, `tools_iac.go` |
