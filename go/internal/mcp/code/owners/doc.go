...
// Package codeownerstools defines pure route selection and the tool
// definition for the MCP CODEOWNERS ownership family.
//
...
// package owns the root registration splice and client-visible order, global
...
// owns the bounded read behind the path, including effective_owner precedence
// between a service manifest and the CODEOWNERS file. This package runs no
// query and must keep the tool name, request path, and query keys stable.
//
