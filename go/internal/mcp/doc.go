...
// dependency, correlation, vulnerability finding, explanation, SBOM, and
// attestation attachment requests stay thin; supply-chain schemas preserve
// ambiguous-subject outcomes instead of hiding non-canonical evidence.
