...
// cloud, documentation, and visualization child packages own their registration
// definitions without importing this parent package. ReadOnlyTools remains the
// sole ordered assembler; routing, dispatch, transport, authorization, and query
// execution remain owned here.
//
