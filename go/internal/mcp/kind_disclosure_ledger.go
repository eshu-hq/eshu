...
// could not see raw-JSON storage/postgres readers or `array.Array`-bound
...
// (go/internal/query/supply/chain/impact/readiness_postgres_query.go,
...
// removed in #5458 once it gained a real consumer, and
// package_registry.registry_event was removed in the same epic's
// registry_event slice once IT gained a real consumer (31 remain). See
...
var grandfatheredUnconsumedKinds = map[string]string{
	...
	"aws_iam_instance_profile":                        "c8f90b94216debd210a2f1e48dbcbdb4ddef832fe2012dcf075f464db890087d",
