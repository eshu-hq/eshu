...
// It reports handled only for tools owned by this package and does not execute
// the request.
func CodeRoute(toolName string, args routecontract.Arguments) (routecontract.Request, bool, error) {
	switch toolName {
