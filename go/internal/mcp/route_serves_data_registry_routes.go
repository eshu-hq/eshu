...
var routeServesDataRegistryPart1 = map[string]routeServesDataSource{
	...
	// azure_cloud_resource} (projector/cloud/inventory/reducer_intent.go),
		...
		Served: []routeServedDomain{
			{
				...
				Evidence: []routeReadEvidence{
					...
					{File: "go/internal/projector/cloud/inventory/reducer_intent.go", Marker: "facts.AWSResourceFactKind"},
				},
			},
			{
			...
			},
			{
				...
				Evidence: []routeReadEvidence{
					{File: "go/internal/query/cloud_inventory_read_model.go", Marker: "reducer_cloud_resource_identity"},
					{File: "go/internal/projector/cloud/inventory/reducer_intent.go", Marker: "facts.GCPCloudResourceFactKind"},
				},
			},
		},
	},
	...
	"GET /api/v0/repositories": {
		...
		ScanFiles: []string{
			"go/internal/query/repository/handler.go",
		},
		Served: []routeServedDomain{{
			Domain: "code_graph_projection",
			Evidence: []routeReadEvidence{
				{File: "go/internal/query/repository/handler.go", Marker: "MATCH (r:Repository)"},
			},
		}},
	},
	...
	// (go/internal/query/supply/chain/impact/findings_queries.go::FindingFactKind).
	...
	"GET /api/v0/supply-chain/impact/findings": {
		...
		MethodFile:       "go/internal/query/supply/chain/findings_handler.go",
		ScanFiles: []string{
			"go/internal/query/supply/chain/findings_handler.go",
			"go/internal/query/supply/chain/impact/findings.go",
			"go/internal/query/supply/chain/impact/findings_queries.go",
		},
		Served: []routeServedDomain{
			{
				...
				Evidence: []routeReadEvidence{
					{File: "go/internal/query/supply/chain/impact/findings_queries.go", Marker: "reducer_supply_chain_impact_finding"},
				},
			},
			{
