...
No-Observability-Change: the code-relationship route still runs through the
root MCP dispatcher and the same HTTP query handlers, which retain the existing
MCP transport and API request telemetry.
