...
No-Regression Evidence: `internal/mcp/ask`, `internal/mcp/documentation`,
`internal/mcp/cloud`, and `internal/mcp/visualization` import `toolcontract`
and own their registration definitions. Their characterization tests pin the
serialized names,
...
and all six extracted constructors remain at their previous assembly
positions.
