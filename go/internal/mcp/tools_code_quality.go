...
func codeQualityInspectionTool() ToolDefinition {
	return ToolDefinition{
		...
		Description: "Inspect bounded code-quality and refactoring metrics for functions: complexity, function length, argument count, or combined refactoring candidates. Scoped tokens receive only granted repositories; an ungranted selector returns not-found.",
