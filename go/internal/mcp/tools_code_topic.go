...
func codeTopicInvestigationTool() ToolDefinition {
	return ToolDefinition{
		...
		Description: "Investigate a broad code topic or behavior with ranked files, symbols, coverage metadata, truncation, and exact next-call handles for source reads and relationship stories. Scoped tokens receive only granted repositories; an ungranted selector returns not-found.",
