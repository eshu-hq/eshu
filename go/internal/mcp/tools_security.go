...
func securityInvestigationTool() ToolDefinition {
	return ToolDefinition{
		...
		Description: "Investigate potential hardcoded passwords, API keys, tokens, private keys, and risky literals from indexed content with redacted findings, suppression metadata, paging, and coverage. Scoped tokens receive only granted repositories; an ungranted selector returns not-found.",
