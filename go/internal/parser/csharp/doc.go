...
// entrypoints. It also emits exact ASP.NET route entries for literal attribute
// routes and minimal API registrations with named handlers; convention routes,
// token substitution, runtime endpoint discovery, and generated routes remain
// unsupported. Root hints are syntax-scoped to declarations, attributes,
