...
// exports, Node migration exports, TypeScript interface implementation,
// module-contract, package public-surface, and exported static-registry roots,
// returned function-value references, static re-export metadata,
