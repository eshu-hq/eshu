...
// metadata values, legacy ENV key/value form, and Dockerfile escape-directive
// handling. Metadata.Map preserves the parent parser payload shape used by
// query and relationship callers.
package dockerfile
