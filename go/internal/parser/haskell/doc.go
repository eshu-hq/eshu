...
// and indented keyword-led bindings such as let expressions. It annotates
// explicit module exports, main functions, typeclass methods, and instance
// methods with dead-code root metadata. PreScan returns declaration names from
// the same payload path. The package is deterministic and depends only on shared
// parser helpers.
package haskell
