...
// evidence bounded to source-proven receivers, including same-file declared Java
// types. ParseMetadata and MetadataClassReferences turn bounded ServiceLoader
// and Spring metadata files into ClassReference rows while rejecting
