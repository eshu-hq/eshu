...
// Parse reads and parses a Java source file using a caller-owned tree-sitter
// parser.
func Parse(
	path string,
	isDependency bool,
	...
	payload["framework_semantics"] = buildJavaFrameworkSemantics(root, source)
...
// PreScan returns Java symbol names used by dependency pre-scanning.
