...
func DependencyCoverage() []DependencyCoverageEntry {
	entries := []DependencyCoverageEntry{
		...
		},
		{
			...
			FileKind:        "lockfile",
			Status:          DependencyCoverageGap,
			SourceReference: "go/internal/parser/json/language.go shouldSkipJSONEntities returns true for composer.lock",
			Notes:           "Composer lockfile is intentionally skipped by the JSON parser today; exact installed versions are not available for PHP repos.",
		},
		{
			Ecosystem:       "pypi",
		...
		},
		{
			...
			FileKind:        "manifest",
			Status:          DependencyCoverageGap,
			SourceReference: "go/internal/parser/ruby_language.go has no Gemfile branch",
			Notes:           "Gemfile DSL is not yet parsed; RubyGems repo dependencies remain missing.",
		},
		{
			Ecosystem:       "rubygems",
			...
			Status:          DependencyCoverageGap,
			SourceReference: "no parser registered in go/internal/parser/registry.go",
			Notes:           "Bundler lockfile is not yet parsed.",
		},
		{
			Ecosystem:       "cargo",
