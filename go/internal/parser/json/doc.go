...
// documents. The package depends on shared parser helpers and CloudFormation
// extraction, but it does not import the parent parser package; parent-owned
// dbt SQL lineage is supplied through Config and converted at the parent
// wrapper boundary.
package json
