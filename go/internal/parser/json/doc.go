...
// deterministic rows for dependency manifests, npm lockfile versions,
// TypeScript configs, `.jsonc` config files, CloudFormation templates, dbt
// manifests, and replay fixture documents. JSONC normalization strips comments
