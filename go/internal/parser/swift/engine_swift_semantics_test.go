...
`,
	...
	parsertest.AssertStringSliceContains(t, assertFunctionByNameAndClass(t, payload, "run", "Runnable"), "dead_code_root_kinds", "swift.protocol_method")
	parsertest.AssertStringSliceContains(t, assertFunctionByNameAndClass(t, payload, "init", "Worker"), "dead_code_root_kinds", "swift.constructor")
