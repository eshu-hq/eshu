...
// also emits metadata-only declared Grafana observability rows from Helm
// values, GrafanaFolder and GrafanaDashboard resources, dashboard ConfigMaps,
// folder, datasource, and alert provisioning while omitting dashboard JSON,
// query bodies, datasource URLs, secrets, contact routes, folder titles, and
// provisioning paths. The package keeps
