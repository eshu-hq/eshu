...
func TestGateAgainstRealReducerAndSchemas(t *testing.T) {
	...
	if len(manifest.Kinds) != 99 {
		t.Fatalf("len(manifest.Kinds) = %d, want 99", len(manifest.Kinds))
	}
}
