...
func TestGateAgainstRealReducerAndSchemas(t *testing.T) {
	...
	if len(manifest.Kinds) != 116 {
		t.Fatalf("len(manifest.Kinds) = %d, want 116", len(manifest.Kinds))
	}
}
