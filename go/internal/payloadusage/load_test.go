...
func TestGateAgainstRealReducerAndSchemas(t *testing.T) {
	...
	if len(manifest.Kinds) != 122 {
		t.Fatalf("len(manifest.Kinds) = %d, want 122", len(manifest.Kinds))
	}
}
