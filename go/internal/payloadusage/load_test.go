...
func TestGateAgainstRealReducerAndSchemas(t *testing.T) {
	...
	if len(manifest.Kinds) != 117 {
		t.Fatalf("len(manifest.Kinds) = %d, want 117", len(manifest.Kinds))
	}
}
