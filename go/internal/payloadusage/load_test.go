...
func TestGateAgainstRealReducerAndSchemas(t *testing.T) {
	...
	if len(manifest.Kinds) != 113 {
		t.Fatalf("len(manifest.Kinds) = %d, want 113", len(manifest.Kinds))
	}
}
