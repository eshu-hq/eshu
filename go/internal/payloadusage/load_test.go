...
func TestGateAgainstRealReducerAndSchemas(t *testing.T) {
	...
	if len(manifest.Kinds) != 115 {
		t.Fatalf("len(manifest.Kinds) = %d, want 115", len(manifest.Kinds))
	}
}
