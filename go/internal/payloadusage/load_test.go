...
func TestGateAgainstRealReducerAndSchemas(t *testing.T) {
	...
	if len(manifest.Kinds) != 102 {
		t.Fatalf("len(manifest.Kinds) = %d, want 102", len(manifest.Kinds))
	}
}
