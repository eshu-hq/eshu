...
func TestGateAgainstRealReducerAndSchemas(t *testing.T) {
	...
	if len(manifest.Kinds) != 124 {
		t.Fatalf("len(manifest.Kinds) = %d, want 124", len(manifest.Kinds))
	}
}
