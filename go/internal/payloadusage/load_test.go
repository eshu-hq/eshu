...
func TestGateAgainstRealReducerAndSchemas(t *testing.T) {
	...
	if len(manifest.Kinds) != 125 {
		t.Fatalf("len(manifest.Kinds) = %d, want 125", len(manifest.Kinds))
	}
}
