...
- **Intent family dependency direction** — extracted family packages must
  ...
  EC2, GCP, Kubernetes, RDS, S3, security, workload-cloud-relationship, and
  incident-routing family builders consume the lookup. Root owns ordered family assembly and the public `ReducerIntent`
  ...
  workload-cloud-relationship, and incident-routing builders trigger on fact
  presence alone and carry no decode seam.
