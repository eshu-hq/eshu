...
// BuildMaterializationReducerIntent enqueues one reducer intent
...
// resource.BuildMaterializationReducerIntent uses — not
...
func BuildMaterializationReducerIntent(
	scopeID string,
	generationID string,
