...
// TestBuildPostureMaterializationReducerIntent proves the builder enqueues
...
func TestBuildPostureMaterializationReducerIntent(t *testing.T) {
	t.Parallel()
	...
	t.Run("queues from private posture presence", func(t *testing.T) {
		...
		got, ok := BuildPostureMaterializationReducerIntent(testScopeID, testGenerationID, lookup)
		if !ok {
