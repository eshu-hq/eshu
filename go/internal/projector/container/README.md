# Container Projector Namespace

## Purpose

Groups source-local container evidence projector families.

## Ownership boundary

Leaf packages own their contracts. Root `projector` owns assembly, queueing,
telemetry, and graph writes.
