...
// through the same factenvelope.FactSchemaFromInternal call (via its
// factschemaEnvelope alias), and the sole caller here — the trigger predicate
// in BuildIAMInstanceProfileRoleMaterializationReducerIntent — checks only
