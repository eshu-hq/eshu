...
// go/internal/projector/iaminstanceprofile/factschema_decode_aws.go) so the
// payload-usage manifest gate (scripts/verify-payload-usage-manifest.sh,
...
// factenvelope.FactSchemaFromInternal call, and the sole caller here
