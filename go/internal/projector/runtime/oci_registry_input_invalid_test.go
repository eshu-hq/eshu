...
func TestExtractOCIRegistryRowsQuarantinesMissingManifestDigest(t *testing.T) {
	...
	quarantined := canonical.ExtractOCIRegistryRows(mat, []facts.Envelope{validManifest, malformed})
...
func TestExtractOCIRegistryRowsPresentButEmptyDigestIsDroppedNotQuarantined(t *testing.T) {
	...
	mat := &canonical.CanonicalMaterialization{}
	quarantined := canonical.ExtractOCIRegistryRows(mat, []facts.Envelope{emptyDigest})
...
func TestExtractOCIRegistryRowsWhitespaceDigestIsDroppedNotMaterialized(t *testing.T) {
	...
	mat := &canonical.CanonicalMaterialization{}
	quarantined := canonical.ExtractOCIRegistryRows(mat, []facts.Envelope{validManifest, whitespaceDigest})
