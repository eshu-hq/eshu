...
// decode wrapper (root's factschema_decode_aws.go): sharing it would require
// this package to import root, which root already imports to dispatch to this
// package — an import cycle. The sole caller
