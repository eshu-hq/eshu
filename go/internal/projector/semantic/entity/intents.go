...
// ("content_entity", declared in go/internal/projector/decode/fact_kind.go)
...
// lives in go/internal/reducer/code/semantic/materialization_helpers.go and
...
// in go/internal/reducer/code/semantic/materialization_helpers.go and gates
