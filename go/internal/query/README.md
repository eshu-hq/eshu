...
retrieval anchor is rebound to the resolved canonical id before ranking, because
that is the identity every indexed document stores. No active mapping returns
