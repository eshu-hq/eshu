...
var scopedTokenAdvertisedRoutes = map[string]scopedRouteClass{
	...
	"GET /api/v0/images/tag-history":                                                scopedRouteGrantBound,
	"GET /api/v0/incidents/{incident_id}/context":                                   scopedRouteGrantBound,
	"GET /api/v0/index-status":                                                      scopedRouteGrantBound,
	...
	"POST /api/v0/impact/trace-resource-to-code":                                    scopedRouteGrantBound,
	"POST /api/v0/impact/explain-dependency-path":                                   scopedRouteGrantBound,
	"POST /api/v0/impact/trace-exposure-path":                                       scopedRouteGrantBound,
	...
	"GET /api/v0/status/index":                                                      scopedRouteGrantBound,
	...
	"POST /api/v0/code/relationships/story":                                         scopedRouteGrantBound,
	"POST /api/v0/code/imports/investigate":                                         scopedRouteGrantBound,
