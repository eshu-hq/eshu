...
// resolveRepositorySelector -> selector.ResolveExactForAccess, the
...
// selector.ResolveExactForAccess chain as
...
// selector.ResolveExactForAccess, the same grant-filtering chain as
// scopedRepositoryFreshnessRoute.
