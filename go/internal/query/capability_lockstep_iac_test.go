...
func TestIaCCapabilityLockstep(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			rootSupport: capabilityMatrix["iac_quality.dead_iac"],
		...
		},
		{
			...
			rootSupport: capabilityMatrix["iac_management.find_unmanaged_resources"],
		...
		},
		{
			...
			rootSupport: capabilityMatrix["iac_management.get_status"],
		...
		},
		{
			...
			rootSupport: capabilityMatrix["iac_management.explain_status"],
		...
		},
		{
			...
			rootSupport: capabilityMatrix["iac_management.propose_terraform_import_plan"],
		...
		},
		{
			...
			rootSupport: capabilityMatrix["aws_runtime_drift.findings.list"],
		...
		},
		{
			...
			rootSupport: capabilityMatrix["iac_inventory.resources.list"],
		...
		},
		{
			...
			rootSupport: capabilityMatrix[replatformingOwnershipCapability],
		...
		},
		{
			...
			rootSupport: capabilityMatrix[replatformingRollupsCapability],
