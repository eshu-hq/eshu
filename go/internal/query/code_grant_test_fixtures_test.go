...
//
// The values live in testutil (#6642): package language's own grant
...
const (
	codeGrantGrantedRepo = testutil.CodeGrantGrantedRepo
	codeGrantOtherRepo   = testutil.CodeGrantOtherRepo
)
