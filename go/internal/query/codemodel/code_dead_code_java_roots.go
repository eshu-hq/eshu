...
// DeadCodeIsJavaRoot reports whether the candidate is a Java entrypoint root.
func DeadCodeIsJavaRoot(result map[string]any, entity *querycontract.EntityContent, stats *DeadCodePolicyStats) bool {
