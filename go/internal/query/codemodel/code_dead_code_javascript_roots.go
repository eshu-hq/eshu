...
// DeadCodeIsJavaScriptFrameworkRoot reports whether the candidate is a JavaScript framework root.
func DeadCodeIsJavaScriptFrameworkRoot(result map[string]any, entity *querycontract.EntityContent, stats *DeadCodePolicyStats) bool {
