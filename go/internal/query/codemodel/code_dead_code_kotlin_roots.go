...
// DeadCodeIsKotlinRoot reports whether the candidate is a Kotlin entrypoint root.
func DeadCodeIsKotlinRoot(result map[string]any, entity *querycontract.EntityContent, stats *DeadCodePolicyStats) bool {
