...
func TestNornicDBRelationshipStoryClassMethodsCypherUsesAnchoredClassPattern(t *testing.T) {
	...
	cypher, params := nornicDBRelationshipStoryClassMethodsCypher(
		codemodel.RelationshipStoryRequest{Limit: 10, Offset: 5},
		"class-a",
		"uid",
...
func TestRelationshipStoryOverrideRowsCypherHonorsLanguageAndOverrideNodeKinds(t *testing.T) {
	...
	cypher, params := relationshipStoryOverrideRowsCypher(codemodel.RelationshipStoryRequest{
		RepoID:   "repo-1",
		Language: "go",
		Limit:    25,
	}, repositoryAccessFilter{AllScopes: true})
...
func TestNornicDBRelationshipStoryInheritanceDepthCypherBoundsTraversal(t *testing.T) {
	...
	cypher, params := nornicDBRelationshipStoryInheritanceDepthCypher(
		codemodel.RelationshipStoryRequest{MaxDepth: 4, Limit: 25},
		"class-a",
		"outgoing",
		"uid",
		repositoryAccessFilter{AllScopes: true},
