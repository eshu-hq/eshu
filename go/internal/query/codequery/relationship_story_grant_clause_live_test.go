...
// Granted-tenant repository. Copy of auth_scoped_code_topic_grant_test.go,
// which stays in codequery: a _test.go symbol cannot be imported here.
const codeGrantGrantedRepo = "repo://tenant-a/granted-service"
