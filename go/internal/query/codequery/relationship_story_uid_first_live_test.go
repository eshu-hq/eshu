...
func TestLiveRelationshipStoryUIDFirstTheory(t *testing.T) {
	...
	graph := &storyPropertyProofGraph{GraphQuery: newLiveNornicDBReader(driver, "nornic")}
	...
	request := codemodel.RelationshipStoryRequest{
		EntityID:  entityID,
		Direction: "both",
...
) (codemodel.RelationshipStoryRequest, error) {
