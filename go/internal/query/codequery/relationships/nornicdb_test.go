...
func (s nornicDBRelationshipContentStore) GetEntityContent(_ context.Context, entityID string) (*codequery.EntityContent, error) {
...
func TestHandleRelationshipsMissingContentUsesLabeledIdentityProbes(t *testing.T) {
	...
	handler := &codequery.CodeHandler{
		GraphBackend: codequery.GraphBackendNornicDB,
		Content:      nornicDBRelationshipContentStore{entities: map[string]codequery.EntityContent{}},
		Neo4j: fakeGraphReader{
