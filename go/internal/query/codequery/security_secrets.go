...
// RedactHardcodedSecretLine replaces a detected secret literal with
// [REDACTED]. It stays exported because the root golden-fixture test pins the
// detection-to-redaction pipeline whose other stages still live in root
// package query.
