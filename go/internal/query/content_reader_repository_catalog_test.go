...
// queries). buildScope (go/internal/collector/repo/git/git_source_processing.go)
// mirrors repo.ID into payload->>'repo_id' -- see
// TestBuildScopeRepositorySourceKeyMatchesMetadataRepoID in
// go/internal/collector/repo/git/git_source_processing_test.go -- so this coalesce
