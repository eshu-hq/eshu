...
func init() {
	...
	register("reachability.csharp.value_flow", capabilitySupport{
	...
	register("codeowners.ownership.list", capabilitySupport{
	...
	register("symbol_graph.language_entities", capabilitySupport{
