...
func init() {
	register("reachability.go.govulncheck", capabilitySupport{
	...
	register("reachability.python.value_flow", capabilitySupport{
		LocalLightweightMax:   nil,
		LocalAuthoritativeMax: nil,
		LocalFullStackMax:     nil,
		ProductionMax:         nil,
	})
	register("reachability.typescript.value_flow", capabilitySupport{
		LocalLightweightMax:   nil,
		LocalAuthoritativeMax: nil,
		LocalFullStackMax:     nil,
		ProductionMax:         nil,
	})
	register("reachability.javascript.value_flow", capabilitySupport{
		LocalLightweightMax:   nil,
		LocalAuthoritativeMax: nil,
		LocalFullStackMax:     nil,
		ProductionMax:         nil,
	})
	register("reachability.jvm.bounded", capabilitySupport{
		LocalLightweightMax:   nil,
		LocalAuthoritativeMax: &truthDerived,
		LocalFullStackMax:     &truthDerived,
		ProductionMax:         nil,
