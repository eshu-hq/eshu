...
// live-data playbook step targets, scanner result routes, documentation
// evidence-packet-by-id routes, provider payloads, local filesystem paths,
// collector instance details, source-system detail, queue conflict keys, and
// tenant data routes behind their own scoped route gates.
