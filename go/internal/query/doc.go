...
// and content read/search routes apply the same bounds to selector resolution,
// graph predicates, exact content lookups, and content fallback calls before
// allowing scoped-token API or MCP reads.
