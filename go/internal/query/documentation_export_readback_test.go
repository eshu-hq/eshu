...
func TestDocumentationHandlerListsOfflineExportSectionFacts(t *testing.T) {
	t.Parallel()

	row := []byte(`{
		"fact_id": "fact:export:section:1",
		"fact_kind": "documentation_section",
		"scope_id": "doc-source:documentation_export:synthetic",
		"generation_id": "export-gen-readback",
		"source_system": "slack",
		"source_uri": "export-file:sha256:synthetic",
		"source_record_id": "export-item:sha256:synthetic",
		"payload": {
			"document_id": "doc:documentation_export:sha256:synthetic",
			"revision_id": "rev-export-readback",
			"section_id": "export:1",
			"heading_text": "Incident discussion",
	...
	req := httptest.NewRequest(
		http.MethodGet,
		"/api/v0/documentation/facts?fact_kind=section&source_id=doc-source:documentation_export:synthetic&document_id=doc:documentation_export:sha256:synthetic&q=queue&limit=1",
		nil,
	)
	...
	if got, want := metadata["source_system"], "slack"; got != want {
