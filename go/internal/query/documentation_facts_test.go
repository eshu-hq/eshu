...
func TestDocumentationHandlerListsCollectedFacts(t *testing.T) {
		...
		Content: fakePortContentStore{
			documentationFactsModel: documentationFactListReadModel{
				Facts: []map[string]any{{
					...
					"scope_id":      "doc-source:confluence:example-org.atlassian.net:196609",
					"generation_id": "gen-1",
					"payload": map[string]any{
						"source_id":     "doc-source:confluence:example-org.atlassian.net:196609",
						"document_id":   "doc:confluence:123",
						"title":         "Platform Runbook",
						"canonical_uri": "https://example-org.atlassian.net/wiki/spaces/PLAT/pages/123",
					},
				}},
				NextCursor: "1",
			},
	...
	req := httptest.NewRequest(
		http.MethodGet,
		"/api/v0/documentation/facts?scope_id=doc-source:confluence:example-org.atlassian.net:196609&fact_kind=documentation_document&limit=1",
		nil,
	)
...
func TestContentReaderDocumentationFactsFiltersAndPaginates(t *testing.T) {
	...
	got, err := reader.documentationFacts(t.Context(), documentationFactFilter{
		...
		ScopeID:    "doc-source:confluence:example-org.atlassian.net:196609",
