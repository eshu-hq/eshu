...
func (s serviceReadModelInfrastructureOverflowContentStore) ListRepoEntitiesByTypes(_ context.Context, _ string, _ []string, _ int) ([]querycontract.EntityContent, error) {
...
func TestGetServiceContextReadModelFallbackDisclosesInfrastructureTruncated(t *testing.T) {
	...
	limitations := querycontract.StringSliceVal(body, "limitations")
