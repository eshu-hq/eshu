...
) (supplychain.SBOMAttestationAttachmentPage, error) {
	s.filters = append(s.filters, filter)
	return supplychain.SBOMAttestationAttachmentPage{
...
func TestServiceStorySupplyChainEvidenceFailsClosedForAmbiguousTags(t *testing.T) {
	...
	if missing := querycontract.StringSliceVal(segment, "missing_evidence"); !slices.Contains(missing, "container_image_identity_ambiguous") {
...
func TestServiceStorySupplyChainEvidenceFailsClosedForStaleIdentity(t *testing.T) {
	...
	if missing := querycontract.StringSliceVal(segment, "missing_evidence"); !slices.Contains(missing, "container_image_identity_stale") {
...
func TestServiceStorySupplyChainEvidenceFailsClosedForUnattachedSBOM(t *testing.T) {
	...
	if missing := querycontract.StringSliceVal(segment, "missing_evidence"); !slices.Contains(missing, "sbom_attachment_not_admissible") {
...
func TestServiceStorySupplyChainEvidenceReportsRepoOnlyHelmValuesImageRef(t *testing.T) {
	...
	if slices.Contains(missing, "deployment_image_reference_missing") {
...
func TestServiceStorySupplyChainEvidenceBoundsImageRefLookups(t *testing.T) {
	...
	refs := make([]string, 0, querycontract.ServiceStoryItemLimit+2)
	for i := range querycontract.ServiceStoryItemLimit + 2 {
