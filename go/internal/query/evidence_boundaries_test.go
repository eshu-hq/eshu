...
// described. testutil.SampleServiceDossierContext() never set ci_cd_evidence, which is
...
// (service_story_supply_chain.go:314-347). testutil.SampleServiceDossierContext() never
