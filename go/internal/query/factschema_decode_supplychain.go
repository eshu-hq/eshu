...
// (a missing/null required identity field), returns a *decode.Error
// (the decode package's classified failure, reused here rather than
...
// (explain_build.go) read across heterogeneous evidence
