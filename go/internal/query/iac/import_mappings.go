...
type terraformImportMapping struct {
	ResourceType string
	ImportID     func(ManagementFindingRow) string
}
...
func terraformImportMappingForFinding(finding ManagementFindingRow) (terraformImportMapping, bool) {
...
func terraformImportS3BucketID(finding ManagementFindingRow) string {
...
func terraformImportLambdaFunctionID(finding ManagementFindingRow) string {
...
func terraformImportSNSTopicID(finding ManagementFindingRow) string {
	resourceID := strings.TrimSpace(finding.ResourceID)
...
func terraformImportDynamoDBTableID(finding ManagementFindingRow) string {
	resourceID := strings.TrimSpace(finding.ResourceID)
...
func terraformImportECRRepositoryID(finding ManagementFindingRow) string {
	resourceID := strings.TrimSpace(finding.ResourceID)
...
func terraformImportCloudWatchLogGroupID(finding ManagementFindingRow) string {
	resourceID := strings.TrimSpace(finding.ResourceID)
