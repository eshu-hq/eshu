...
func terraformImportPlanFixture(resourceType, resourceID, arn string) ManagementFindingRow {
...
func terraformImportPlanCandidateForRow(t *testing.T, row ManagementFindingRow) map[string]any {
	t.Helper()
	handler := &Handler{
		Profile:    querycontract.ProfileLocalAuthoritative,
		Management: fakeIaCManagementStore{rows: []ManagementFindingRow{row}},
	}
...
func terraformImportPlanRequireReady(t *testing.T, row ManagementFindingRow) map[string]any {
	t.Helper()
...
func terraformImportPlanRequireRefused(t *testing.T, row ManagementFindingRow) map[string]any {
	t.Helper()
	candidate := terraformImportPlanCandidateForRow(t, row)
