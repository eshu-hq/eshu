...
// bindIaCManagementFilterAccess binds a ManagementFilter to the caller's
// exact AWS collector-scope grant (#5167 W4). Every handler on the shared
// ManagementStore.{List,Count}UnmanagedCloudResources choke point --
...
// unaffected: querycontract.RepositoryAccessFilterFromContext returns allScopes true, so
...
func bindIaCManagementFilterAccess(ctx context.Context, filter ManagementFilter) ManagementFilter {
