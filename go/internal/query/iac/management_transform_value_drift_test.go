...
// list_aws_runtime_drift_findings (via ManagementFindingRow, embedded in
...
func TestAWSRuntimeDriftRowToIaCManagementSurfacesDriftedAttributes(t *testing.T) {
	...
	want := []querycontract.DriftedAttributeView{{Attribute: "ami", Declared: "ami-0123456789abcdef0", Observed: "ami-000000000000000a"}}
	...
	// AWSRuntimeDriftFindingRow embeds ManagementFindingRow, so the JSON
	...
	wrapped := AWSRuntimeDriftFindingRow{ManagementFindingRow: finding}
