...
func replatformingReadinessForFinding(finding ManagementFindingRow, filter ManagementFilter) string {
...
// account.
func replatformingAccountKey(finding ManagementFindingRow, filter ManagementFilter) string {
