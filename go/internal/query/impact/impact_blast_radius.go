...
func (h *ImpactHandler) blastRadiusAffected(ctx context.Context, targetType, target string, limit int, access querycontract.RepositoryAccessFilter) ([]map[string]any, bool, bool, []blastRadiusEdgeCoverage, error) {
