...
// seam.go is the exported seam of the impact handler family (#6060).
...
// Handler methods the same pass found are renamed at their
...
const (
	...
	// MaxListLimit is the exported seam for maxListLimit, which
...
// families outside the impact move set call on Handler (contract,
...
// See #6060.
func (h *Handler) ResolvedProfile() querycontract.QueryProfile {
	return h.profile()
}
