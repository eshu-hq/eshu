...
// route's contract (resource_investigation.go,
// change_surface_investigation.go, change_surface_legacy.go,
...
// default limit of 25. The MCP dispatch route (mcp/dispatch_impact.go) passes an
...
// (change_surface_legacy.go) and the MaxDepth clamp in
// ResourceInvestigationRequest.normalize (resource_investigation.go),
