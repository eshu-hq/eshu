...
func TestSearchConsumerEvidenceAnyRepoUsesIndexedServiceReferences(t *testing.T) {
	...
	store := &indexedReferenceConsumerSearchContentStore{
		referenceRows: map[string][]querycontract.FileContent{
...
func TestSearchConsumerEvidenceAnyRepoDoesNotFallbackWhenIndexedServiceEmpty(t *testing.T) {
	...
	store := &indexedReferenceConsumerSearchContentStore{
		exactRows: []querycontract.FileContent{
			{RepoID: "repo-consumer", RelativePath: "deploy/values.yaml"},
		},
	}
	got, _, err := searchConsumerEvidenceAnyRepo(
...
func TestSearchConsumerEvidenceAnyRepoUsesIndexedHostnameReferences(t *testing.T) {
	...
	store := &indexedHostnameConsumerSearchContentStore{
		referenceRows: []querycontract.FileContent{
			{RepoID: "repo-consumer", RelativePath: "deploy/values.yaml"},
		},
	}
	got, _, err := searchConsumerEvidenceAnyRepo(
...
func (s *indexedReferenceConsumerSearchContentStore) SearchFileReferenceAnyRepo(_ context.Context, kind string, value string, _ int) ([]querycontract.FileContent, bool, error) {
	s.referenceCalls++
	key := kind + ":" + value
	rows := append([]querycontract.FileContent(nil), s.referenceRows[key]...)
	return rows, true, nil
}

func (s *indexedReferenceConsumerSearchContentStore) SearchFileContentAnyRepoExactCase(context.Context, string, int) ([]querycontract.FileContent, error) {
	s.exactCalls++
	return append([]querycontract.FileContent(nil), s.exactRows...), nil
}
...
func (s *indexedHostnameConsumerSearchContentStore) SearchFileReferenceAnyRepo(_ context.Context, kind string, value string, _ int) ([]querycontract.FileContent, bool, error) {
	s.referenceCalls++
	if kind != "hostname" {
		return nil, true, nil
	}
	...
	rows := append([]querycontract.FileContent(nil), s.referenceRows...)
	return rows, true, nil
}

func (s *indexedHostnameConsumerSearchContentStore) SearchFileContentAnyRepoExactCase(context.Context, string, int) ([]querycontract.FileContent, error) {
	s.exactCalls++
	return append([]querycontract.FileContent(nil), s.exactRows...), nil
}
...
func (s *methodChoiceConsumerSearchContentStore) SearchFileContentAnyRepo(context.Context, string, int) ([]querycontract.FileContent, error) {
	s.insensitiveCalls++
	return nil, nil
}

func (s *methodChoiceConsumerSearchContentStore) SearchFileContentAnyRepoExactCase(context.Context, string, int) ([]querycontract.FileContent, error) {
	s.exactCalls++
	return nil, nil
}
...
func (s *blockingConsumerSearchContentStore) SearchFileContentAnyRepo(ctx context.Context, pattern string, _ int) ([]querycontract.FileContent, error) {
	return s.blockedSearch(ctx, pattern)
}

func (s *blockingConsumerSearchContentStore) SearchFileContentAnyRepoExactCase(ctx context.Context, pattern string, _ int) ([]querycontract.FileContent, error) {
	return s.blockedSearch(ctx, pattern)
}

func (s *blockingConsumerSearchContentStore) blockedSearch(ctx context.Context, pattern string) ([]querycontract.FileContent, error) {
	s.mu.Lock()
