...
const impactAnchorLabelDisjunction = ImpactAnchorLabelDisjunction

// ImpactAnchorLabelDisjunction is the by-id anchor label set. Exported
// because the impact/ handler tests assert generated Cypher never
// interpolates it (a disjunction matches zero rows on the pinned NornicDB
// build); the canonical home stays this package. See #6060.
