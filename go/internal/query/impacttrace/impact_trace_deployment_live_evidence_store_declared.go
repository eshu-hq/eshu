...
const hasLiveKubernetesPodTemplateDeclaredObjectIdentityQuery = HasLiveKubernetesPodTemplateDeclaredObjectIdentityQuery

// HasLiveKubernetesPodTemplateDeclaredObjectIdentityQuery is the same query string, exported because staying query tests and
// the impact/ declared-evidence tests pin the SQL text; the home stays this
// package. See #6060.
...
const hasLiveKubernetesPodTemplateDeclaredObjectIdentityScopedQuery = HasLiveKubernetesPodTemplateDeclaredObjectIdentityScopedQuery

// HasLiveKubernetesPodTemplateDeclaredObjectIdentityScopedQuery is the same query string, exported because staying query tests and
// the impact/ declared-evidence tests pin the SQL text; the home stays this
// package. See #6060.
...
const listLiveKubernetesPodTemplateDeclaredObjectIdentityMatchesQuery = ListLiveKubernetesPodTemplateDeclaredObjectIdentityMatchesQuery

// ListLiveKubernetesPodTemplateDeclaredObjectIdentityMatchesQuery is the same query string, exported because staying query tests and
// the impact/ declared-evidence tests pin the SQL text; the home stays this
// package. See #6060.
...
const listLiveKubernetesPodTemplateDeclaredObjectIdentityMatchesScopedQuery = ListLiveKubernetesPodTemplateDeclaredObjectIdentityMatchesScopedQuery

// ListLiveKubernetesPodTemplateDeclaredObjectIdentityMatchesScopedQuery is the same query string, exported because staying query tests and
// the impact/ declared-evidence tests pin the SQL text; the home stays this
// package. See #6060.
