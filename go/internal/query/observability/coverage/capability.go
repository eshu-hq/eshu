...
// Capability is the capability id GET
// /api/v0/observability/coverage/correlations serves.
const Capability = "observability.coverage.correlations.list"
...
// reducer read model.
//
// This is the single declaration of the row. contract/observability_coverage.go
