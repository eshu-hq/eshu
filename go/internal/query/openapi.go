...
func OpenAPISpec() string {
	return strings.Replace(
		openAPISpecPrefix+
			...
			openAPIPathsRepositoriesStatsAndCoverage+
			...
			openAPIPathsSupplyChainAdvisoryCatalog+
			...
			openAPIPathsOperations+
			openAPIPathsFreshnessCausality+
