...
// VisualizationPackets is the OpenAPI path fragment documenting the
// `/api/v0/visualizations/derive` route. openapi.Spec concatenates it into the
// published document; keep it in lockstep with the handlers and
// docs/public/reference/http-api.md.
const VisualizationPackets = `
