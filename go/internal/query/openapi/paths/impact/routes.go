...
` + K8sResourceLimits + `
                    ...
                    "deployment_overview": {"type": "object", "description": "Deployment summary with counts, including the full hostname_count and entrypoint_count. It does not repeat the hostnames and entrypoints arrays."},
