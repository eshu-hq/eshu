    ...
    "/api/v0/images/tag-history": {
      "get": {
        ...
        "parameters": [
          ...
          {"name": "cursor", "in": "query", "schema": {"type": "string"}, "description": "Opaque continuation token from a truncated page's next_cursor. It is bound to the image_ref and the limit it was issued for; a malformed, edited, unknown-version, foreign-image_ref, or different-limit token returns 400 rather than a silently reset or empty page. Mutually exclusive with a non-zero offset."},
