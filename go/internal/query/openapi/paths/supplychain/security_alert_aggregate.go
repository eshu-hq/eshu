...
// SecurityAlertAggregate is the OpenAPI path fragment documenting the
// `/api/v0/supply-chain/security-alerts/reconciliations/count`,
// `/api/v0/supply-chain/security-alerts/reconciliations/inventory` routes.
