...
func TestOpenAPIAuthAdminReadPaths(t *testing.T) {
	...
	for _, path := range adminPaths {
		...
		get := testutil.MustMapField(t, entry, "get")
	...
	providers := testutil.MustMapField(t, testutil.MustMapField(t, paths, "/api/v0/auth/admin/idp-providers"), "get")
	...
	// returned.
	mappings := testutil.MustMapField(t, testutil.MustMapField(t, paths, "/api/v0/auth/admin/idp-group-mappings"), "get")
