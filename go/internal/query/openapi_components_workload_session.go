...
const openAPIComponentsWorkloadSession = `      "WorkloadContext": {
        ...
        "properties": {
          ...
          "infrastructure": {"type": "array", "description": "Repository-level infrastructure entities (Kubernetes, Terraform, ArgoCD, Helm, Kustomize, Crossplane, CloudFormation) for the workload's resolved repository. Present only once a repository has been resolved; see limitations for degraded or truncated reads.", "items": {"type": "object"}},
