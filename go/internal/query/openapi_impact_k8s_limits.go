...
const openAPIImpactK8sResourceLimits = `
                    "k8s_resource_limits": {
                      ...
                      "properties": {
                        "limit": {"type": "integer"},
                        "query_sentinel_limit": {"type": "integer", "description": "Content entity search limit, including the one-row truncation probe."},
                        ...
                        "observed_count_is_lower_bound": {"type": "boolean", "description": "True when the content entity search reached its sentinel, so additional matching Kubernetes rows may exist."},
