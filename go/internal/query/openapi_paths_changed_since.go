    ...
    "/api/v0/freshness/changed-since": {
      "get": {
        ...
        "parameters": [
          ...
          {"name": "repository", "in": "query", "schema": {"type": "string"}, "description": "Canonical repository id (matches repository-kind scopes by source_key; required unless scope_id is set)."},
