...
const openAPIPathsCode = `
    ...
    "/api/v0/code/dead-code": {
      "post": {
        ...
        "description": "Finds graph-backed dead-code candidates, applies the current default entrypoint/test/generated exclusions plus modeled language roots such as Go public-package exports, C parser-backed roots, and Groovy Jenkins roots, and classifies returned candidates without changing the derived truth envelope.",
          ...
          "content": {
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "repo_id": {"type": "string", "description": "Optional repository selector (canonical ID, name, slug, or path)"},
                  "language": {"type": "string", "description": "Optional parser language filter. Use this when validating one language family, for example c, groovy, or sql."},
