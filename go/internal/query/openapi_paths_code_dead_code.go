              ...
              "application/json": {
                "schema": {
                  ...
                  "properties": {
                    ...
                    "candidate_scan_truncated": {"type": "boolean", "description": "True when at least one selected candidate label reached candidate_scan_limit_per_label before exhausting candidates."},
                    ...
                    "candidate_scan_limit_per_label": {"type": "integer", "description": "Maximum raw candidate rows the investigation may inspect for each selected candidate label."},
              ...
              "application/json": {
                "schema": {
                  ...
                  "properties": {
                    ...
                    "candidate_scan_limit_per_label": {"type": "integer", "description": "Maximum raw candidate rows the classification may inspect for each selected candidate label."},
