                    ...
                    "findings": {
                      ...
                      "items": {
                        ...
                        "properties": {
                          ...
                          "detection_profile": {"type": "string", "enum": ["precise", "comprehensive"], "description": "Evidence tier the row meets. precise requires an exact installed-version anchor and ecosystem-aware match, including supported npm, PyPI, Maven, Cargo, NuGet, Swift, and vendor-backed RPM paths. comprehensive covers SBOM/CPE-derived, range-only, malformed, or missing-version rows that still have an owned anchor."},
