    ...
    "/api/v0/supply-chain/impact/findings/count": {
      "get": {
        ...
        "parameters": [
          ...
          {"name": "profile", "in": "query", "schema": {"type": "string", "enum": ["precise", "comprehensive"], "default": "precise"}, "description": "Detection profile selector. Matches the list endpoint: precise is the default, comprehensive also includes range-only, SBOM/CPE-derived, malformed range, unsupported ecosystem, and missing-version rows."},
