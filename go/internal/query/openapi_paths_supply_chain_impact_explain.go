              ...
              "application/json": {
                "schema": {
                  ...
                  "properties": {
                    ...
                    "finding": {
                      "type": "object",
                      "description": "The same finding shape returned by the list route, including read-time runtime context, exact digest-bound Kubernetes runtime refs, and bounded probe metadata.",
                      "properties": {
