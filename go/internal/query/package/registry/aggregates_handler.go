...
func (h *Handler) countPackageRegistryPackages(w http.ResponseWriter, r *http.Request) {
...
func (h *Handler) packageRegistryPackageInventory(w http.ResponseWriter, r *http.Request) {
	r, span := startQueryHandlerSpan(
		r,
		telemetry.SpanQueryPackageRegistryAggregate,
...
func packageRegistryAggregateFilterFromRequest(r *http.Request) AggregateFilter {
...
func packageRegistryAggregateScope(filter AggregateFilter) map[string]string {
...
func validatePackageRegistryAggregateVisibility(w http.ResponseWriter, filter AggregateFilter) bool {
	if filter.Visibility == "" {
		return true
	}
