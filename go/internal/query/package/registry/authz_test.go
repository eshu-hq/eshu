...
// TestAuthMiddlewareWithScopedTokensAllowsPackageRegistryCorrelationRoute and
// TestAuthMiddlewareWithScopedTokensAllowsPackageRegistryIdentityRoutes moved
// to root's package_registry_auth_middleware_test.go with the rest of this
// family's move (#6060): they exercise AuthMiddlewareWithScopedTokens's route
// allowlist directly (neither calls Handler or Mount), and
// that middleware has no leaf package this family can import without an
// import cycle back through root package query.
...
func (s *failingPackageRegistryCorrelationStore) ListPackageRegistryCorrelations(
	...
	s.called = true
	return CorrelationPage{}, errors.New("broad package registry correlation read")
}
