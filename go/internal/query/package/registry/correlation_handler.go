...
// CorrelationResult is one reducer-owned package ownership,
...
func (h *Handler) listCorrelations(w http.ResponseWriter, r *http.Request) {
	...
	results := make([]CorrelationResult, 0, len(page.Rows))
...
func (h *Handler) writeEmptyPackageRegistryCorrelationPage(
