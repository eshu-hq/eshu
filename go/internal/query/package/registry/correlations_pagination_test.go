...
// is the codex P1 finding regression test on PR #5816 (correlations.go:157).
...
func TestBuildPackageRegistryCorrelationPageDerivesTruncationFromFetchedFactsNotDecodedRows(t *testing.T) {
	...
	// PostgresCorrelationStore's "+1" convention.
...
// rawFactPackageRegistryCorrelationStore is a CorrelationStore
...
// early return (dependency_chains.go) forwards Truncated and
