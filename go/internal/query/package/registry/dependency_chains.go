...
// CorrelationPage -- derived from the RAW fetched consumption
...
func ResolvePackageDependencyChains(
	...
	consumptionPage, err := store.ListPackageRegistryCorrelations(ctx, CorrelationFilter{
...
func loadPackagePublishers(
	...
	publisherPage, err := store.ListPackageRegistryCorrelations(ctx, CorrelationFilter{
...
func distinctConsumedPackageIDs(rows []CorrelationRow) []string {
