...
// correlations.go is the only read site for these three
...
//
// This file moved from root package query into this family package with the
// rest of the package-registry handler family (#6060); it kept package query's decode
