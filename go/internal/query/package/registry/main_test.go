...
//
// `go test ./internal/query/package/registry` never links root package query:
// this family cannot import it without an import cycle (root's
// package_registry_alias.go already imports this family for the
