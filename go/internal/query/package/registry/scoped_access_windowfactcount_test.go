...
// tests, split out of scoped_access_test.go to keep that
// file under the repo's 500-line cap. See
// correlation_page.go's CorrelationPage.WindowFactCount
// doc comment and scoped_access.go's
...
// candidateFactPackageRegistryCorrelationStore is a CorrelationStore
