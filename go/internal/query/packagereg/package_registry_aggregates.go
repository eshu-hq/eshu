...
// NewGraphPackageRegistryAggregateStore wires a querycontract.GraphQuery (Neo4jReader in
// production) into the package-registry aggregate Reader.
func NewGraphPackageRegistryAggregateStore(graph querycontract.GraphQuery) GraphPackageRegistryAggregateStore {
