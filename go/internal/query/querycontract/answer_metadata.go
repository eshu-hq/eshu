...
// AnswerMetadataSchemaVersion is the answer_metadata shape version.
// Exported because handler tests across packages assert it on shaped
// responses. See #6060.
...
// WithDefaults fills unset AnswerMetadata slots (schema version, nil slices)
// so a decoded or partially built companion compares equal to a freshly
// derived one. Exported because package query normalizes packets from outside
