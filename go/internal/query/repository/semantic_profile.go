...
// buildEntitySemanticProfile keeps the in-package spelling after the #6060
// export; root stayers name BuildEntitySemanticProfile.
func buildEntitySemanticProfile(entity map[string]any) map[string]any {
	return BuildEntitySemanticProfile(entity)
}
