...
func TestGetRepositoryContextIncludesTypedRelationshipOverview(t *testing.T) {
	...
	if !testutil.AnySliceContains(evidenceKinds, "ARGOCD_APPLICATION_SOURCE") {
