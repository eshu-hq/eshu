...
func TestGetRepositoryContextSurfacesDockerComposeDeploysFromRelationship(t *testing.T) {
	t.Parallel()
			...
			rows: [][]driver.Value{
				{
					...
					"hash-docker-compose", int64(18), "yaml", "docker_compose",
				},
			},
		},
	})
	...
	if got, want := rel["type"], "DEPLOYS_FROM"; got != want {
