...
`,
	...
	configPaths := querycontract.MapSliceValue(got, "config_paths")
...
func TestBuildRepositoryConfigArtifactsExtractsTerragruntDependencyConfigPaths(t *testing.T) {
	...
	got := buildRepositoryConfigArtifacts("terraform-stack-payments", []querycontract.FileContent{
		{
...
func TestBuildRepositoryConfigArtifactsExtractsDockerComposeConfigLinks(t *testing.T) {
	...
	got := buildRepositoryConfigArtifacts("payments-service", []querycontract.FileContent{
		{
...
func TestBuildRepositoryConfigArtifactsExtractsTerragruntFindInParentFoldersSidecars(t *testing.T) {
	...
	got := buildRepositoryConfigArtifacts("iac-terragrunt-core-infra", []querycontract.FileContent{
		{
...
func TestBuildRepositoryConfigArtifactsExtractsAnsibleConfigAssets(t *testing.T) {
	...
	got := buildRepositoryConfigArtifacts("ansible-ops", []querycontract.FileContent{
		{
...
func TestBuildRepositoryConfigArtifactsDoesNotTreatHelmValuesAsAnsiblePlaybook(t *testing.T) {
	...
	got := buildRepositoryConfigArtifacts("helm-comprehensive", []querycontract.FileContent{
		{
...
func TestBuildRepositoryConfigArtifactsDoesNotTreatKubernetesIngressAsAnsiblePlaybook(t *testing.T) {
	...
	got := buildRepositoryConfigArtifacts("kubernetes-comprehensive", []querycontract.FileContent{
		{
...
func TestBuildRepositoryConfigArtifactsExtractsLocalVariableConfigAssets(t *testing.T) {
	...
	got := buildRepositoryConfigArtifacts("terraform-modules-aws", []querycontract.FileContent{
		{
...
func TestBuildRepositoryConfigArtifactsExtractsLookupBackedLocalVariableConfigAssets(t *testing.T) {
	...
	got := buildRepositoryConfigArtifacts("terraform-credentials", []querycontract.FileContent{
		{
...
func TestBuildRepositoryConfigArtifactsExtractsTerragruntGetRepoRootModuleSource(t *testing.T) {
	...
	got := buildRepositoryConfigArtifacts("terragrunt-deployment", []querycontract.FileContent{
		{
...
func TestBuildRepositoryConfigArtifactsExtractsJoinedPathModuleTemplateAssets(t *testing.T) {
	...
	got := buildRepositoryConfigArtifacts("terraform-stack-aws-client-vpn", []querycontract.FileContent{
		{
...
func TestBuildRepositoryConfigArtifactsExtractsNestedLocalInterpolationConfigAssets(t *testing.T) {
	...
	got := buildRepositoryConfigArtifacts("terraform-stack-event-linking", []querycontract.FileContent{
		{
...
`,
	...
	pathCounts := map[string]int{}
	for _, row := range configPaths {
		pathCounts[querycontract.StringVal(row, "path")]++
	}
...
`,
	...
	for _, row := range querycontract.MapSliceValue(got, "config_paths") {
		if strings.Contains(querycontract.StringVal(row, "path"), "terraform.tfstate") {
