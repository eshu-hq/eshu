...
func (s *stubServiceEvidenceReader) ListRepoFiles(context.Context, string, int) ([]querycontract.FileContent, error) {
	if s.listErr != nil {
...
func (s *stubServiceEvidenceReader) GetFileContent(_ context.Context, repoID, relativePath string) (*querycontract.FileContent, error) {
	if s.readErr != nil {
