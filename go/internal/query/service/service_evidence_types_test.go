...
func (r *countingSpecFileReader) ListRepoFiles(context.Context, string, int) ([]querycontract.FileContent, error) {
	return nil, nil
}

func (r *countingSpecFileReader) GetFileContent(_ context.Context, repoID, relativePath string) (*querycontract.FileContent, error) {
	r.getFileContentCalls++
	if r.err != nil {
		return nil, r.err
	}
	return &querycontract.FileContent{RepoID: repoID, RelativePath: relativePath, Content: r.content}, nil
}
