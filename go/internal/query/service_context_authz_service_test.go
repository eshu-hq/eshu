...
// This file holds the GetServiceStory/GetServiceContext/InvestigateService
// half of the scoped-workload-authorization coverage; the sibling
// service_context_authz_test.go covers GetWorkloadContext /
// FetchWorkloadContextForOperation and the shared fakes/helpers both files
// use. The split keeps each file under the repository's 500-line cap.
