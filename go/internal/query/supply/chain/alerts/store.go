...
// compat_supply_chain.go, and in turn cmd/api and cmd/mcp-server wiring
...
// at a call site. Moved from root's compat_supply_chain.go pin (#6642).
...
// call it through an unexported forward in compat_supply_chain.go.
