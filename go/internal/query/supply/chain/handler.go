...
// matrix (see compat_supply_chain.go's exported/unexported forwards) and
...
const (
	...
	// moved to internal/query/supply/chain/impact with the impact read models
	// (#6060 lane A); see compat_supply_chain.go.
)
