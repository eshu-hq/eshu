...
//
// `go test ./internal/query/supply/chain` never links root package query:
// this package cannot import it without an import cycle (root's
// compat_supply_chain.go already imports this package for the
...
// copy of their fields. A copied row is what the registry family's TestMain
