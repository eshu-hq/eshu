...
// internal/query/supply/chain/impact (#6060 lane A); the aliases in
// compat_supply_chain.go keep this probe compiling unchanged until
...
// internal/query/supply/chain/impact with the other runtime-evidence
// read-model types (#6060 lane A); see compat_supply_chain.go.
