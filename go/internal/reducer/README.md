...
- `observability_coverage_correlations_total` — observability coverage
  ...
  `paging`). Durable `reducer_observability_coverage_correlation` facts record
