...
// AzureRelationshipNodesNotReadyFailureClass identifies an in-handler readiness-gate miss: the
// Azure relationship edge intent ran before its upstream cloud-resource
...
const AzureRelationshipNodesNotReadyFailureClass = "azure_relationship_nodes_not_ready"

func (azureRelationshipNodesNotReadyError) FailureClass() string {
	return AzureRelationshipNodesNotReadyFailureClass
}
