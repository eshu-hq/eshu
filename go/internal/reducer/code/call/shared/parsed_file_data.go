...
// DeadCodeFileRootKinds returns the JavaScript dead-code file root-kind
// literals from a parsed_file_data map through the typed accessor, or nil
// when the key is absent or not a string slice. It mirrors the tolerant
// toStringSlice read the javascript leaf's file-root caller resolver used
// before this typing.
func DeadCodeFileRootKinds(fileData map[string]any) []string {
