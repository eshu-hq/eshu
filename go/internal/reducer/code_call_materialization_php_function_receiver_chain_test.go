...
func TestExtractCodeCallRowsResolvesPHPDirectFreeFunctionReturnReceiverCallsUsingTypedPropertyInference(t *testing.T) {
	t.Parallel()
...
func TestExtractCodeCallRowsResolvesPHPFreeFunctionReturnCallChainReceiverCallsUsingTypedPropertyInference(t *testing.T) {
	t.Parallel()
			...
			Payload: map[string]any{
				...
				"parsed_file_data": map[string]any{
					...
					"function_calls": []any{
						map[string]any{
							"name":              "info",
							"full_name":         "createFactory().createService().info",
							"inferred_obj_type": "Service",
							"line_number":       4,
							"lang":              "php",
						},
...
func TestExtractCodeCallRowsResolvesPHPNewExpressionReceiverCallsUsingTypedPropertyInference(t *testing.T) {
	t.Parallel()
