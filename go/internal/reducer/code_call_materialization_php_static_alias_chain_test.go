...
func TestExtractCodeCallRowsResolvesPHPImportedStaticTypeAliasReceiverChainsUsingTypedPropertyInference(t *testing.T) {
	t.Parallel()
			...
			Payload: map[string]any{
				...
				"parsed_file_data": map[string]any{
					...
					"function_calls": []any{
						map[string]any{
							"name":              "info",
							"full_name":         "AppFactory::instance().createService.info",
				...
				"parsed_file_data": map[string]any{
					...
					"functions": []any{
						map[string]any{
							...
							"line_number":   1,
							"end_line":      3,
							"uid":           "content-entity:php-factory-instance",
						},
						map[string]any{
							"name":          "createService",
							"class_context": "Factory",
