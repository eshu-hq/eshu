...
func TestContainerImageIdentityPublicationCanNarrowSourceRepositoryIDs(t *testing.T) {
	...
	tag := containerImageIdentityDecisionForOutcome(imageRef, digest, ContainerImageIdentityTagResolved)
	...
	exact := containerImageIdentityDecisionForOutcome(imageRef, digest, ContainerImageIdentityExactDigest)
