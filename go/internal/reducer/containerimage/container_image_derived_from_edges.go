...
func exactContainerImageDigest(decision ContainerImageIdentityDecision) string {
	if decision.Outcome != reducercontract.ContainerImageIdentityExactDigest {
		return ""
	}
...
func exactContainerImageSupportDigest(support containerImageIdentitySupport) string {
	if support.Outcome != string(reducercontract.ContainerImageIdentityExactDigest) {
		return ""
	}
...
func (h ContainerImageIdentityHandler) projectContainerImageDerivedFromEdges(
	...
	return h.projectContainerImageDerivedFromRows(
		ctx,
		intent,
		containerImageDerivedFromRows(decisions, payloadcore.RepositoryIDFromReducerScope(intent.ScopeID)),
	)
}
...
func (h ContainerImageIdentityHandler) projectContainerImageDerivedFromSupportEdges(
	...
	return h.projectContainerImageDerivedFromRows(
		ctx,
		intent,
		containerImageDerivedFromSupportRows(supports, payloadcore.RepositoryIDFromReducerScope(intent.ScopeID)),
	)
}
