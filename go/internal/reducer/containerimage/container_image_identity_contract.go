...
//
// reducercontract.ContainerImageIdentityOutcome and its constants are pure vocabulary (no
...
// this file's unqualified root aliases alongside reducercontract.DomainContainerImageIdentity.
