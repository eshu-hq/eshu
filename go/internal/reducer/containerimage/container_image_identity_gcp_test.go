...
func TestBuildContainerImageIdentityDecisionsConsumesGCPDigestReference(t *testing.T) {
	...
	assertContainerImageDecision(t, decision, reducercontract.ContainerImageIdentityExactDigest, testContainerDigest, 1)
...
func TestBuildContainerImageIdentityDecisionsResolvesGCPTagOnlyWithRegistryEvidence(t *testing.T) {
	...
	assertContainerImageDecision(t, decision, reducercontract.ContainerImageIdentityTagResolved, testContainerDigest, 1)
