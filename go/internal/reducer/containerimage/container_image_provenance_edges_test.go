...
func TestContainerImageBuiltFromRowsAdmitsExactDigestOnly(t *testing.T) {
	...
	decisions := []ContainerImageIdentityDecision{
		...
		},
		{
			...
			Outcome:                      reducercontract.ContainerImageIdentityAmbiguousTag,
		},
		{
...
func TestContainerImageBuiltFromRowsRejectsBlankDigest(t *testing.T) {
	...
	decisions := []ContainerImageIdentityDecision{
		{Digest: "  ", BuildProvenanceRepositoryIDs: []string{"repo-1"}, Outcome: reducercontract.ContainerImageIdentityExactDigest},
	}
...
func TestProjectContainerImageBuiltFromEdgesNoOpWithoutWriter(t *testing.T) {
	...
	if err := h.projectContainerImageBuiltFromEdges(context.Background(), reducercontract.Intent{ScopeID: "scope-1", GenerationID: "gen-1"}, nil); err != nil {
...
func TestProjectContainerImageBuiltFromEdgesRetractsFirstThenWrites(t *testing.T) {
	...
	decisions := []ContainerImageIdentityDecision{
		{Digest: "sha256:exact", SourceRepositoryIDs: []string{"repo-1"}, BuildProvenanceRepositoryIDs: []string{"repo-1"}, Outcome: reducercontract.ContainerImageIdentityExactDigest},
	}

	if err := h.projectContainerImageBuiltFromEdges(context.Background(), reducercontract.Intent{ScopeID: "scope-1", GenerationID: "gen-1"}, decisions); err != nil {
...
func TestProjectContainerImageBuiltFromEdgesRetractsEvenWhenNoRowsToWrite(t *testing.T) {
	...
	if err := h.projectContainerImageBuiltFromEdges(context.Background(), reducercontract.Intent{ScopeID: "scope-1", GenerationID: "gen-2"}, nil); err != nil {
		t.Fatalf("projectContainerImageBuiltFromEdges returned error: %v", err)
	}
	if len(writer.retractCalls) != 1 {
...
//     (containerImageIdentityFactKinds via factload.LoadFactsForKinds in
