...
type CodeEvidenceHandlers struct {
	...
	CodeInterprocEvidenceLoader taint.InterprocEvidenceFactLoader

	// CodeInterprocEvidenceWriter projects cross-function findings into
	// TAINT_FLOWS_TO edges between Function nodes.
	CodeInterprocEvidenceWriter taint.InterprocEvidenceWriter
	...
	CodeInterprocProjectedEdgeLedger taint.InterprocProjectedEdgeLedger
