...
// growing with a second full node-row build. The sibling identity-extractor
// benchmark moved with its family to
// go/internal/reducer/ec2instance/ec2_instance_identity_rows_bench_test.go
// (issue #6061); this file stays because it exercises the root extractor.
