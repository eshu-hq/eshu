# Agent instructions: internal/reducer/intents/phase
...
[doc.go](doc.go)). It groups `intents/phase/repair`.

## Hard rules

**Do not add code here.** Put new code in `intents/phase/repair`, not in
