...
// rather than exported from the root for test-only use. This family needs no
// phase-publisher fake: unlike the EC2 instance node domain, neither
// exposure handler publishes a readiness phase.
