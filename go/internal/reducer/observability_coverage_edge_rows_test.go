...
func TestExtractObservabilityCoverageEdgeRowsEmitsExactEdge(t *testing.T) {
	...
	rows, tally := ExtractObservabilityCoverageEdgeRows(ec2AlarmCoverageFixture())
	if len(rows) != 1 {
...
func TestExtractObservabilityCoverageEdgeRowsGapEmitsNoEdge(t *testing.T) {
	...
	rows, _ := ExtractObservabilityCoverageEdgeRows(envelopes)
...
func TestExtractObservabilityCoverageEdgeRowsAmbiguousEmitsNoEdge(t *testing.T) {
	...
	rows, _ := ExtractObservabilityCoverageEdgeRows([]facts.Envelope{one, two, alarm, rel})
	if len(rows) != 0 {
...
func TestExtractObservabilityCoverageEdgeRowsStaleEmitsNoEdge(t *testing.T) {
	...
	rows, _ := ExtractObservabilityCoverageEdgeRows([]facts.Envelope{instance, alarm, rel})
	if len(rows) != 0 {
...
func TestExtractObservabilityCoverageEdgeRowsRejectedEmitsNoEdge(t *testing.T) {
	...
	rows, _ := ExtractObservabilityCoverageEdgeRows([]facts.Envelope{alarm, rel})
	if len(rows) != 0 {
...
func TestExtractObservabilityCoverageEdgeRowsXRayDerivedEmitsNoEdge(t *testing.T) {
	...
	rows, _ := ExtractObservabilityCoverageEdgeRows([]facts.Envelope{rule, rel})
	if len(rows) != 0 {
...
func TestExtractObservabilityCoverageEdgeRowsEmptyIsNoOp(t *testing.T) {
	...
	rows, tally := ExtractObservabilityCoverageEdgeRows(nil)
	if len(rows) != 0 {
