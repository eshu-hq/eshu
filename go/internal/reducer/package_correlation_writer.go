...
// PackageCorrelationWrite carries package ownership and consumption decisions
// for durable reducer facts.
...
// WritePackageCorrelations persists source-hint ownership candidates and
// manifest-backed consumption truth. Ownership candidates keep
// canonical_writes=0 until stronger build, release, or CI evidence exists.
func (w PostgresPackageCorrelationWriter) WritePackageCorrelations(
	...
	return PackageCorrelationWriteResult{
		...
		EvidenceSummary: fmt.Sprintf(
			"wrote package correlations ownership=%d consumption=%d canonical_writes=%d",
