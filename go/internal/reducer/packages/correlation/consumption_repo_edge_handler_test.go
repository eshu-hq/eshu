...
// recordingRepoDependencyIntentWriter is a minimal family-local fake
// satisfying crossrepo.RepoDependencyIntentWriter. The reducer root keeps its
// own copy for the staying cross-repo and code-import tests
// (cross_repo_test_doubles_test.go); Go test files cannot share unexported
// symbols across a package boundary, so this family test keeps a local copy
// (issue #6061).
