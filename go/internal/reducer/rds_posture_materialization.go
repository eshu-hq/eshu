...
// RDSPostureNodesNotReadyFailureClass identifies an in-handler readiness-gate miss: the
// RDS posture edge intent ran before its upstream cloud-resource
...
const RDSPostureNodesNotReadyFailureClass = "rds_posture_nodes_not_ready"

func (rdsPostureNodesNotReadyError) FailureClass() string {
	return RDSPostureNodesNotReadyFailureClass
}
