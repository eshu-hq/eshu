...
// cloudInventoryAdmissionDomainDefinition moved to
// [cloudinventory.CloudInventoryAdmissionDomainDefinition] with the family
// (issue #6061); the registry now calls the family package directly from
