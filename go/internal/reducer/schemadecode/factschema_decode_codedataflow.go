...
func DecodeCodeDataflowScanned(env facts.Envelope) (codedataflowv1.DataflowScanned, error) {
	...
	if err != nil {
		return codedataflowv1.DataflowScanned{}, factdecode.NewFactDecodeError(factschema.FactKindCodeDataflowScanned, err)
	}
	return scanned, nil
}
...
func DecodeCodeDataflowFunction(env facts.Envelope) (codedataflowv1.DataflowFunction, error) {
	...
	if err != nil {
		return codedataflowv1.DataflowFunction{}, factdecode.NewFactDecodeError(factschema.FactKindCodeDataflowFunction, err)
	}
	return function, nil
}
...
func DecodeCodeFunctionSummary(env facts.Envelope) (codedataflowv1.FunctionSummary, error) {
	...
	if err != nil {
		return codedataflowv1.FunctionSummary{}, factdecode.NewFactDecodeError(factschema.FactKindCodeFunctionSummary, err)
	}
	return summary, nil
}
...
func DecodeCodeFunctionSource(env facts.Envelope) (codedataflowv1.FunctionSource, error) {
	...
	if err != nil {
		return codedataflowv1.FunctionSource{}, factdecode.NewFactDecodeError(factschema.FactKindCodeFunctionSource, err)
	}
	return source, nil
}
...
func DecodeCodeTaintEvidence(env facts.Envelope) (codedataflowv1.TaintEvidence, error) {
	...
	if err != nil {
		return codedataflowv1.TaintEvidence{}, factdecode.NewFactDecodeError(factschema.FactKindCodeTaintEvidence, err)
	}
	return evidence, nil
}
...
func DecodeCodeInterprocEvidence(env facts.Envelope) (codedataflowv1.InterprocEvidence, error) {
	...
	if err != nil {
		return codedataflowv1.InterprocEvidence{}, factdecode.NewFactDecodeError(factschema.FactKindCodeInterprocEvidence, err)
	}
	return evidence, nil
}
