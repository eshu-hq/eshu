...
func securityAlertReconciliationPayload(
	...
	return map[string]any{
		...
		"eshu_observed_version":         strings.TrimSpace(decision.EshuObservedVersion),
		"eshu_match_reason":             strings.TrimSpace(decision.EshuMatchReason),
		"eshu_missing_evidence":         uniqueSortedStrings(decision.EshuMissingEvidence),
