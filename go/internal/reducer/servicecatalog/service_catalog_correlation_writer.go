...
// serviceCatalogCorrelationFactKind aliases the exported contract constant so
// this file's existing unqualified spelling keeps compiling unchanged. See
// [reducercontract.ServiceCatalogCorrelationFactKind].
const serviceCatalogCorrelationFactKind = reducercontract.ServiceCatalogCorrelationFactKind
...
func serviceCatalogCorrelationPayload(
	...
	return map[string]any{
		"reducer_domain":           string(reducercontract.DomainServiceCatalogCorrelation),
