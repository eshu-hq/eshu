...
//
// Exported (rather than kept package-private) because the reducer root's own
// golden fixture test (service_changed_since_golden_fixture_test.go) asserts
// distinctness and idempotency directly against this derivation rather than
// through a wired handler, and duplicating a fingerprint algorithm risks a
// silent drift between the golden test and production behavior (issue #6061).
