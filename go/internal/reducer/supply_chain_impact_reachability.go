...
// SupplyChainReachabilityState aliases
// [supplychaincore.SupplyChainReachabilityState]; the reachability value
// types moved to the shared supply-chain leaf (#6061) while the enrichment
// functions below stay in this package.
type SupplyChainReachabilityState = supplychaincore.SupplyChainReachabilityState

const (
	// SupplyChainReachabilityReachable aliases [supplychaincore.SupplyChainReachabilityReachable].
	SupplyChainReachabilityReachable = supplychaincore.SupplyChainReachabilityReachable
	// SupplyChainReachabilityNotCalled aliases [supplychaincore.SupplyChainReachabilityNotCalled].
	SupplyChainReachabilityNotCalled = supplychaincore.SupplyChainReachabilityNotCalled
	// SupplyChainReachabilityUnknown aliases [supplychaincore.SupplyChainReachabilityUnknown].
	SupplyChainReachabilityUnknown = supplychaincore.SupplyChainReachabilityUnknown
	// SupplyChainReachabilityUnavailable aliases [supplychaincore.SupplyChainReachabilityUnavailable].
	SupplyChainReachabilityUnavailable = supplychaincore.SupplyChainReachabilityUnavailable
	// SupplyChainReachabilityMissingEvidence aliases [supplychaincore.SupplyChainReachabilityMissingEvidence].
	SupplyChainReachabilityMissingEvidence = supplychaincore.SupplyChainReachabilityMissingEvidence
)

// SupplyChainReachability aliases [supplychaincore.SupplyChainReachability].
type SupplyChainReachability = supplychaincore.SupplyChainReachability
