...
// SupplyChainImpactRemediation is the reducer-root spelling of
// [supplychaincore.SupplyChainImpactRemediation]; the advisory-only
// safe-upgrade type moved to the shared supply-chain leaf (#6061) while
// BuildSupplyChainImpactRemediation and the closed reason/confidence/manifest
// constant sets below stay here. See the leaf type for the full field and
// confidence contract.
type SupplyChainImpactRemediation = supplychaincore.SupplyChainImpactRemediation
