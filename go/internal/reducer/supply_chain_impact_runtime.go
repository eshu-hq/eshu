...
// SupplyChainServiceWorkloadPair aliases
// [supplychaincore.SupplyChainServiceWorkloadPair]; the value type moved to
// the shared supply-chain leaf (#6061) while uniqueServiceWorkloadPairs and
// the suppression scope-match helpers that read it stay in this package.
type SupplyChainServiceWorkloadPair = supplychaincore.SupplyChainServiceWorkloadPair
