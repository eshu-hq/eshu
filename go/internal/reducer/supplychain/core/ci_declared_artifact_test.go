...
func TestBuildSupplyChainImpactFindingsUsesFactOrderWithinEqualMatchStrength(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			deployments: []facts.Envelope{
				cicdRunCorrelationImpactFact("deploy-a", testImpactSubjectDigest, "registry.example.com/api:digest-a", testImpactRepositoryID, testImpactEnv, string(cicdrun.CICDRunCorrelationExact)),
				cicdRunCorrelationImpactFact("deploy-b", testImpactSubjectDigest, "registry.example.com/api:digest-b", testImpactRepositoryID, testImpactEnv, string(cicdrun.CICDRunCorrelationExact)),
			},
		...
		},
		{
			...
			deployments: []facts.Envelope{
				cicdRunCorrelationImpactFact("deploy-c", testImpactOtherDigest, findingImageRef, testImpactRepositoryID, testImpactEnv, string(cicdrun.CICDRunCorrelationExact)),
				cicdRunCorrelationImpactFact("deploy-d", thirdDigest, findingImageRef, testImpactRepositoryID, testImpactEnv, string(cicdrun.CICDRunCorrelationExact)),
			},
