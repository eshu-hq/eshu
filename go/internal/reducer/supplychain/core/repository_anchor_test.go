...
// repositoryAnchorSupplyChainImpactFactLoader is a scope-aware factload.FactLoader fake
...
func TestSupplyChainImpactHandlerResolvesRepositoryFromContainerImageIdentityDigest(t *testing.T) {
	...
	assertContainsString(t, got.EvidencePath, reducercontract.ContainerImageIdentityFactKind)
