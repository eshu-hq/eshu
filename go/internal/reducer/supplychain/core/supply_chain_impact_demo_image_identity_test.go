...
// upstream domains (reducercontract.DomainContainerImageIdentity, reducercontract.DomainSBOMAttestationAttachment)
...
// reducercontract.DomainSupplyChainImpact, which is what the API route the proof script polls
