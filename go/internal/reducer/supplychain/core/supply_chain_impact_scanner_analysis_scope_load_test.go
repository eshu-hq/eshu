...
// factload.FactLoader fake that TestSupplyChainImpactHandlerLoadsScannerAnalysisFromOSPackageScanScope
...
// reader the handler's factload.FactLoader is type-asserted against.
