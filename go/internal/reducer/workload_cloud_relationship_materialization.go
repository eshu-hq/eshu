...
// WorkloadCloudRelationshipNodesNotReadyFailureClass identifies an in-handler readiness-gate miss: the
// workload-cloud relationship edge intent ran before its upstream cloud-resource
...
const WorkloadCloudRelationshipNodesNotReadyFailureClass = "workload_cloud_relationship_nodes_not_ready"

func (workloadCloudRelationshipNotReadyError) FailureClass() string {
	return WorkloadCloudRelationshipNodesNotReadyFailureClass
}
