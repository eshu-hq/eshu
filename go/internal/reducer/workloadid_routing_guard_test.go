...
// this test scans the package's own non-test sources for the two hand-built
// shapes and fails on either.
//
// Deliberately narrow patterns, not a broad "workload:" match:
//   - `Sprintf("workload:%s",` is the exact pre-refactor construction. The
