...
func RenderDashboard(rep CoverageReport) []byte {
	...
	b.WriteString("\n\n")
	b.WriteString("Every surface Eshu claims to support should map to a committed replay scenario. ")
	b.WriteString("Each row maps to a committed scenario and the named proof gate that must pass. ")
