...
func TestStatusMetricsHandlerServesRuntimeMetrics(t *testing.T) {
	...
	for _, want := range []string{
		...
		`eshu_runtime_provenance_edge_identity_upgrade_applied{service_name="collector-git"} 1`,
		`eshu_runtime_provenance_edge_identity_upgrade_required{service_name="collector-git"} 2`,
