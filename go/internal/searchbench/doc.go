...
// and operability metrics, issue #417 hybrid retrieval proof, and issue #1298
// stopped evidence. It performs no database, graph, protocol, reranker, or
// NornicDB I/O; live adapters must feed measured observations into this
