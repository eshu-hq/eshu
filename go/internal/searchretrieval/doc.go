...
// the attempt. The package normalizes ranked EshuSearchDocument candidates into
// deterministic top-K responses that preserve derived truth labels, freshness,
// graph handles, truncation, and false-canonical-claim counts. It performs no
// Postgres, graph, NornicDB, HTTP, MCP, or OTEL I/O.
