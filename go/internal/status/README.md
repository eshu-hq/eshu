...
- `RegistryCollectorSnapshot` — bounded OCI and package-registry runtime status
  counts for configured instances, active scopes, completed generations, last
  completed timestamp, retryable/terminal failures, and failure classes without
  private registry object names
