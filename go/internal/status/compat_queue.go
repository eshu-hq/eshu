...
// once its last caller has moved to the leaf; see the importer-migration issue #6949. A later queue move adds a stanza here and never creates a second
// compat file for this family.

import "github.com/eshu-hq/eshu/go/internal/status/queue"

// Queue blockage and failure sections. See the [queue] names.
type (
