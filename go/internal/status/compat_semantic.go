...
// importer-migration issue #6949. A later semantic move adds a stanza here and
...
// Semantic extraction and provider profile sections. See the [semantic] names.
type (
...
// Semantic extraction states and reasons. See the [semantic] constants.
const (
...
// See [semantic.ExtractionSupportedStates].
...
// See [semantic.ProviderProfileSupportedStates].
...
// See [semantic.DefaultExtractionStatus].
