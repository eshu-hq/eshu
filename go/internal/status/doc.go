...
// shared projection backlog as unfinished graph-visible work and uses active
// shared-projection leases as in-flight progress, so code graph and dead-code
// queries do not look ready while accepted edges are still being written.
package status
