...
func TestBuildSubmodulePinRowMap(t *testing.T) {
	...
	cypher, rowMap, ok := sourcecypher.BuildSubmodulePinRowMap(payload, "reducer/submodule")
	if !ok {
		t.Fatal("BuildSubmodulePinRowMap ok = false, want true")
	}
	if cypher != sourcecypher.BatchCanonicalSubmodulePinEdgeCypher {
...
func TestBuildSubmodulePinRowMapOmitsUnknownPinnedSHA(t *testing.T) {
	...
	_, rowMap, ok := sourcecypher.BuildSubmodulePinRowMap(payload, "reducer/submodule")
	if !ok {
		t.Fatal("BuildSubmodulePinRowMap ok = false, want true")
	}
...
func TestBuildSubmodulePinRowMapRequiresMergeKeys(t *testing.T) {
	...
	for _, missing := range []string{"parent_repo_id", "resolved_repo_id", "submodule_path"} {
		...
		if _, _, ok := sourcecypher.BuildSubmodulePinRowMap(payload, "src"); ok {
...
func TestBuildRetractSubmodulePinEdges(t *testing.T) {
	...
	stmt := sourcecypher.BuildRetractSubmodulePinEdges([]string{"repo-parent"}, "reducer/submodule")
...
func TestBuildRetractSubmodulePinEdgesAnchorsOnParentRepo(t *testing.T) {
	...
	stmt := sourcecypher.BuildRetractSubmodulePinEdges([]string{"repo-A"}, "reducer/submodule")
...
func TestEdgeWriterWriteEdgesSubmodulePinRoutesTemplate(t *testing.T) {
	...
	if executor.calls[0].Cypher != sourcecypher.BatchCanonicalSubmodulePinEdgeCypher {
