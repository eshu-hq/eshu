...
type targetMissProbeExecutor struct {
	executeCalls    int
	probeCalls      int
	probeStmts      []sourcecypher.Statement
	probeAllPresent bool
	probeErr        error
}

func (e *targetMissProbeExecutor) Execute(_ context.Context, _ sourcecypher.Statement) error {
	e.executeCalls++
	return nil
}

func (e *targetMissProbeExecutor) ExecuteProbe(_ context.Context, stmt sourcecypher.Statement) (bool, error) {
	e.probeCalls++
