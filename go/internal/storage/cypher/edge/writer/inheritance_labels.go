...
func buildInheritanceRowMap(
	...
	childEntityID := sourcecypher.PayloadString(payload, "child_entity_id")
	parentEntityID := sourcecypher.PayloadString(payload, "parent_entity_id")
	...
	childLabel := sourcecypher.PayloadString(payload, "child_entity_type")
	parentLabel := sourcecypher.PayloadString(payload, "parent_entity_type")
	...
	case "OVERRIDES":
		return sourcecypher.BatchCanonicalInheritanceOverrideUpsertCypher, rowMap, true
	case "ALIASES":
		return sourcecypher.BatchCanonicalInheritanceAliasUpsertCypher, rowMap, true
	case "IMPLEMENTS":
		return sourcecypher.BatchCanonicalImplementsEdgeUpsertCypher, rowMap, true
	case "", "INHERITS":
		return sourcecypher.BatchCanonicalInheritanceEdgeUpsertCypher, rowMap, true
	default:
		return "", nil, false
	}
}
