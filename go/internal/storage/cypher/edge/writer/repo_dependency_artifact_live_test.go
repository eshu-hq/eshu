...
func (e *trueGroupLiveExecutor) Execute(ctx context.Context, stmt sourcecypher.Statement) error {
	return e.runner.runCypherSingle(ctx, stmt)
}

func (e *trueGroupLiveExecutor) ExecuteGroup(ctx context.Context, stmts []sourcecypher.Statement) error {
