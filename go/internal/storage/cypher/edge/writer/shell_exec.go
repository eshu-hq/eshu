...
func buildShellExecRowMap(
	...
	sourcePath := sourcecypher.PayloadString(payload, "source_path")
	...
	return BatchCanonicalShellExecUpsertCypher, map[string]any{
		...
		"line_number":       sourcecypher.PayloadInt(payload, "line_number"),
		"api":               sourcecypher.PayloadString(payload, "api"),
		"language":          sourcecypher.PayloadString(payload, "language"),
		"relationship_type": sourcecypher.PayloadString(payload, "relationship_type"),
		"evidence_source":   evidenceSource,
	}, true
}

// BuildRetractShellExecEdges builds shell execution edge retraction for repos.
func BuildRetractShellExecEdges(repoIDs []string, evidenceSource string) sourcecypher.Statement {
...
func BuildRetractShellExecEdgesByFilePath(filePaths []string, evidenceSource string) sourcecypher.Statement {
	return sourcecypher.Statement{
		Operation: sourcecypher.OperationCanonicalRetract,
