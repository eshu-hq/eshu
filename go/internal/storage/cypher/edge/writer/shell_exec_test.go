...
func assertShellExecRetractScopesEvidenceSource(t *testing.T, stmt sourcecypher.Statement, scopeParam string) {
	t.Helper()
...
func assertShellExecDeleteByUIDStatement(t *testing.T, stmt sourcecypher.Statement, wantKeys []string) {
	t.Helper()
