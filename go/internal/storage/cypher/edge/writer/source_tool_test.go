...
func TestBuildCanonicalRepoDependencyUpsertStampsSourceTool(t *testing.T) {
	...
	stmt := sourcecypher.BuildCanonicalRepoDependencyUpsert(sourcecypher.CanonicalRepoDependencyParams{
		RepoID:       "repo-a",
		TargetRepoID: "repo-b",
		SourceTool:   "ansible",
	}, "resolver/cross-repo")
...
func TestBuildCanonicalRepoRelationshipUpsertStampsSourceTool(t *testing.T) {
	...
	for _, relType := range []string{
		...
		stmt := sourcecypher.BuildCanonicalRepoRelationshipUpsert(sourcecypher.CanonicalRepoRelationshipParams{
			RepoID:           "repo-a",
			TargetRepoID:     "repo-b",
