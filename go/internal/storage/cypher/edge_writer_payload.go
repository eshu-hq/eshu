...
// payloadString reads a string field from a shared-projection intent payload,
// returning the empty string when the key is absent or not a string.
...
// payloadBool reads a boolean field from a payload, returning false when the key
