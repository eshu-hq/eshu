...
const collectorGenerationDeadLetterSchemaSQL = `
...
func collectorGenerationDeadLetterBootstrapDefinition() Definition {
	return Definition{
		Name: "collector_generation_dead_letters",
		Path: "schema/data-plane/postgres/006b_collector_generation_dead_letters.sql",
