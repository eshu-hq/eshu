...
- Task-777 worst partition:
  ...
  `new_facts=0` in `5.215589209s`.
- Retained evidence scopes preserved exact evidence:
  - `r_d393ab02`: `old_facts=103`, `new_facts=100`, `old_evidence=788`,
    `new_evidence=788`, `old_load=2.335089542s`, `new_load=2.342339334s`.
  - `r_415c2ca3`: `old_facts=1239`, `new_facts=1123`, `old_evidence=210`,
    `new_evidence=210`, `old_load=9.497368583s`, `new_load=8.1424485s`.
  - `r_d737ae8e`: `old_facts=367`, `new_facts=271`, `old_evidence=123`,
    `new_evidence=123`, `old_load=4.161278375s`, `new_load=3.975898333s`.
  - `r_6d9013cd`: `old_facts=107`, `new_facts=100`, `old_evidence=572`,
    `new_evidence=572`, `old_load=3.173026458s`, `new_load=3.081788125s`.
  - `r_7616858d`: `old_facts=106`, `new_facts=100`, `old_evidence=478`,
    `new_evidence=478`, `old_load=2.98073425s`, `new_load=2.8817s`.
  - `r_15dfa4e6`: `old_facts=55`, `new_facts=52`, `old_evidence=456`,
    `new_evidence=456`, `old_load=1.241908459s`, `new_load=1.197784s`.
  - `r_a1c966b1`: `old_facts=119`, `new_facts=116`, `old_evidence=284`,
    `new_evidence=284`, `old_load=2.003172416s`, `new_load=1.982132333s`.
  - `r_a0dbf5f4`: `old_facts=92`, `new_facts=88`, `old_evidence=242`,
    `new_evidence=242`, `old_load=1.542599041s`, `new_load=1.5477645s`.
  - `r_ba232843`: `old_facts=122`, `new_facts=112`, `old_evidence=192`,
    `new_evidence=192`, `old_load=3.069375208s`, `new_load=2.829388917s`.
  - `r_68db34ea`: `old_facts=37`, `new_facts=34`, `old_evidence=238`,
    `new_evidence=238`, `old_load=760.957625ms`, `new_load=683.999916ms`.
  - `r_4d50ff71`: `old_facts=75`, `new_facts=72`, `old_evidence=173`,
    `new_evidence=173`, `old_load=985.929833ms`, `new_load=950.333333ms`.
