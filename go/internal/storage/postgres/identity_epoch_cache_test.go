...
// TestIdentityEpochCacheConcurrentSingleflight and its supporting
// concurrentSingleflightQueryer fake live in
// identity_epoch_cache_concurrency_test.go, which groups the concurrency
// surface of this cache separately from the sequential-access tests below.
