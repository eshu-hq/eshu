-- 128_service_materialization_generations_active_service_idx_rescope.sql
--
-- #6475: drops the single-active-per-service_id definition of
-- service_materialization_generations_active_service_idx so migration 129 can
...
-- with lock_timeout and retries (schema.go). Between this drop and 129's build
...
-- they could leave two actives, and 129 then fails loudly (and is retried by
