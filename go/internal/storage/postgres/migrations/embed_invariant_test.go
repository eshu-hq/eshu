...
// goldenBootstrapDefinitionsDigest pins BootstrapDefinitions() as captured at
// eshu-hq/eshu#6693's base commit (7c561440c), before the embed moved from
// root's schema.go into this package. It is sha256 over
// "Name|Path|sha256(SQL)\n" per definition, in BootstrapDefinitions() order.
// The migration tracker keys applied migrations by path + variant +
...
// an intentional migration edit, never by the D2 package split alone.
const goldenBootstrapDefinitionsDigest = "4167ad0e0bb49fc9cfbcea243c9672b1ceddfc860db7ead5a4b1526a619ed7e4"
