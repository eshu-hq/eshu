...
func TestValidateTerraformStateCollectorConfigurationRejectsS3BackendFilterWithoutCredentials(t *testing.T) {
	t.Parallel()
	...
	if got, want := err.Error(), "target_scopes or aws.role_arn"; !strings.Contains(got, want) {
