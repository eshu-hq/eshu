...

{
	...
	printf '`error` rather than as a gate failure: a cancelled check, a stale one, one\n'
	printf 'GitHub marked skipped because the run that owned it was cancelled, and one\n'
