...
# shell_exec fault cells (#6001). Three one-line delegations to the
...
cell_baseline_shell_exec() {
	cell_baseline_family shell_exec
}

cell_killworker_shell_exec() {
	cell_killworker_family shell_exec
}

cell_failgraphwrite_shell_exec() {
	cell_failgraphwrite_family shell_exec
}
