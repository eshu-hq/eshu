...
ifa_live_gate_common_seams=(
	...
	'go/internal/projector/failure/retry.go|go/internal/projector/failure/retry.go'
	'go/internal/projector/decode/schema_version_admission.go|go/internal/projector/decode/schema_version_admission.go'
	'go/internal/storage/postgres/queue/failure_metadata.go|go/internal/storage/postgres/queue/failure_metadata.go'
	'go/internal/storage/postgres/queue/backoff.go|go/internal/storage/postgres/queue/backoff.go'
	...
	'go/internal/ifa/materializededges/**|go/internal/ifa/materializededges/code_calls.go'
	'go/internal/ifa/materializededges/**|go/internal/ifa/materializededges/documentation.go'
	...
	'go/internal/storage/cypher/edge/writer/*documentation*.go|go/internal/storage/cypher/edge/writer/documentation_labels.go'
	'scripts/lib/ifa_*_live*.sh|scripts/lib/ifa_documentation_live.sh'
	'go/internal/ifa/materializededges/**|go/internal/ifa/materializededges/codeowners.go'
	...
	'go/internal/ifa/materializededges/**|go/internal/ifa/materializededges/submodule_pin.go'
	...
	'go/internal/storage/cypher/payload_accessors.go|go/internal/storage/cypher/payload_accessors.go'
	'go/internal/storage/cypher/canonical_instantiates_edges.go|go/internal/storage/cypher/canonical_instantiates_edges.go'
	'go/internal/storage/cypher/edge/writer/writer.go|go/internal/storage/cypher/edge/writer/writer.go'
	'go/internal/storage/cypher/canonical_retract.go|go/internal/storage/cypher/canonical_retract.go'
	'go/internal/storage/cypher/edge/writer/retract*.go|go/internal/storage/cypher/edge/writer/retract.go'
	'go/internal/storage/cypher/edge/writer/retract*.go|go/internal/storage/cypher/edge/writer/retract_scope.go'
	'go/internal/content/writer.go|go/internal/content/writer.go'
	'go/internal/projector/canonical/builder.go|go/internal/projector/canonical/builder.go'
	'go/internal/projector/canonical/codegraph_extract.go|go/internal/projector/canonical/codegraph_extract.go'
	'go/internal/projector/canonical/delta.go|go/internal/projector/canonical/delta.go'
	'go/internal/projector/decode/codegraph.go|go/internal/projector/decode/codegraph.go'
	'go/internal/projector/decode/fact_kind.go|go/internal/projector/decode/fact_kind.go'
	'go/internal/projector/canonical/materialization.go|go/internal/projector/canonical/materialization.go'
	'go/internal/projector/runtime/projection.go|go/internal/projector/runtime/projection.go'
	'go/internal/projector/runtime/reducer_intent.go|go/internal/projector/runtime/reducer_intent.go'
	'go/internal/projector/decode/payload.go|go/internal/projector/decode/payload.go'
	'go/internal/projector/runtime/phase.go|go/internal/projector/runtime/phase.go'
	'go/internal/projector/canonical/entity_identity.go|go/internal/projector/canonical/entity_identity.go'
	'go/internal/projector/runtime/stages.go|go/internal/projector/runtime/stages.go'
	...
	'go/internal/storage/cypher/edge/writer/rationale_labels.go|go/internal/storage/cypher/edge/writer/rationale_labels.go'
	...
	'go/internal/storage/cypher/edge/writer/inheritance_labels.go|go/internal/storage/cypher/edge/writer/inheritance_labels.go'
	'go/internal/storage/cypher/edge/writer/shell_exec.go|go/internal/storage/cypher/edge/writer/shell_exec.go'
	...
	'go/internal/collector/repo/git/fact_builder*.go|go/internal/collector/repo/git/fact_builder.go'
	'go/internal/collector/repo/git/fact_builder*.go|go/internal/collector/repo/git/fact_builder_delta.go'
	'go/internal/collector/repo/git/followup_facts.go|go/internal/collector/repo/git/followup_facts.go'
	'go/internal/projector/canonical/import_extract.go|go/internal/projector/canonical/import_extract.go'
	'go/internal/projector/runtime/workload_dependency_cassette_admission_test.go|go/internal/projector/runtime/workload_dependency_cassette_admission_test.go'
	...
	'go/internal/storage/cypher/edge/materialized/repo_dependency.go|go/internal/storage/cypher/edge/materialized/repo_dependency.go'
