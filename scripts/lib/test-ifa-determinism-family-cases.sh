...
# apart would separate a check from the family it is about. The
# repo_dependency (#5999) and workload_dependency (#6003) maintenance-backed
# families' own cases were split OUT of this file into
# scripts/lib/test-ifa-determinism-maintenance-family-cases.sh once this
# file crossed the 500-line cap on its own; that module's
# run_ifa_determinism_maintenance_family_cases is called from inside this
# file's run_ifa_determinism_family_cases, in the same narrative position
# between deployable_unit_edges and rationale_edges.
#
...
# repo_dependency (#5999) and workload_dependency (#6003): maintenance-backed
# families, split into their own module so this file stays below the 500-line
# cap -- see test-ifa-determinism-maintenance-family-cases.sh's own header.
