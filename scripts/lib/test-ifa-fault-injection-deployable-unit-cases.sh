...
# shellcheck source=scripts/lib/test-ifa-fault-injection-deployable-unit-lock-cases.sh
deployable_unit_lock_cases_lib="${repo_root}/scripts/lib/test-ifa-fault-injection-deployable-unit-lock-cases.sh"
source "${deployable_unit_lock_cases_lib}"
...
run_ifa_fault_injection_deployable_unit_cases() {
	...
	# The #6149 lock-target, precondition-gate and fresh-intents cases, moved to
	# their own module when this file reached the 500-line cap.
