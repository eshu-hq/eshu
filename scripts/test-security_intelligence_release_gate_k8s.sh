...
JSON
  ...
  "-n eshu logs eshu-api-6bd9f-private --all-containers --tail=200")
    printf 'level=info repository=private/repo package_name=private-package provider_url=https://provider.private.example.com/path token=ghp_abcdef path=/Users/alice/private/repo host=api.private.example.com ip=10.42.0.15\n'
    ;;
  "-n eshu logs eshu-reducer-77dd-private --all-containers --tail=200")
    printf '{"level":"warn","repo":"private/repo","package":"private-package","url":"https://provider.private.example.com/path","message":"retrying queue item","host":"reducer.private.example.com","path":"/home/alice/private/repo"}\n'
    ;;
  *)
