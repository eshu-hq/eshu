...
gate_integrity_lib="${repo_root}/scripts/lib/golden-corpus-gate-integrity.sh"
[[ -f "${gate_integrity_lib}" ]] && bash -n "${gate_integrity_lib}" ||
	fail "missing or invalid gate integrity lib: ${gate_integrity_lib}"
