...
require "workflow watches extracted CLI family packages" "go/internal/cli/**" "${workflow}"
...
require "ci registry watches extracted CLI family packages" "go/internal/cli/**" "${ci_gates}"
