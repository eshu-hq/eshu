...
COLLECTOR_SERVICES="${ESHU_REMOTE_E2E_COLLECTOR_SERVICES:-collector-terraform-state collector-oci-registry collector-package-registry collector-vulnerability-intelligence collector-aws-cloud scanner-worker}"
