...
// workflow file (go/internal/collector/repo/git/workflow/image/git_workflow_image_facts.go), distinct
...
type WorkflowImageEvidence struct {
	...
	// class is resolvable (go/internal/image.Evidence.ImageRef).
