...
// DecodeParsedFileDataKustomizeOverlays decodes the "kustomize_overlays" inner
// slice of a parsed_file_data map into a typed
// []codegraphv1.KustomizeOverlay. An absent key decodes to a nil slice with no
// error, and a malformed element is skipped rather than failing the whole
// decode, matching the tolerance of the raw-content Kustomize read this
// replaces (go/internal/relationships/kustomize_yaml_evidence.go, #5609).
