...
const (
	...
	// FactKindVulnerabilitySuppression is the
	// "vulnerability.suppression" fact kind.
	FactKindVulnerabilitySuppression = "vulnerability.suppression"
	...
	// go/internal/collector/repo/git/fact_builder.go). TestFactSchemaKindsMatchWireFactKinds
	// (reducer side) asserts each stays byte-equal to its facts.*FactKind
	// counterpart.
	...
	// code/function_summary.go, code/function_source.go, code/taint.go,
	// code/interproc.go). TestFactSchemaKindsMatchWireFactKinds (reducer side)
	// asserts each stays byte-equal to its facts.*FactKind counterpart.
