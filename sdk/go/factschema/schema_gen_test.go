...
func TestSchemasHaveNoDrift(t *testing.T) {
	...
	cases := []struct {
		...
		{file: "ci.deployment_event.v1.schema.json", generate: schemagen.CICDDeploymentEventSchema},
		...
		{file: "reducer_code_drifted_finding.v1.schema.json", generate: schemagen.ReducerCodeDriftedFindingSchema},
...
func TestSchemasMatchCollectorPayloadShape(t *testing.T) {
	...
	files := []string{
		...
		"ci.deployment_event.v1.schema.json",
